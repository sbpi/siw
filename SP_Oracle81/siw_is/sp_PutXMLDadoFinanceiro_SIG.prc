create or replace procedure sp_PutXMLDadoFinanceiro_SIG
...
begin
   ...
   If w_operacao = 'I' Then
      -- Insere registro
      insert into is_sig_dado_financeiro (cliente, ano, cd_programa, cd_acao, cd_subacao, cd_fonte, cd_regiao,
      ...
      values (p_cliente, p_ano, p_cd_programa, p_cd_acao, p_cd_subacao, p_cd_fonte, p_cd_regiao,
   ...
   ElsIf w_operacao = 'A' Then
      -- Altera registro
      update is_sig_dado_financeiro set
       ...
       where cd_regiao          = p_cd_regiao
         ...
         and ano                = p_ano;
   End If;
end sp_PutXMLDadoFinanceiro_SIG;
/
