...
begin
   ...
   If w_operacao = 'I' Then
      ...
      values (p_cliente, p_ano, p_chave, p_tipo_org, p_orgao, p_nome, p_tipo_prog, 
              ...
              nvl(p_temporario,'N'), nvl(p_estruturante,'S'), p_contexto, p_atual_contexto, p_estagio, p_andamento,
   ...
   Else
      ...
      update is_sig_programa set
         ...
         temporario                 = nvl(p_temporario,'N'),
         estruturante               = nvl(p_estruturante,'S'),
         contexto                   = p_contexto,
