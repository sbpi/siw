   ...
   If p_restricao is null Then
      ...
      open p_result for 
         select a.sq_tipo_afastamento chave, a.cliente, a.nome, a.sigla,
                ...
                decode(sexo,'M','Masculino','F','Feminino','Ambos') nm_sexo
   ...
   ElsIf p_restricao = 'MODALIDADES' Then
      open p_result for
         select a.sq_tipo_afastamento chave, a.cliente, a.nome, a.sigla,
                ...
                decode(contagem_dias,'C','Corridos','Úteis') nm_contagem_dias,
                decode(sexo,'M','Masculino','F','Feminino','Ambos') nm_sexo
           from gp_tipo_afastamento       a,
                gp_afastamento_modalidade b, 
                gp_modalidade_contrato    c
          where (a.sq_tipo_afastamento    = b.sq_tipo_afastamento (+))
            and (b.sq_modalidade_contrato = c.sq_modalidade_contrato (+))
