    ...
    open p_result for
       select a.sq_portal_lic,      a.cliente,           a.sq_unidade,
         ...
         where (a.sq_unidade         = b.sq_unidade)
           and (b.sq_pessoa_endereco = b1.sq_pessoa_endereco)
           and (b1.sq_cidade         = b2.sq_cidade)
           and (a.sq_lcmodalidade    = c.sq_lcmodalidade)
           and (a.sq_lcfinalidade    = e.sq_lcfinalidade)
           and (a.sq_lcjulgamento    = f.sq_lcjulgamento)
           and (a.sq_lcsituacao      = g.sq_lcsituacao)
           and (a.sq_lcfonte_recurso = h.sq_lcfonte_recurso)
