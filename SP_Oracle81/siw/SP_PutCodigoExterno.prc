...
begin
  If p_restricao = 'UNIDADE' Then
     update EO_UNIDADE set codigo = p_chave_externa where sq_unidade = p_chave;
  ...
  Elsif p_restricao = 'TIPO_UNIDADE' Then
     update EO_TIPO_UNIDADE set codigo_externo = p_chave_externa where sq_tipo_unidade = p_chave;
  Elsif p_restricao = 'AREA_ATUACAO' Then
     update EO_AREA_ATUACAO set codigo_externo = p_chave_externa where sq_area_atuacao = p_chave;
  ...
  Elsif p_restricao = 'PESSOA' Then
     update CO_PESSOA set codigo_externo = p_chave_externa where sq_pessoa = p_chave;
  Elsif p_restricao = 'TIPO_VINCULO' Then
     update CO_TIPO_VINCULO set codigo_externo = p_chave_externa where sq_tipo_vinculo = p_chave;
  ...
  Elsif p_restricao = 'ENDERECO' Then
     update CO_PESSOA_ENDERECO set codigo_externo = p_chave_externa where sq_pessoa_endereco = p_chave;
  End If;
  commit;
