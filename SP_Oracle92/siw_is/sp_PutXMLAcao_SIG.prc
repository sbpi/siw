...
begin
   ...
   ElsIf w_operacao = 'A' Then
      ...
      If w_cd_subacao <> p_cd_subacao or p_cd_subacao is null Then
         ...
         EXECUTE IMMEDIATE 'alter table is_sig_dado_financiero disable constraint FK_ISSIGDADFIN_ISSIGACA';
         ...
         EXECUTE IMMEDIATE 'alter table is_sig_dado_financiero enable constraint FK_ISSIGDADFIN_ISSIGACA';
