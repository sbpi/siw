...
select a3.sigla      sg_menu,
       ...
       conversao_lancamento(a3.sq_pessoa, coalesce(c.quitacao,c.vencimento,a.fim)-1, a.sq_siw_solicitacao, b.sq_moeda, e.valor, 'V') valor, -- valor na moeda do projeto
       conversao_lancamento(a3.sq_pessoa, coalesce(c.quitacao,c.vencimento,a.fim)-1, a.sq_siw_solicitacao, 70, e.valor, 'V') usd_valor_venda -- valor em dólar
  from siw_solicitacao                       a
       ...
       inner         join fn_lancamento      c  on (a.sq_siw_solicitacao  = c.sq_siw_solicitacao)
         left        join co_moeda_cotacao   c2 on (-- Taxa deve ser do dia anterior ao da conclusão do lançamento
