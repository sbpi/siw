      ...
      select a.sigla as sg_menu,
       ...
       where a.sq_menu     = p_menu
         ...
         and ((p_restricao = 'PADAUTUA'   and db.cliente is not null and c.data_autuacao is null) or
              ...
              (p_restricao = 'PAENVCEN'   and b3.sigla = 'AS' and b3.sigla <> 'CA' and b.sq_solic_pai is null and c.data_setorial is not null and (ca.sq_caixa is null or (ca.sq_caixa is not null and ca.sq_unidade = p_unid_posse))) or
