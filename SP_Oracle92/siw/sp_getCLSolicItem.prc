      ...
      open p_result for 
         select /*+ ordered */ a.sq_solicitacao_item as chave, a.sq_siw_solicitacao, a.quantidade, a.valor_unit_est,
          ...
          where a.quantidade > 0
            ...
            and ((p_aviso        is null and 0 = 1) or (p_aviso is not null and p_aviso = 'S'  and b.pesquisa_validade-f.dias_aviso_pesquisa<sysdate and b.pesquisa_validade>=sysdate-1))
    UNION
         select /*+ ordered */ a.sq_solicitacao_item as chave, a.sq_siw_solicitacao, a.quantidade, a.valor_unit_est,
                a.preco_menor, a.preco_maior, a.preco_medio, a.quantidade_autorizada, a.cancelado, a.motivo_cancelamento,
                a.ordem,
   ...
   UNION
         select /*+ ordered */ a.sq_solicitacao_item as chave, a.sq_siw_solicitacao, a.quantidade, a.valor_unit_est,
          ...
          where a.quantidade > 0
            ...
            and (p_codigo        is null or (p_codigo        is not null and b.codigo_interno   like '%'||p_codigo||'%'))
            and (p_nome          is null or (p_nome          is not null and acentos(b.nome)    like '%'||acentos(p_nome)||'%'))            
            and ((p_valida       is null and 0 = 1) or       (p_valida   is not null and        p_valida = 'S' and b.pesquisa_validade>=sysdate-1 and b.pesquisa_validade-f.dias_aviso_pesquisa>sysdate))
    UNION
         select /*+ ordered */ a.sq_solicitacao_item as chave, a.sq_siw_solicitacao, a.quantidade, a.valor_unit_est,
                a.preco_menor, a.preco_maior, a.preco_medio, a.quantidade_autorizada, a.cancelado, a.motivo_cancelamento,
                a.ordem,
