...
begin
   If p_operacao = 'I' Then
      ...
      insert into pe_objetivo
        (sq_peobjetivo, cliente,   sq_plano, nome,   sigla,   descricao,   ativo)
      values
        (w_chave,       p_cliente, p_chave,    p_nome, p_sigla, p_descricao, p_ativo);
   ...
   Elsif p_operacao = 'T' Then
      ...
      (select sq_peobjetivo.nextval, cliente, p_chave, nome, sigla, descricao, ativo 
         from pe_objetivo 
        where sq_peobjetivo = p_chave_aux
      );
   End If;
