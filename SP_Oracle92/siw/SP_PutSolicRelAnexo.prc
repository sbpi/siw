create or replace procedure SP_PutSolicRelAnexo
...
begin
   ...
   Elsif p_operacao = 'E' Then -- Exclusão
      ...
      delete pd_missao_relatorio where sq_siw_solicitacao = p_chave and sq_siw_arquivo = p_chave_aux;
      
      -- Remove da tabela de arquivos
      delete siw_arquivo where sq_siw_arquivo = p_chave_aux;
   End If;
end SP_PutSolicRelAnexo;
/
