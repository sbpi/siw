create or replace procedure SP_PutComentarioArquivo
...
begin
   If p_operacao = 'I' Then -- Inclusão
      ...
      insert into pj_comentario_arq
        (sq_etapa_comentario, sq_siw_arquivo)
      values
        (p_chave         , w_chave);
   ...
   Elsif p_operacao = 'E' Then -- Exclusão
      ...
      delete pj_comentario_arq where sq_etapa_comentario = p_chave and sq_siw_arquivo = p_chave_aux;
      -- Remove da tabela de arquivos
      delete siw_arquivo where sq_siw_arquivo = p_chave_aux;
   End If;
end SP_PutComentarioArquivo;
/
