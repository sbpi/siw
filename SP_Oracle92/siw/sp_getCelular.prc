...
begin
   ...
   Elsif p_restricao is not null Then
       ...
       open p_result for 
          select a.sq_celular as chave, a.cliente, a.numero_linha, a.marca, a.modelo, a.sim_card, a.imei, a.ativo,
                 d.sq_siw_solicitacao, d.inicio, d.fim, case when d.sq_siw_solicitacao = 53084 then 'S' else d.pendencia end pendencia,
...
--                                )                         d on (a.sq_celular           = d.sq_celular or (d.sq_siw_solicitacao = 53086 and a.sq_celular=1) or (d.sq_siw_solicitacao = 53084 and a.sq_celular=3))
