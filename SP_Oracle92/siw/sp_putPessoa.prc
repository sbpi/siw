...
begin
   ...
   If p_operacao = 'E' Then
       -- Remove uma pessoa da base de dados, desde que seus únicos dados sejam os gravados por esta procedure.
       -- A única exceção é a conta bancária, que é gravada em outra rotina.
       delete co_pessoa_telefone where sq_pessoa = p_sq_pessoa;
       delete co_pessoa_endereco where sq_pessoa = p_sq_pessoa;
       delete co_pessoa_fisica   where sq_pessoa = p_sq_pessoa;
       delete co_pessoa_juridica where sq_pessoa = p_sq_pessoa;
       delete co_pessoa_conta    where sq_pessoa = p_sq_pessoa;
       delete co_pessoa          where sq_pessoa = p_sq_pessoa;
   Else
