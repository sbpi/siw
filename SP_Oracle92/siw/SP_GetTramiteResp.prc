...
begin
   ...
   open p_result for
     ...
     select a.sq_siw_tramite, a.sq_menu, a.nome as nm_tramite, a.ordem, a.chefia_imediata,
            ...
            'Permissão' as tipo
       from siw_tramite                        a
            inner       join sg_tramite_pessoa b on (a.sq_siw_tramite  = b.sq_siw_tramite)
     ...
     select b.sq_siw_tramite, b.sq_menu, b.nome as nm_tramite, b.ordem, b.chefia_imediata,
       ...
       from siw_solicitacao                  a
            inner     join siw_menu          e on (a.sq_menu            = e.sq_menu and
                                                   e.sq_menu            = l_menu
                                                  )
              inner   join siw_tramite       b on (e.sq_menu            = b.sq_menu and
                                                   b.chefia_imediata    = 'U'
                                                  )
              inner   join eo_unidade        c on (e.sq_unid_executora  = c.sq_unidade)
                inner join (select x.sq_unidade, x.sq_pessoa, y.nome, y.nome_resumido, z.username, z.email
