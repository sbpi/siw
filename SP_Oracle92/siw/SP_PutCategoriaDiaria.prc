...
begin
   If p_operacao = 'I' Then
      -- Insere registro
      insert into pd_categoria_diaria ( sq_categoria_diaria,         cliente,   nome,         ativo,   tramite_especial)
      (select                           sq_categoria_diaria.nextval, p_cliente, trim(p_nome), p_ativo, p_tramite_especial from dual);
