create or replace function MontaNomeTipoMaterial(p_chave in number, p_retorno in varchar2 default null) return varchar2 is
  cursor c_ordem is
     select sq_tipo_material, sq_tipo_pai, nome
