      ...
      open p_result for
         select a.sq_pessoa as cliente, 
                ...
                coalesce(case when to_char(g.sq_siw_solicitacao) is null then null else to_char(f.sq_siw_solicitacao) end,
                         case when to_char(i.sq_siw_solicitacao) is null then null else f.codigo_interno end,
                         case when to_char(j.sq_siw_solicitacao) is null then null else f.codigo_interno end,
                         case when to_char(k.sq_siw_solicitacao) is null then null else f.codigo_interno end,
                         case when to_char(l.sq_siw_solicitacao) is null then null else f.codigo_interno end,
