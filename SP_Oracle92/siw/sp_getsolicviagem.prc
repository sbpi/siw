...
begin
   ...
   If p_restricao = 'GRPDCIAVIAGEM' or p_restricao = 'GRPDCIDADE' Then
           ...
           from siw_menu                                    a
                  ...
                  left outer     join (select x1.sq_siw_solicitacao, x1.sq_cia_transporte, x1.destino, 
                                         ...
                                         from pd_deslocamento                   x1
                                              left outer join pd_cia_transporte x2 on (x1.sq_cia_transporte = x2.sq_cia_transporte)
                                              left outer join co_cidade         x3 on (x1.destino           = x3.sq_cidade)
                                        where 1 = 1
