      ...
      open p_result for 
         select a.sq_mtentrada,       a.recebimento_previsto,        a.recebimento_efetivo, 
          ...
          where a.cliente         = p_cliente
            ...
            and (p_pais           is null or (p_pais        is not null and 0 < (select count(*) from mt_entrada_item x inner join cl_material y on (x.sq_material = y.sq_material) where x.sq_mtentrada = a.sq_mtentrada and y.sq_tipo_material in (select sq_tipo_material from cl_tipo_material connect by prior sq_tipo_material = sq_tipo_pai start with sq_tipo_material=p_pais))))
            ...
            and (p_ini_i          is null or (p_ini_i       is not null and (a.recebimento_previsto between p_ini_i and p_ini_f or a.recebimento_efetivo between p_ini_i and p_ini_f or a.armazenamento between p_ini_i and p_ini_f)))
