...
begin
   ...
   Elsif w_modulo = 'AC' or substr(w_opcao,1,3)='GCZ' Then -- Se for o módulo de acordos
      ...
      If p_exclui_arquivo is not null or p_operacao = 'E' Then -- Remove arquivo
         If w_arquivo is not null Then
            -- Remove o vínculo
            delete ac_acordo_log_arq where sq_acordo_log = p_chave_aux;
      ...
      Else
         -- Remove a anotação
         delete ac_acordo_log where sq_acordo_log = p_chave_aux;
      End If;
   ...
   Elsif w_modulo = 'FN' Then -- Se for o módulo financeiro
      ...
      If p_exclui_arquivo is not null or p_operacao = 'E' Then -- Remove arquivo
         If w_arquivo is not null Then
            -- Remove o vínculo
            delete fn_lancamento_log_arq where sq_lancamento_log = p_chave_aux;
      ...
      Else
         -- Remove a anotação
         delete fn_lancamento_log where sq_lancamento_log = p_chave_aux;
      End If;
   ...
   Elsif w_modulo in ('GP','SR','CO','PA') Then -- Se for o módulo de pessoal, recursos logísticos, compras ou protocolo
      ...
      If p_exclui_arquivo is not null or p_operacao = 'E' Then -- Remove arquivo
         If w_arquivo is not null Then
            -- Remove o vínculo
            delete siw_solic_log_arq where sq_siw_solic_log = p_chave_aux;
      ...
      Else
         -- Remove a anotação
         delete siw_solic_log where sq_siw_solic_log = p_chave_aux;
      End If;
