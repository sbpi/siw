          ...
          where ((p_tipo = 1 and b1.sigla = 'EE' and b2.acesso > 0 and (w_cliente <> 10135 or (w_cliente = 10135 and a.sigla <> 'FNDCONT'))) or
            ...
            and (p_pais           is null or (p_pais        is not null and (d.sq_pessoa_conta   = p_pais or 
                                                                             p_pais = (select w.sq_pessoa_conta 
                                                                                        ...
                                                                                        where w.sq_pessoa       = a.sq_pessoa 
                                                                                          and w.sq_agencia      = d.sq_agencia 
                                                                                          and w.numero          = d.numero_conta
                                                                                          and w.sq_pessoa_conta <> d.sq_pessoa_conta
                                                                                      )
                                                                            )
                                             )
                )
         ...
         select a.tipo,               a.qtd_itens,                a.sq_projeto,               a.cd_projeto, 
          ...
          where a.cliente    = p_pessoa
            ...
            and (p_pais           is null or (p_pais        is not null and (a.sq_pessoa_conta   = p_pais or 
                                                                             p_pais in (select w.sq_pessoa_conta 
                                                                                          from co_pessoa_conta w 
