   ...
   Elsif p_restricao = 'PDDIARIA' Then
      open p_result for
         select a.sq_deslocamento, a.sq_siw_solicitacao, a.origem, a.destino, a.sq_cia_transporte, 
                ...
                f.hospedagem, f.hospedagem_qtd, f.hospedagem_valor, h1.sigla as sg_moeda_hospedagem, h.valor as vl_diaria_hospedagem, 
                h.sq_valor_diaria as sq_diaria_hospedagem,
                f.veiculo, f.veiculo_qtd, f.veiculo_valor, i1.sigla as sg_moeda_veiculo, i.valor as vl_diaria_veiculo, 
                i.sq_valor_diaria as sq_diaria_veiculo,
                f.hospedagem_checkin, f.hospedagem_checkout, f.hospedagem_observacao, f.veiculo_retirada, f.veiculo_devolucao,
                f.calculo_diaria_qtd, f.calculo_diaria_texto, f.calculo_hospedagem_qtd, f.calculo_hospedagem_texto, f.calculo_veiculo_qtd, 
                f.calculo_veiculo_texto,
           ...
           from pd_deslocamento                       a
                ...
                left       join pd_valor_diaria       g  on (g.sq_valor_diaria            = recuperaValorDiaria(a1.cliente,a.destino,'D',a1.diaria))
                  left     join co_moeda              g1 on (g.sq_moeda                   = g1.sq_moeda)
