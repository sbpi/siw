...
select s.id_programa,
       ...
       case
           when inicio_real is not null and fim_real is not null and fim_real = fim_previsto then 1 --'Prazo final dentro do previsto'
           when inicio_real is not null and fim_real is not null and fim_real < fim_previsto then 2 --'Antes da data prevista'
           when inicio_real is not null and fim_real is not null and fim_real > fim_previsto then 3 --'Fim previsto superado'
       ...
       case
           when ((inicio_real is not null and fim_real is not null) and (fim_real = fim_previsto)) then 'Prazo final dentro do previsto'
           when inicio_real is not null and fim_real is not null and fim_real < fim_previsto then 'Antes da data prevista'
           when inicio_real is not null and fim_real is not null and fim_real > fim_previsto then 'Fim previsto superado'
           when (( (inicio_real is not null and fim_real is null) OR (inicio_real is  null and fim_real is null) ) and  fim_previsto >= sysdate+5) then 'Prazo final dentro do previsto'
           when (( (inicio_real is not null and fim_real is null) OR (inicio_real is  null and fim_real is null) ) and  fim_previsto > sysdate) then 'Fim previsto próximo'
           when (( (inicio_real is not null and fim_real is null) OR (inicio_real is  null and fim_real is null) ) and  fim_previsto < sysdate) then 'Fim previsto superado'
       end as status
  from pj_projeto_etapa et, vw_projeto s, vw_indicador_projeto ind
