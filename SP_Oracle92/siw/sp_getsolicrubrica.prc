   ...
   Elsif p_restricao = 'PJEXECLS' or p_restricao = 'PJEXECLN' Then
      open p_result for
         select a.tipo, a.sq_projeto, a.cd_projeto, a.sq_pj_moeda, a.sg_pj_moeda,
                ...
                case when substr(a.sg_menu,1,3) = 'FNR' then trunc(-1*a.fn_valor,2) else trunc(a.fn_valor,2) end fn_valor,
                a.fn_sq_moeda, a.fn_sg_moeda, a.fn_sb_moeda, a.ordem or_item, a.sq_documento_item,
                ...
                g43.valor cb_valor,                             -- Valor da conta bancária
           ...
           from vw_projeto_financeiro              a
                ...
                inner     join siw_solicitacao     d on (a.sq_financeiro      = d.sq_siw_solicitacao)
                  ...
                  inner   join fn_lancamento       g on (d.sq_siw_solicitacao = g.sq_siw_solicitacao)
                    ...
                    left  join siw_solic_cotacao g43 on (g.sq_siw_solicitacao = g43.sq_siw_solicitacao and
