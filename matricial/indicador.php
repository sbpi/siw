...
<BODY>
  ...
  <H3>Recupera quantitativos dos programas</H3>
  <UL>
  ...
  <form name="Form" action="indicador.php" method="POST" onSubmit="return(Validacao(this));">
    ...
    <table width="100%" border=1>
      ...
      <tr valign="top"><td>codigo</td><td><input type="TEXT" class="STI" name="codigo" value="<?php echo $_POST["codigo"]?>" size="20" maxlength="20"></input></td><td>OPCIONAL. Código do programa a ter seus quantitativos recuperados. Se não for informado, a rotina trará os quantitativos de todos os programas do SIW-GP que tenham sido criados pelo MatricialNet.</td></tr>
  ...
  if (isset($_POST['uid'])) {
    ...
    <b>$response = http_post_fields(&lt;endereço-base>/indicador.php, $campos);</font></b></PRE>
    ?>
    </font></TD></TR></table>
    ...
    // Chamada PHP para uma URL passando variáveis com o método POST. Em <b>$response</b> será armazenado o resultado do processamento.
    $response = http_post_fields('http://www2.sbpi.com.br/siw/cl_terracap/indicador.php', $campos);
