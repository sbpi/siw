...
<BODY>
  ...
  <H3>Exibe relatório executivo dos projetos de um programa</H3>
  <UL>
  ...
  <form name="Form" action="visual.php" method="POST" onSubmit="return(Validacao(this));">
    ...
    <table width="100%" border=1>
      ...
      <tr valign="top"><td>codigo</td><td><input type="TEXT" class="STI" name="codigo" value="<?php echo $_POST["codigo"]?>" size="20" maxlength="20"></input></td><td>OBRIGATÓRIO. Código do programa a ter seu relatório executivo exibido.</td></tr>
  ...
  if (isset($_POST['uid'])) {
    ...
    <b>$response = http_post_fields(&lt;endereço-base>/visual.php, $campos);</font></b></PRE>
    ?>
    </font></TD></TR></table>
    <p>Em caso de sucesso, a rotina retornará uma página HTML contendo o relatório executivo do programa informado; caso contrário, o retorno será um dos informados abaixo:</p>
    <dl>
      ...
      <dt>501<dd>Código de programa não encontrado. Neste caso, verifique se o programa foi criado no SIW-GP e se o código é igual no MatricialNet.</dd></dt>
    </dl>
    <?php
    // Criação de um array PHP com os pares variável-valor do formulário. Os nomes das variáveis devem ser exatamente iguais aos indicados.
    ...
    // Chamada PHP para uma URL passando variáveis com o método POST. Em <b>$response</b> será armazenado o resultado do processamento.
    $response = http_post_fields('http://www2.sbpi.com.br/siw/cl_terracap/visual.php', $campos);
