<%
REM =========================================================================
REM Mantém os dados de identificacao do colaborador
REM -------------------------------------------------------------------------
Sub DML_PutCVIdent(Operacao, p_cliente, p_chave, p_nome, p_nome_resumido, p_nascimento, p_sexo, _
  ...
  with sp
     ...
     set l_sq_deficiencia       = .CreateParameter("l_sq_deficiencia",      adInteger, adParamInput,    , tvl(p_sq_deficiencia))
...
REM =========================================================================
REM Mantém os idiomas do colaborador
REM -------------------------------------------------------------------------
...
REM =========================================================================
REM Mantém os dados de formação acadêmica do colaborador
REM -------------------------------------------------------------------------
...
REM =========================================================================
REM Mantém os dados de extensão acadêmica do colaborador
REM -------------------------------------------------------------------------
...
REM =========================================================================
REM Mantém os dados de produção técnica do colaborador
REM -------------------------------------------------------------------------
...
REM =========================================================================
REM Mantém os dados da experiência profissional do colaborador
REM -------------------------------------------------------------------------
Sub DML_PutCVExperiencia(Operacao, p_pessoa, p_chave, p_sq_area_conhecimento, p_sq_cidade, _
  ...
  Set l_ultimo_salario          = Server.CreateObject("ADODB.Parameter") 
  ...
  with sp
     ...
     l_ultimo_salario.Value         = Tvl(p_ultimo_salario)
