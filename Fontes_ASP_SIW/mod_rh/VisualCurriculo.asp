...
Sub VisualCurriculo(p_cliente, p_usuario, O)
  ...
  If O = "L" Then ' Se for listagem dos dados
     ...
     Else
        ...
        HTML = VbCrLf & HTML &"      <tr><td colspan=2><font size=""1"">Deficiência:<br><b>" & Nvl(RS("nm_deficiencia"),"---") & " </b></td>"
        ...
        ' Histórico Pessoal
        HTML = VbCrLf & HTML &"      <tr><td valign=""top"" colspan=""2"" align=""center"" bgcolor=""#D0D0D0"" style=""border: 2px solid rgb(0,0,0);""><font size=""1""><b>Histórico Pessoal</td>"
        ...
        HTML = VbCrLf & HTML &"      <tr><td valign=""top"" width=""80%""><font size=""1"">Você já fixou residência permanente legal em país estrangeiro?</td><td valign=""top""><font size=""1""><b>" & RS("nm_residencia") & " </b></td>"
        HTML = VbCrLf & HTML &"      <tr><td valign=""top""><font size=""1"">Você já tomou alguma medida para mudar de nacionalidade?</td><td valign=""top""><font size=""1""><b>" & RS("nm_mudanca")
        If RS("mudanca_nacionalidade") = "S" Then
           HTML = VbCrLf & HTML &"                          , " & RS("mudanca_nacionalidade_medida") & "</b></td>" 
        End If
        HTML = VbCrLf & HTML &"      <tr><td valign=""top""><font size=""1"">Você aceitaria um emprego por menos de 6 meses?</td><td valign=""top""><font size=""1""><b>" & RS("nm_emprego") & " </b></td>"
        HTML = VbCrLf & HTML &"      <tr><td valign=""top""><font size=""1"">Você possui algum impedimento para efetuar viagens aéreas?</td><td valign=""top""><font size=""1""><b>" & RS("nm_impedimento") & " </b></td>"
        HTML = VbCrLf & HTML &"      <tr><td valign=""top""><font size=""1"">Você tem algum parente trabalhando nesta organização?</td><td valign=""top""><font size=""1""><b>" & RS("nm_familiar") & " </b></td>"
        HTML = VbCrLf & HTML &"      <tr><td valign=""top""><font size=""1"">Você tem alguma objeção a fazer em relação à solicitação de informações a seu respeito para seu último empregador?</td><td valign=""top""><font size=""1""><b>" & RS("nm_objecao") & " </b></td>"
        HTML = VbCrLf & HTML &"      <tr><td valign=""top""><font size=""1"">Você alguma vez já foi preso, acusado ou convocado pela Corte como réu em algum processo criminal ou sentenciado, penalizado ou aprisionado por violação de alguma lei? (excluem-se violações menores de trânsito)</td><td valign=""top""><font size=""1""><b>" & RS("nm_prisao")
        If RS("prisao_envolv_justica") = "S" Then
           HTML = VbCrLf & HTML &"                          , " & RS("motivo_prisao") & "</b></td>" 
        End If
        HTML = VbCrLf & HTML &"      <tr><td valign=""top""><font size=""1"">Exponha algum outo fato relevante. Inclua informações relacionadas a qualquer residência fora do país de origem:</td><td valign=""top""><font size=""1""><b>" & Nvl(RS("fato_relevante_vida"),"---") & " </b></td>"
        HTML = VbCrLf & HTML &"      <tr><td valign=""top""><font size=""1"">Você é ou foi Funcionário Público?</td><td valign=""top""><font size=""1""><b>" & RS("nm_servidor")
        ...
        End If
        HTML = VbCrLf & HTML &"      <tr><td valign=""top""><font size=""1"">Sociedade profissional ou atividades ligadas a assuntos cívicos, públicos ou internacionais das quais faz parte:</td><td valign=""top""><font size=""1""><b>" & Nvl(RS("atividades_civicas"),"---") & " </b></td>"
        HTML = VbCrLf & HTML &"          </table>"
        DesconectaBD
        ...
        HTML = VbCrLf & HTML &"      <tr><td valign=""top"" colspan=""3""><font size=""1"">&nbsp;</td>"
        HTML = VbCrLf & HTML &"      <tr><td valign=""top"" colspan=""3"" align=""center"" bgcolor=""#D0D0D0"" style=""border: 2px solid rgb(0,0,0);""><font size=""1""><b>Contas bancárias</td>"
        HTML = VbCrLf & HTML & "<tr><td align=""center"" colspan=3>"
        HTML = VbCrLf & HTML & "    <TABLE WIDTH=""100%"" bgcolor=""" & conTableBgColor & """ BORDER=""" & conTableBorder & """ CELLSPACING=""" & conTableCellSpacing & """ CELLPADDING=""" & conTableCellPadding & """ BorderColorDark=""" & conTableBorderColorDark & """ BorderColorLight=""" & conTableBorderColorLight & """>"
        HTML = VbCrLf & HTML & "        <tr bgcolor=""" & conTrBgColor & """ align=""center"">"
        HTML = VbCrLf & HTML &"          <td><font size=""1""><b>Tipo</font></td>"
        HTML = VbCrLf & HTML &"          <td><font size=""1""><b>Banco</font></td>"
        HTML = VbCrLf & HTML &"          <td><font size=""1""><b>Agência</font></td>"
        HTML = VbCrLf & HTML &"          <td><font size=""1""><b>Operação</font></td>"
        HTML = VbCrLf & HTML &"          <td><font size=""1""><b>Conta</font></td>"
        HTML = VbCrLf & HTML &"          <td><font size=""1""><b>Ativo</font></td>"
        HTML = VbCrLf & HTML &"          <td><font size=""1""><b>Padrão</font></td>"
        HTML = VbCrLf & HTML & "        </tr>"
        If RS.EOF Then ' Se não foram selecionados registros, exibe mensagem
           HTML = VbCrLf & HTML & "      <tr bgcolor=""" & conTrBgColor & """><td colspan=7 align=""center""><font size=""1""><b>Não foram encontrados registros.</b></td></tr>"
        Else
           ' Lista os registros selecionados para listagem
           w_cor = conTrBgColor
           While Not RS.EOF
        ...
        Else
           While Not RS.EOF
              ...
              HTML = VbCrLf & HTML &"              <td valign=""top""><font size=""1"">Último salário mensal: <br><b>" & FormatNumber(Nvl(RS("ultimo_salario"),0),2) & "</b></td></tr>"
              HTML = VbCrLf & HTML &"          <tr> "
        ...
        HTML = VbCrLf & HTML &"      <tr><td valign=""top"" colspan=""3""><font size=""1"">&nbsp;</td>"
        HTML = VbCrLf & HTML &"      <tr><td valign=""top"" colspan=""3"" align=""center"" bgcolor=""#D0D0D0"" style=""border: 2px solid rgb(0,0,0);""><font size=""1""><b>Declaração</td>"
        HTML = VbCrLf & HTML &"      <tr><td valign=""top"" colspan=""3""><font size=""3""><blockquote><p align=""justify""><br>Eu, <b>" & w_nome & "</b>, declaro que as informações aqui constantes estão atualizadas, são verdadeiras e passíveis de comprovação.</p><p><br></p><p align=""center"">" & FormatDateTime(Date(),1) & "</p></blockquote></td>"
        HTML = VbCrLf & HTML &"</table>"
     End If
     DesconectaBD
  Else
