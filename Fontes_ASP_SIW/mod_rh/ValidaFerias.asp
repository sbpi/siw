<%
REM =========================================================================
REM Rotina de validação do pedido de férias
REM -------------------------------------------------------------------------
Function ValidaFerias(p_cliente, p_chave, p_sg1, p_sg2, p_sg3, p_sg4, p_tramite)
  ...
  If l_rs_solic.eof Then
     ValidaFerias = "0<li>Não existe registro no banco de dados com o número informado."
     l_rs_solic.close
     Exit Function
  End If
