...
<!-- #INCLUDE FILE="DML_Geral.asp" -->
<!-- #INCLUDE FILE="ValidaFerias.asp" -->
<!-- #INCLUDE FILE="VisualFerias.asp" -->
...
Sub Inicial
  ...
  If O = "L" Then
     ...
     End If
     If w_copia > "" Then ' Se for cópia, aplica o filtro sobre todas as solicitações visíveis pelo usuário
  ...
  ShowHTML "<TITLE>" & conSgSistema & " - Listagem de pedidos de férias</TITLE>"
...
Sub Visual
  ...
  ShowHTML VisualFerias(w_chave, "L", w_usuario, P1, P4)
...
Sub Encaminhamento
  ...
  If O = "V" Then w_erro = ValidaFerias(w_cliente, w_chave, SG, null, null, null, w_tramite) End If
...
Sub Concluir
  ...
  ' Se for envio, executa verificações nos dados da solicitação
  w_erro = ValidaFerias(w_cliente, w_chave, SG, null, null, null, w_tramite)
