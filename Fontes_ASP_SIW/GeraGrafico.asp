...
Dim cht             ' referencia ao grбfico
Dim axc, axv
Dim sFullFileName   ' caminho fнsico para o GIF gerado
Dim asSeriesNames(7)
Dim asCategories(7)
Dim asValues(7)
...
With cso
   ...
   asSeriesNames(2) = "Em execuзгo"
   asSeriesNames(3) = "Concluнdas"
   ...
   asCategories(2) = "Em execuзгo"
   asCategories(3) = "Concluнdas"
...
' Retorna a imagem como fluxo binбrio usando o BinaryFileStream ActiveX DLL
