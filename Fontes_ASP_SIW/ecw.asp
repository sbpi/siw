...
Sub LogOn
  ...
  ShowHTML "<TABLE cellSpacing=0 cellPadding=0 width=""780"" height=550 border=1  background=""" & conFileVirtual & p_cliente & "/img/logo_sge.jpg"" bgproperties=""fixed""><tr><td width=""100%"" valign=""top"">"
  ShowHTML "  <TABLE cellSpacing=0 cellPadding=0 width=""100%"" border=0>"
  ShowHTML "    <TR>"
  ShowHTML "      <TD vAlign=center align=middle><IMG border=1 src=""" & conFileVirtual & p_cliente & "/img/logo1.gif""></TD>"
  ...
  ShowHTML "     </TD>"
  ShowHTML "      <TD vAlign=center align=middle><IMG border=1 src=""" & conFileVirtual & p_cliente & "/img/logo.gif"" ></TD></TR>"
