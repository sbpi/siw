  ...
  If Request("regional") = "" Then
     ...
     Else
        ...
        If par = "Log" Then
           ...
           ShowHTML "  location.href='ecw.asp?par=Frames&Login=" & wNoUsuario &  "';"
        Else
...
Sub LogOn
  ...
  End If
  ShowHTML "<CENTER>"
  ShowHTML "<form method=""post"" action=""ecw.asp"" onsubmit=""return(Validacao(this));"" name=""Form""> "
  ...
  ShowHTML "<TABLE cellSpacing=0 cellPadding=0 width=""780"" height=550 border=1  background=""" & LinkArquivo(null, p_cliente, "/img/logo_sge.jpg", null, null, null, "EMBED") & """ bgproperties=""fixed""><tr><td width=""100%"" valign=""top"">"                                                                        
  ShowHTML "  <TABLE cellSpacing=0 cellPadding=0 width=""100%"" border=0>"
  ShowHTML "    <TR>"
  ShowHTML "      <TD vAlign=center align=middle><IMG border=1 src=""" & LinkArquivo(null, p_cliente, "/img/logo1.gif", null, null, null, "EMBED") & """></TD>"
  ...
  ShowHTML "     </TD>"
  ShowHTML "      <TD vAlign=center align=middle><IMG border=1 src=""" & LinkArquivo(null, p_cliente, "/img/logo.gif", null, null, null, "EMBED") & """ ></TD></TR>"
