...
Sub Inicial
        ...
        If Session("interno") = "S" and w_tipo <> "WORD" Then 
           ...
           If P1 <> 3 Then ' Se não for acompanhamento
              ...
              ElseIf P1 = 1 Then ' Se for cadastramento
                 If w_submenu > "" Then
                    ShowHTML "          <A class=""HL"" HREF=""Menu.asp?par=ExibeDocs&O=A&w_chave=" & RS("sq_siw_solicitacao") & "&R=" & w_Pagina & par & "&SG=" & SG & "&TP=" & TP & "&w_documento=Nr. " & RS("sq_siw_solicitacao") & MontaFiltro("GET") & """ title=""Altera as informações cadastrais da atividade"" TARGET=""menu"">Alterar</a>&nbsp;"
                 Else
                    ShowHTML "          <A class=""HL"" HREF=""" & w_Pagina & par & "&R=" & w_Pagina & par & "&O=A&w_chave=" & RS("sq_siw_solicitacao") & "&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & MontaFiltro("GET") & """ title=""Altera as informações cadastrais da atividade"">Alterar</A>&nbsp"
                 End If
                 ShowHTML "          <A class=""HL"" HREF=""" & w_Pagina & "Excluir&R=" & w_Pagina & par & "&O=E&w_chave=" & RS("sq_siw_solicitacao") & "&w_tipo=Volta&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & MontaFiltro("GET") & """ title=""Exclusão da atividade."">Excluir</A>&nbsp"
              ElseIf P1 = 2 Then ' Se for execução
                 If cDbl(w_usuario) = cDbl(RS("executor")) Then
                    ShowHTML "          <A class=""HL"" HREF=""" & w_Pagina & "Anotacao&R=" & w_Pagina & par & "&O=V&w_chave=" & RS("sq_siw_solicitacao") & "&w_tipo=Volta&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & MontaFiltro("GET") & """ title=""Registra anotações para a atividade, sem enviá-la."">Anotar</A>&nbsp"
                    ShowHTML "          <A class=""HL"" HREF=""" & w_Pagina & "envio&R=" & w_Pagina & par & "&O=V&w_chave=" & RS("sq_siw_solicitacao") & "&w_tipo=Volta&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & MontaFiltro("GET") & """ title=""Envia a atividade para outro responsável."">Enviar</A>&nbsp"
                    ShowHTML "          <A class=""HL"" HREF=""" & w_Pagina & "Concluir&R=" & w_Pagina & par & "&O=V&w_chave=" & RS("sq_siw_solicitacao") & "&w_tipo=Volta&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & MontaFiltro("GET") & """ title=""Conclui a execução da atividade."">Concluir</A>&nbsp"
                 Else
                    ShowHTML "          <A class=""HL"" HREF=""" & w_Pagina & "envio&R=" & w_Pagina & par & "&O=V&w_chave=" & RS("sq_siw_solicitacao") & "&w_tipo=Volta&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & MontaFiltro("GET") & """ title=""Envia a atividade para outro responsável."">Enviar</A>&nbsp"
                 End If
              End If
  ...
  ElseIf Instr("CP",O) > 0 Then
    ...
    SelecaoProjeto "Pro<u>j</u>eto:", "J", "Selecione o projeto da atividade na relação.", p_projeto, w_usuario, RS("sq_menu"), "p_projeto", "PJLIST", "onChange=""document.Form.action='" & w_pagina & par & "'; document.Form.O.value='" & O & "'; document.Form.w_troca.value='p_atividade'; document.Form.submit();"""
    DesconectaBD
    ShowHTML "      </tr>"
    ShowHTML "      <tr>"
...
Sub Geral
  ...
  If Instr("IAEV",O) > 0 Then
    ...
    ShowHTML "      <tr>"
    DB_GetLinkData RS, w_cliente, "PJCAD"
    SelecaoProjeto "Pro<u>j</u>eto:", "J", "Selecione o projeto da atividade na relação.", w_projeto, w_usuario, RS("sq_menu"), "w_projeto", "PJLISTCAD", "onChange=""document.Form.action='" & w_pagina & par & "'; document.Form.w_troca.value='w_atividade'; document.Form.submit();"""
    DesconectaBD
    ShowHTML "      </tr>"
...
Sub Anotar
  ...
  ShowHTML "<HR>"
  ShowHTML "<FORM name=""Form"" method=""POST"" enctype=""multipart/form-data"" onSubmit=""return(Validacao(this));"" action=""" & w_pagina & "Grava&SG=GDPENVIO&O="&O&"&w_menu="&w_menu&"&UploadID="&UploadID&""">"
  ShowHTML "<INPUT type=""hidden"" name=""P1"" value=""" & P1 & """>"
  ShowHTML "<INPUT type=""hidden"" name=""P2"" value=""" & P2 & """>"
  ShowHTML "<INPUT type=""hidden"" name=""P3"" value=""" & P3 & """>"
  ShowHTML "<INPUT type=""hidden"" name=""P4"" value=""" & P4 & """>"
...
Sub SolicMail(p_solic, p_tipo)
  ...
  If p_tipo = 1 Then
     w_html = w_html & "      <tr valign=""top""><td align=""center""><font size=2><b>INCLUSÃO DE ATIVIDADE</b></font><br><br><td></tr>" & VbCrLf
  ElseIf p_tipo = 2 Then
     w_html = w_html & "      <tr valign=""top""><td align=""center""><font size=2><b>TRAMITAÇÃO DE ATIVIDADE</b></font><br><br><td></tr>" & VbCrLf
  ElseIf p_tipo = 3 Then
     w_html = w_html & "      <tr valign=""top""><td align=""center""><font size=2><b>CONCLUSÃO DE ATIVIDADE</b></font><br><br><td></tr>" & VbCrLf
  End IF
  ...
  w_html = w_html & VbCrLf & "      <tr><td valign=""top""><font size=""1"">Projeto: <b>" & RSM("nm_projeto") & "  (" & RSM("sq_solic_pai") & ")</b></td>"
  If Not IsNull(RSM("nm_etapa")) Then
     w_html = w_html & VbCrLf & "      <tr><td valign=""top""><font size=""1"">Etapa: <b>" & MontaOrdemEtapa(RSM("sq_projeto_etapa")) & ". " & RSM("nm_etapa") & " </b></td>"
  End If
  w_html = w_html & VbCrLf & "      <tr><td><font size=1>Detalhamento: <b>" & p_solic & "<br>" & CRLF2BR(RSM("assunto")) & "</b></font></td></tr>"
      
  ' Identificação da atividade
  w_html = w_html & VbCrLf & "      <tr><td valign=""top"" colspan=""2"" align=""center"" bgcolor=""#D0D0D0"" style=""border: 2px solid rgb(0,0,0);""><font size=""1""><b>EXTRATO DA ATIVIDADE</td>"
  ...
  If Nvl(RSM("descricao"),"") > "" Then 
     If Nvl(RSM("descricao"),"") > "" Then w_html = w_html & VbCrLf & "      <tr><td valign=""top""><font size=""1"">Resultados da atividade:<br><b>" & CRLF2BR(RSM("descricao")) & " </b></td>" End If
  End If
