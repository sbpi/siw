...
Sub DML_PutCVIdent(Operacao, p_cliente, p_chave, p_nome, p_nome_resumido, p_nascimento, p_sexo, _
         ...
         p_foto, p_tamanho, p_tipo, p_nome_original)
  ...
  Dim l_foto, l_tamanho, l_tipo, l_nome_original
  ...
  with sp
     ...
     set l_nome_original                 = .CreateParameter("l_nome_original",                adVarchar, adParamInput,  60, Tvl(p_nome_original))
