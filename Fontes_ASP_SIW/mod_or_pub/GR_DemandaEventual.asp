...
Sub Gerencial
  ...
  If O = "L" or O = "V" or O = "W" Then
     ...
     If p_projeto > ""  Then 
        ...
        w_filtro = w_filtro & "<tr valign=""top""><td align=""right""><font size=1>Ação <td><font size=1>[<b><A class=""HL"" HREF=""Projeto.asp?par=Visual&O=L&w_chave=" & p_projeto & "&w_tipo=Volta&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & """ title=""Exibe as informações do projeto."">" & RS("titulo") & "</a></b>]"
     End If
     If p_sqcc > ""  Then 
  ...
  If O = "L" or O = "W" Then
    ...
    If RS1.RecordCount > 0 and p_tipo = "N" Then ' Coloca o gráfico somente se o usuário desejar
       ...
       ShowHTML "<tr><td align=""center""><IMG SRC=""GeraGrafico.php?p_genero=F&p_objeto=" & RS_Menu("nome") & "&p_tipo="&SG&"&p_grafico=Barra&p_tot="&t_totsolic&"&p_cad="&t_totcad&"&p_tram="&t_tottram&"&p_conc="&t_totconc&"&p_atraso="&t_totatraso&"&p_aviso="&t_totaviso&"&p_acima="&t_totacima&""">"
       ShowHTML "<tr><td align=""center"" height=20>"
       If (t_totcad + t_tottram) > 0 Then
          ShowHTML "<tr><td align=""center""><IMG SRC=""GeraGrafico.php?p_genero=F&p_objeto=" & RS_Menu("nome") & "&p_tipo="&SG&"&p_grafico=Pizza&p_tot="&t_totsolic&"&p_cad="&t_totcad&"&p_tram="&t_tottram&"&p_conc="&t_totconc&"&p_atraso="&t_totatraso&"&p_aviso="&t_totaviso&"&p_acima="&t_totacima&""">"
       End If
    End If
  ...
  ElseIf Instr("P",O) > 0 Then
    ...
    If RS_menu("solicita_cc") = "S" Then If p_agrega = "GRDMCC" Then ShowHTML " <option value=""GRDMCC"" selected>Classificação"                      Else ShowHTML " <option value=""GRDMCC"">Classificação"                       End If End If
    ...
    If p_agrega = "GRDMPROP"        Then                             ShowHTML " <option value=""GRDMPROP"" selected>Parceria externa"                 Else ShowHTML " <option value=""GRDMPROP"">Parceria externa"                  End If
    If Nvl(p_agrega,"GRDMRESP") = "GRDMRESP" Then                    ShowHTML " <option value=""GRDMRESP"" selected>Responsável monitoramento"        Else ShowHTML " <option value=""GRDMRESP"">Responsável pelo monitoramento"    End If
    If p_agrega = "GRDMSETOR"       Then                             ShowHTML " <option value=""GRDMSETOR"" selected>Setor responsável monitoramento" Else ShowHTML " <option value=""GRDMSETOR"">Setor responsável monitoramento"  End If
    ShowHTML "          </select></td>"
