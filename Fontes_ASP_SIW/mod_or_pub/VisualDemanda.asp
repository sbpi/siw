  ...
  If O = "L" or O = "V" Then ' Se for listagem dos dados
     ...
     If Not IsNull(RS("nm_projeto")) Then
        ...
        If Not IsNull(RS1("sq_acao_ppa")) Then
           ...
           w_html = w_html & VbCrLf & "      <tr><td valign=""top""><font size=""1"">Ação PPA:<b>" & RS1("nm_ppa") & " (" & RS1("cd_ppa") & ")" & " </b></td>"
        End If
        ' Se a iniciativa prioritária for informada, exibe.
        If Not IsNull(RS1("sq_orprioridade")) Then
           w_html = w_html & VbCrLf & "      <tr><td valign=""top""><font size=""1"">Iniciativa prioritária:<b>" & RS1("nm_pri")
     ...
     w_html = w_html & VbCrLf & "          <td><font size=""1"">Responsável:<br><b>" & ExibePessoa("../", w_cliente, RS("solicitante"), TP, RS("nm_sol")) & "</A></b></td>"
