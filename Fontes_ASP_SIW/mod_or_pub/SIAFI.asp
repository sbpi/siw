  ...
  If O = "L" Then
    ...
    Else
      ...
      While Not RS.EOF
        ...
        ShowHTML "          <A class=""HL"" HREF=""" & conFileVirtual & w_cliente & "/" & RS("cm_recebido") & """ title=""Exibe os dados do arquivo importado."" target=""_blank"">Arquivo</A>&nbsp"
        ShowHTML "          <A class=""HL"" HREF=""" & conFileVirtual & w_cliente & "/" & RS("cm_result") & """ title=""Exibe o registro da importação."" target=""_blank"">Registro</A>&nbsp"
        ShowHTML "        </td>"
        ShowHTML "      </tr>"
        RS.MoveNext
      wend
