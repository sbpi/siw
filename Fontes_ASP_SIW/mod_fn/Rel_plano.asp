  ...
  If O = "L" Then
    ...
    Else
      ...
      While Not RS.EOF
        ...
        Else
           ShowHTML "        <A class=""hl"" HREF=""" & w_dir & "Lancamento.asp?par=Visual&R=" & w_pagina & par & "&O=L&w_chave=" & RS("sq_siw_solicitacao") & "&w_tipo=Volta&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & MontaFiltro("GET") & """ title=""Exibe as informações deste registro."">" & RS("codigo_interno") & "&nbsp;</a>"
        End If
        ...
        If Nvl(RS("cd_acordo"),"") > "" Then
           ShowHTML "        <td><font size=""1""><A class=""hl"" HREF=""" & "mod_ac/Contratos.asp?par=Visual&O=L&w_chave=" & RS("sq_acordo") & "&w_tipo=&P1=2&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=GC" & Mid(SG,3,1) & "CAD"" title=""Exibe as informações do projeto."" target=""_blank"">" & RS("cd_acordo") & "</a> - " & RS("descricao") & "</td>"
        Else
