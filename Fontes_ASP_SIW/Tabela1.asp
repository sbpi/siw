...
Sub ParSeguranca
  ...
  ShowHTML "<tr bgcolor=""" & conTrBgColor & """><td align=""center"">"
  ShowHTML "    <table width=""70%"" border=""0"">"
  ShowHTML "      <tr><td valign=""top""><font  size=""1""><b>Tamanho mín<U>i</U>mo:<br><INPUT ACCESSKEY=""I"" " & w_Disabled & " class=""sti"" type=""text"" name=""w_tamanho_minimo_senha"" size=""2"" maxlength=""2"" value=""" & w_tamanho_minimo_senha & """ ONMOUSEOVER=""popup('Tamanho mínimo da senha de acesso e assinatura eletrônica','white')""; ONMOUSEOUT=""kill()""></td>"
  ShowHTML "          <td valign=""top""><font  size=""1""><b>Tamanho má<U>x</U>imo:<br><INPUT ACCESSKEY=""X"" " & w_Disabled & " class=""sti"" type=""text"" name=""w_tamanho_maximo_senha"" size=""2"" maxlength=""2"" value=""" & w_tamanho_maximo_senha & """ ONMOUSEOVER=""popup('Tamanho máximo da senha de acesso e assinatura eletrônica','white')""; ONMOUSEOUT=""kill()""></td>"
  ShowHTML "      <tr><td valign=""top"" colspan=2><font  size=""1""><b>Máximo <U>t</U>entativas:<br><INPUT ACCESSKEY=""T"" " & w_Disabled & " class=""sti"" type=""text"" name=""w_maximo_tentativas"" size=""2"" maxlength=""2"" value=""" & w_maximo_tentativas & """ ONMOUSEOVER=""popup('Máximo de tentativas inválidas antes de bloquear o acesso do usuário','white')""; ONMOUSEOUT=""kill()""></td>"
  ShowHTML "      <tr><td valign=""top""><font  size=""1""><b>Dias <U>v</U>igência:<br><INPUT ACCESSKEY=""V"" " & w_Disabled & " class=""sti"" type=""text"" name=""w_dias_vigencia_senha"" size=""2"" maxlength=""2"" value=""" & w_dias_vigencia_senha & """ ONMOUSEOVER=""popup('Número de dias de vigência da senha de acesso','white')""; ONMOUSEOUT=""kill()""></td>"
  ShowHTML "          <td valign=""top""><font  size=""1""><b><U>D</U>ias de aviso:<br><INPUT ACCESSKEY=""D"" " & w_Disabled & " class=""sti"" type=""text"" name=""w_dias_aviso_expiracao"" size=""2"" maxlength=""2"" value=""" & w_dias_aviso_expiracao & """ ONMOUSEOVER=""popup('Dias de aviso para o usuário antes que sua senha de acesso tenha sua vigência expirada','white')""; ONMOUSEOUT=""kill()""></td>"
  ShowHTML "      <tr><td valign=""top""><font  size=""1""><b><U>A</U>ssinatura Eletrônica:<br><INPUT ACCESSKEY=""A"" class=""sti"" type=""PASSWORD"" name=""w_assinatura"" size=""30"" maxlength=""30"" value=""""></td>"
  ShowHTML "      <tr><td align=""center"" colspan=""3"" height=""1"" bgcolor=""#000000"">"
