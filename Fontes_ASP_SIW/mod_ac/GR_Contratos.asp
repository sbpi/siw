    ...
    Else
      If O = "L" Then
         ...
         While Not RS2.EOF
            ...
            ElseIf RS2("ativo") = "N" AND Nvl(RS2("sigla"),"-") <> "CA" Then
               w_fase_conc = w_fase_conc & "," & RS2("sq_siw_tramite")
         ...
         ShowHTML "    if (conc >= 0) document.Form.p_fase.value='" & Mid(w_fase_conc,2,100) & "';"
