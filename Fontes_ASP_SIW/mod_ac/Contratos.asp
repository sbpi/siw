...
<!-- #INCLUDE FILE="DB_Contrato.asp" -->
<!-- #INCLUDE FILE="DB_Tabelas.asp" -->
<!-- #INCLUDE VIRTUAL="/siw/DML_Solic.asp" -->
<!-- #INCLUDE VIRTUAL="/siw/jScript.asp" -->
<!-- #INCLUDE VIRTUAL="/siw/Funcoes.asp" -->
<!-- #INCLUDE FILE="DML_Contrato.asp" -->
<!-- #INCLUDE FILE="ValidaAcordo.asp" -->
<!-- #INCLUDE FILE="VisualAcordo.asp" -->
...
If InStr(uCase(Request.ServerVariables("http_content_type")),"MULTIPART/FORM-DATA") > 0 Then  
   ...
   p_objeto        = uCase(ul.Form("p_objeto"))  
...
Sub Inicial
  ...
  Dim w_titulo, w_total, w_parcial, w_atual, w_real
  ...
  If O = "L" Then
     ...
     If w_copia > "" Then ' Se for cópia, aplica o filtro sobre todos os contratos visíveis pelo usuário
  ...
  If O = "L" Then
    ...
    If P1 = 1 and w_copia = "" Then ' Se for cadastramento e não for resultado de busca para cópia
       ...
       End If
    End If
    If Instr(uCase(R),"GR_") = 0 and Instr(uCase(R),"ACORDO") = 0 and P1 <> 6 Then
    ...
    ShowHTML "          <td rowspan=2><font size=""1""><b>" & LinkOrdena("Código","codigo_interno") & "</font></td>"
    ShowHTML "          <td rowspan=2><font size=""1""><b>" & LinkOrdena("Outra parte","nm_outra_parte_resumido") & "</font></td>"
    If Mid(SG,1,3) = "GCR" Then
       ShowHTML "          <td rowspan=2><font size=""1""><b>" & LinkOrdena("Classificação","nm_cc") & "</font></td>"
    Else
       ShowHTML "          <td rowspan=2><font size=""1""><b>Classif./Projeto</font></td>"
    End IF
    ShowHTML "          <td colspan=2><font size=""1""><b>Vigência</font></td>"
    ShowHTML "          <td rowspan=2><font size=""1""><b>" & LinkOrdena("$ Previsto","valor") & "</font></td>"
    If Instr(uCase(R),"GR_") > 0 Then
       ShowHTML "          <td rowspan=2><font size=""1""><b>" & LinkOrdena("$ Real","valor_atual") & "</font></td>"
    End If
    If P1 <> 1 Then ' Se for cadastramento ou mesa de trabalho
    ...
    Else
      ...
      While Not RS.EOF and RS.AbsolutePage = P3
        ...
        Else
           ...
           End IF
        End If
        ShowHTML "        <A class=""hl"" HREF=""" & w_dir & w_pagina & "Visual&R=" & w_pagina & par & "&O=L&w_chave=" & RS("sq_siw_solicitacao") & "&w_tipo=Volta&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & MontaFiltro("GET") & """ title=""" & RS("objeto") & """>" & RS("codigo_interno") & "&nbsp;</a>"
        ...
        Else
           ShowHTML "        <td><font size=""1""><A class=""hl"" HREF=""" & w_dir & w_pagina & "Visual&O=L&w_chave=" & RS("sq_solic_pai") & "&w_tipo=Volta&P1=2&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & """ title=""Exibe as informações do projeto."" target=""_blank"">" & RS("nm_projeto") & "</a></td>"
        End If
        ...
        If Instr(uCase(R),"GR_") > 0 Then
           If cDbl(Nvl(RS("valor_atual"),0)) > 0 and cDbl(Nvl(RS("valor_atual"),0)) <> cDbl(RS("valor")) Then
              ShowHTML "        <td align=""right""><font size=""1"" color=""#BC3131""><b>" & FormatNumber(Nvl(RS("valor_atual"),0),2) & "&nbsp;</td>"
           Else
              ShowHTML "        <td align=""right""><font size=""1"">" & FormatNumber(Nvl(RS("valor_atual"),0),2) & "&nbsp;</td>"
           End If
           w_atual = w_atual + cDbl(Nvl(RS("valor_atual"),0))
        End If
        If P1 <> 1 Then ' Se for cadastramento ou mesa de trabalho
        ...
        If Session("interno") = "S" Then 
           ...
           If P1 <> 3 Then ' Se não for acompanhamento
              ...
              ElseIf P1 = 1 Then ' Se for cadastramento
                 If w_submenu > "" Then
                    ShowHTML "          <A class=""hl"" HREF=""Menu.asp?par=ExibeDocs&O=A&w_chave=" & RS("sq_siw_solicitacao") & "&R=" & w_pagina & par & "&SG=" & SG & "&TP=" & TP & "&w_documento=" & RS("codigo_interno") & MontaFiltro("GET") & """ title=""Altera as informações cadastrais do contrato"" TARGET=""menu"">Alterar</a>&nbsp;"
                 Else
      ...
      If P1 <> 1 and P1 <> 2 Then ' Se não for cadastramento nem mesa de trabalho
         ...
         If RS.PageCount > 1 Then
            ...
            If Instr(uCase(R),"GR_") > 0 Then
               ShowHTML "          <td align=""right""><font size=""1""><b>" & FormatNumber(w_atual,2) & "&nbsp;</font></td>"
            End If
         ...
         If P3 = RS.PageCount Then
            RS.MoveFirst
            While Not RS.EOF
              w_real  = w_real  + cDbl(Nvl(RS("valor_atual"),0))
            ...
            If Instr(uCase(R),"GR_") > 0 Then
               ShowHTML "          <td align=""right""><font size=""1""><b>" & FormatNumber(w_real,2) & "&nbsp;</font></td>"
            End If
            ShowHTML "          <td colspan=2><font size=""1"">&nbsp;</font></td>"
            ShowHTML "        </tr>"
         End If
...
Sub Geral
  ...
  If cDbl(Nvl(w_sq_tipo_acordo,0)) > 0 Then
     DB_GetAgreeType RS, w_sq_tipo_acordo, null, w_cliente, SG
       ...
       If w_nome > "" Then
          ...
          Else
            While Not RS.EOF
              ...
              Else
                 ShowHTML "          <A class=""hl"" HREF=""" & w_dir & w_pagina & par & "&R=" & R & "&O=A&w_cnpj=" & RS("cnpj") & "&w_sq_pessoa=" & RS("sq_pessoa") & "&w_chave=" & w_chave & "&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & "&Botao=Selecionar"">Selecionar</A>&nbsp"
              End If
              ShowHTML "        </td>"
              ShowHTML "      </tr>"
              RS.MoveNext
...
Sub parcelas
  ...
  If O = "L" Then
    ...
    If w_total > 0 Then
       ...
       If round(cDbl(w_valor_inicial) - cDbl(w_total),2) <> 0 Then
...
Sub Concluir
  ...
  Dim w_inicio, w_fim, w_valor
  Dim w_tipo_conc
  
  Dim w_troca, i, w_erro, w_tramite
  
  w_Chave           = Request("w_Chave")
  w_tipo_conc       = Nvl(Request("w_tipo_conc"),-1)
  w_chave_aux       = Request("w_chave_aux")
  w_troca           = Request("w_troca")
  ...
  DB_GetSolicData RS, w_chave, Mid(SG,1,3) & "GERAL"
  w_tramite      = RS("sq_siw_tramite")
  w_inicio_real  = FormataDataEdicao(FormatDateTime(RS("inicio"),2))
  w_fim_real     = FormataDataEdicao(FormatDateTime(RS("fim"),2))
  w_custo_real   = FormatNumber(RS("valor"),2)
  DesconectaBD
  ...
  ShowHTML "<HR>"
  AbreForm "Form", w_dir & w_pagina & "Grava", "POST", "return(Validacao(this));", null,P1,P2,P3,P4,TP,Mid(SG,1,3)&"CONC",R,O
  ShowHTML MontaFiltro("POST")
  ShowHTML "<INPUT type=""hidden"" name=""w_chave"" value=""" & w_chave & """>"
  ShowHTML "<INPUT type=""hidden"" name=""w_menu"" value=""" & w_menu & """>"
  ShowHTML "<INPUT type=""hidden"" name=""w_troca"" value="""">"
  ...
  If w_tipo_conc = 2 Then
     ShowHTML "              <td><font size=""1""><b>Da<u>t</u>a da rescisão:</b><br><input " & w_Disabled & " accesskey=""T"" type=""text"" name=""w_fim_real"" class=""sti"" SIZE=""10"" MAXLENGTH=""10"" VALUE=""" & w_fim_real & """ onKeyDown=""FormataData(this,event);"" title=""Informe a data da rescisão.""></td>"
  Else
     ShowHTML "<INPUT type=""hidden"" name=""w_fim_real"" value=""" & w_fim_real & """>"
  End If
  ShowHTML "          </table>"
  If w_tipo_conc = 2 Then
     ShowHTML "      <tr><td><font size=""1""><b>Motivo da r<u>e</u>scisão:</b><br>"  
  Else
     ShowHTML "      <tr><td><font size=""1""><b>Obs<u>e</u>rvação:</b><br>"  
  End If
  ...
  If w_tipo_conc = 0 Then
     w_inicio = FormataDataEdicao(cDate(w_fim_real)+1)
     w_fim    = FormataDataEdicao(cDate(w_inicio) + (cDate(w_fim_real)-cDate(w_inicio_real)))
     w_valor  = w_custo_real
     ShowHTML "      <tr><td align=""center"" bgcolor=""" & conTrBgColor & """ style=""border: 1px solid rgb(0,0,0);""><font size=""1""><b>Dados para a renovação do contrato</font></td>"
     ShowHTML "      <tr><td colspan=""2""><table border=0 width=""100%"" cellspacing=0>"
     ShowHTML "          <tr valign=""top"">"
     ShowHTML "              <td><font size=""1""><b><u>I</u>nício da vigência:</b><br><input " & w_Disabled & " accesskey=""I"" type=""text"" name=""w_inicio"" class=""sti"" SIZE=""10"" MAXLENGTH=""10"" VALUE=""" & w_inicio & """ onKeyDown=""FormataData(this,event);"" title=""Informe o início da vigência do novo contrato.""></td>"
     ShowHTML "              <td><font size=""1""><b><u>T</u>érmino da vigência:</b><br><input " & w_Disabled & " accesskey=""T"" type=""text"" name=""w_fim"" class=""sti"" SIZE=""10"" MAXLENGTH=""10"" VALUE=""" & w_fim & """ onKeyDown=""FormataData(this,event);"" title=""Informe o termino da vigência do novo contrato.""></td>"
     ShowHTML "              <td><font size=""1""><b>Valor aco<u>r</u>dado:</b><br><input " & w_Disabled & " accesskey=""O"" type=""text"" name=""w_valor"" class=""STI"" SIZE=""18"" MAXLENGTH=""18"" VALUE=""" & w_valor & """ onKeyDown=""FormataValor(this,18,2,event);"" TITLE=""Informe o valor total real ou estimado para o novo contrato.""></td>"
     ShowHTML "          </table>"
  End If
  ShowHTML "      <tr><td align=""LEFT"" colspan=4><font size=""1""><b><U>A</U>ssinatura Eletrônica:<BR> <INPUT ACCESSKEY=""A"" class=""sti"" type=""PASSWORD"" name=""w_assinatura"" size=""30"" maxlength=""30"" value=""""></td></tr>"
  ShowHTML "    <tr><td align=""center"" colspan=4><hr>"
...
Sub SolicMail(p_solic, p_tipo)
  ...
  Dim w_cab, w_html, w_texto, w_solic, RSM, RSM1, w_resultado, w_destinatarios
  ...
  w_html = w_html & VbCrLf & "      <tr><td><font size=1>Objeto: <b>" & RSM("codigo_interno") & " (" & RSM("sq_siw_solicitacao") & ")<br>" & CRLF2BR(RSM("objeto")) & "</b></font></td></tr>"
      
  ' Identificação do contrato
  w_html = w_html & VbCrLf & "      <tr><td align=""center"" bgcolor=""#D0D0D0"" style=""border: 2px solid rgb(0,0,0);""><font size=""1""><b>EXTRATO DO CONTRATO</td>"
  ...
  w_html = w_html & VbCrLf & "          <td><font size=""1"">Responsável pelo monitoramento:<br><b>" & RSM("nm_solic") & "</b></td>"
  ...
  ' Outra parte
  DB_GetBenef RSM1, w_cliente, Nvl(RSM("outra_parte"),0), null, null, null, Nvl(RSM("sq_tipo_pessoa"),0), null, null
  If Not RSM1.EOF Then
     ...
     w_html = w_html & VbCrLf & "          " & RSM1("nm_pessoa") & " (" & RSM1("nome_resumido") & ")"
     If cDbl(Nvl(RSM("sq_tipo_pessoa"),0)) = 1 Then
        w_html = w_html & VbCrLf & "          - " & RSM1("cpf")
     Else
        w_html = w_html & VbCrLf & "          - " & RSM1("cnpj")
     End IF
  End If
...
Public Sub Grava
  ...
  If Instr(SG, "GERAL") > 0 Then
     ...
     If (VerificaAssinaturaEletronica(Session("Username"),w_assinatura) and w_assinatura > "") or _
        ...
        ElseIf O = "E" Then
           ShowHTML "  location.href='" & R & "&O=L&R=" & R & "&SG="&Mid(SG,1,3)&"CAD&w_menu=" & w_menu & "&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & MontaFiltro("GET") & "';"
        Else
  ...
  ElseIf Instr(SG, "ANEXO") > 0 Then
     ...
     If (VerificaAssinaturaEletronica(Session("Username"),w_assinatura) and w_assinatura > "") or _
        ...
        ShowHTML "  location.href='" & R & "&O=L&w_chave=" & ul.Form("w_chave") & "&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & "';" 
        ScriptClose
     Else
        ScriptOpen "JavaScript"
        ShowHTML "  alert('Assinatura Eletrônica inválida!');"
  ...
  ElseIf Instr(SG, "CONC") > 0 Then
     ...
     If (VerificaAssinaturaEletronica(Session("Username"),w_assinatura) and w_assinatura > "") or _
        ...
        DB_GetSolicData RS, Request("w_chave"), Mid(SG,1,3)&"GERAL" 
        ...
        Else
           dbms.BeginTrans
           DML_PutAcordoConc w_menu, Request("w_chave"), w_usuario, Request("w_tramite"), _
               Request("w_inicio_real"), Request("w_fim_real"), Request("w_nota_conclusao"), _
               Request("w_custo_real"), Request("w_tipo_conc")
           
           ' Se for renovação, grava os registros a partir do contrato atual
           If Request("w_tipo_conc") = 0 Then
              ' Grava dados gerais
              DML_PutAcordoGeral "I", w_cliente, _
                  null, RS("sq_menu"), RS("sq_unidade"), RS("solicitante"), _
                  Session("sq_pessoa"), RS("sq_cc"), RS("descricao"), RS("justificativa"), _
                  Request("w_inicio"), Request("w_fim"), Request("w_valor"), RS("data_hora"), _
                  RS("aviso_prox_conc"), RS("dias_aviso"), RS("sq_cidade_origem"), RS("sq_solic_pai"), _
                  RS("sq_tipo_acordo"), RS("objeto"), RS("sq_tipo_pessoa"), _
                  RS("sq_forma_pagamento"), null, null, _
                  w_chave_nova, Request("w_chave"), w_codigo
           End If
           dbms.CommitTrans
