  ...
  If O = "L" or O = "W" Then
    ...
    Else
      If O = "L" Then
         ...
         Select case p_agrega
            Case "GRISAACAO"    ShowHTML "      document.Form.p_acao.value=filtro;"
            Case "GRISAPROP"    ShowHTML "      document.Form.p_proponente.value=filtro;"
         ...
         ShowHTML "    }"
         Select case p_agrega
            Case "GRISAACAO"    ShowHTML "    else document.Form.p_acao.value='" & Request("p_acao")& "';"
            Case "GRISAPROP"    ShowHTML "    else document.Form.p_proponente.value=""" & Request("p_proponente")& """;"
         ...
         Select case p_agrega
            Case "GRISAACAO"    If Request("p_acao") = ""        Then ShowHTML "<input type=""Hidden"" name=""p_acao"" value="""">"       End If
            Case "GRISAPROP"    If Request("p_proponente") = ""  Then ShowHTML "<input type=""Hidden"" name=""p_proponente"" value="""">"    End If
      ...
      While Not RS1.EOF
        ...
        If O = "W" and w_linha > 25 Then ' Se for geração de MS-Word, quebra a página
           ...
           ImprimeCabecalho
           Select Case p_agrega
              Case "GRISAACAO"    ShowHTML "      <tr bgcolor=""" & w_cor & """ valign=""top""><td><font size=1><b>" & RS1("titulo")
              Case "GRISAPROP"    ShowHTML "      <tr bgcolor=""" & w_cor & """ valign=""top""><td><font size=1><b>" & RS1("proponente")
...
Sub ImprimeCabecalho
    ...
    Select case p_agrega
       Case "GRISAACAO"    ShowHTML "          <td><font size=""1""><b>Ação</font></td>"
       Case "GRISAPROP"    ShowHTML "          <td><font size=""1""><b>Parceria externa</font></td>"
