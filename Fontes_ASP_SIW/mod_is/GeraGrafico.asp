...
With cso
   ...
   asSeriesNames(1) = "Programação"
   asSeriesNames(2) = "Monitoramento"
   asSeriesNames(3) = "Concluídas"
   asSeriesNames(4) = "Atrasadas"
   asSeriesNames(5) = "Em aviso de atraso"
   asSeriesNames(6) = "Acima do valor previsto"
   asCategories(0) = "Total"
   asCategories(1) = "Programação"
   asCategories(2) = "Monitoramento"
   asCategories(3) = "Concluídas"
