...
Sub Gerencial
  ...
  If O = "L" or O = "V" or O = "W" Then
     ...
     If p_projeto > ""  Then 
        ...
        w_filtro = w_filtro & "<tr valign=""top""><td align=""right"">Projeto <td>[<b><A class=""hl"" HREF=""Projeto.asp?par=Visual&O=L&w_chave=" & p_projeto & "&w_tipo=Volta&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & """ title=""Exibe as informações do projeto."">" & RS("titulo") & "</a></b>]"
     End If
     If p_sqcc > ""  Then 
     ...
     If p_solicitante > ""  Then
        ...
        w_filtro = w_filtro & "<tr valign=""top""><td align=""right"">Responsável <td>[<b>" & RS("nome_resumido") & "</b>]"
     End If
     If p_unidade     > ""  Then 
...
Sub ImprimeCabecalho
    ...
    Select case p_agrega
       ...
       Case "GRDMRESP"    ShowHTML "          <td><b>Responsável</font></td>"
       Case "GRDMRESPATU" ShowHTML "          <td><b>Executor</font></td>"
       Case "GRDMCC"      ShowHTML "          <td><b>Classificação</font></td>"
       Case "GRDMSETOR"   ShowHTML "          <td><b>Setor responsável</font></td>"
       Case "GRDMPRIO"    ShowHTML "          <td><b>Prioridade</font></td>"
       Case "GRDMLOCAL"   ShowHTML "          <td><b>UF</font></td>"
       Case "GRDMAREA"    ShowHTML "          <td><b>Área envolvida</font></td>"
