...
Sub Gerencial
  ...
  If O = "L" or O = "V" or O = "W" Then
     ...
     End If
     If p_chave       > ""  Then w_filtro = w_filtro & "<tr valign=""top""><td align=""right"">Projeto nº <td>[<b>" & p_chave & "</b>]" End If
     ...
     If p_palavra     > ""  Then w_filtro = w_filtro & "<tr valign=""top""><td align=""right"">Nº do Pronac <td>[<b>" & p_palavra & "</b>]"                     End If
     If p_ini_i       > ""  Then w_filtro = w_filtro & "<tr valign=""top""><td align=""right"">Data recebimento <td>[<b>" & p_ini_i & "-" & p_ini_f & "</b>]"     End If
     If p_fim_i       > ""  Then w_filtro = w_filtro & "<tr valign=""top""><td align=""right"">Limite conclusão <td>[<b>" & p_fim_i & "-" & p_fim_f & "</b>]"     End If
     ...
     Select case p_agrega
        ...
        Case "GRPRCC"
           ...
           RS1.sort = "sg_cc"
        Case "GRPRSETOR"
           w_TP = TP & " - Por unidade responsável"
           DB_GetSolicList RS1, P2, w_usuario, p_agrega, 4, _
                p_ini_i, p_ini_f, p_fim_i, p_fim_f, p_atraso, p_solicitante, _
                p_unidade, p_prioridade, p_ativo, p_proponente, _
                p_chave, p_assunto, p_pais, p_regiao, p_uf, p_cidade, p_usu_resp, _
  ...
  ElseIf Instr("P",O) > 0 Then
    ...
    If RS_menu("solicita_cc") = "S" Then
       Select case p_agrega
          Case "GRPRCC"      ShowHTML "          <option value=""GRPRCC"" selected>Classificação<option value=""GRPRRESPATU"">Executor<option value=""GRPRPRIO"">Prioridade<option value=""GRPRPROJ"">Projeto<option value=""GRPRPROP"">Proponente<option value=""GRPRRESP"">Gerente<option value=""GRPRSETOR"">Unidade responsável<option value=""GRPRLOCAL"">UF"
          Case "GRPRPRIO"    ShowHTML "          <option value=""GRPRCC"">Classificação<option value=""GRPRRESPATU"">Executor<option value=""GRPRPRIO"" selected>Prioridade<option value=""GRPRPROJ"">Projeto<option value=""GRPRPROP"">Proponente<option value=""GRPRRESP"">Gerente<option value=""GRPRSETOR"">Unidade responsável<option value=""GRPRLOCAL"">UF"
          Case "GRPRPROJ"    ShowHTML "          <option value=""GRPRCC"">Classificação<option value=""GRPRRESPATU"">Executor<option value=""GRPRPRIO"">Prioridade<option value=""GRPRPROJ"" selected>Projeto<option value=""GRPRPROP"">Proponente<option value=""GRPRRESP"">Gerente<option value=""GRPRSETOR"">Unidade responsável<option value=""GRPRLOCAL"">UF"
          Case "GRPRPROP"    ShowHTML "          <option value=""GRPRCC"">Classificação<option value=""GRPRRESPATU"">Executor<option value=""GRPRPRIO"">Prioridade<option value=""GRPRPROJ"">Projeto<option value=""GRPRPROP"" selected>Proponente<option value=""GRPRRESP"">Gerente<option value=""GRPRSETOR"">Unidade responsável<option value=""GRPRLOCAL"">UF"
          Case "GRPRRESPATU" ShowHTML "          <option value=""GRPRCC"">Classificação<option value=""GRPRRESPATU"" selected>Executor<option value=""GRPRPRIO"">Prioridade<option value=""GRPRPROJ"">Projeto<option value=""GRPRPROP"">Proponente<option value=""GRPRRESP"">Gerente<option value=""GRPRSETOR"">Unidade responsável<option value=""GRPRLOCAL"">UF"
          Case "GRPRSETOR"   ShowHTML "          <option value=""GRPRCC"">Classificação<option value=""GRPRRESPATU"">Executor<option value=""GRPRPRIO"">Prioridade<option value=""GRPRPROJ"">Projeto<option value=""GRPRPROP"">Proponente<option value=""GRPRRESP"">Gerente<option value=""GRPRSETOR"" selected>Unidade responsável<option value=""GRPRLOCAL"">UF"
          Case "GRPRLOCAL"   ShowHTML "          <option value=""GRPRCC"">Classificação<option value=""GRPRRESPATU"">Executor<option value=""GRPRPRIO"">Prioridade<option value=""GRPRPROJ"">Projeto<option value=""GRPRPROP"">Proponente<option value=""GRPRRESP"">Gerente<option value=""GRPRSETOR"">Unidade responsável<option value=""GRPRLOCAL"" selected>UF"
          Case Else          ShowHTML "          <option value=""GRPRCC"">Classificação<option value=""GRPRRESPATU"">Executor<option value=""GRPRPRIO"">Prioridade<option value=""GRPRPROJ"">Projeto<option value=""GRPRPROP"">Proponente<option value=""GRPRRESP"" selected>Gerente<option value=""GRPRSETOR"">Unidade responsável<option value=""GRPRLOCAL"">UF"
       End Select
    Else
       Select case p_agrega
          Case "GRPRCC"      ShowHTML "          <option value=""GRPRRESPATU"">Executor<option value=""GRPRPRIO"">Prioridade<option value=""GRPRPROJ"">Projeto<option value=""GRPRPROP"">Proponente<option value=""GRPRRESP"">Gerente<option value=""GRPRSETOR"">Unidade responsável<option value=""GRPRLOCAL"">UF"
          Case "GRPRPRIO"    ShowHTML "          <option value=""GRPRRESPATU"">Executor<option value=""GRPRPRIO"" selected>Prioridade<option value=""GRPRPROJ"">Projeto<option value=""GRPRPROP"">Proponente<option value=""GRPRRESP"">Gerente<option value=""GRPRSETOR"">Unidade responsável<option value=""GRPRLOCAL"">UF"
          Case "GRPRPROJ"    ShowHTML "          <option value=""GRPRRESPATU"">Executor<option value=""GRPRPRIO"">Prioridade<option value=""GRPRPROJ"" selected>Projeto<option value=""GRPRPROP"">Proponente<option value=""GRPRRESP"">Gerente<option value=""GRPRSETOR"">Unidade responsável<option value=""GRPRLOCAL"">UF"
          Case "GRPRPROP"    ShowHTML "          <option value=""GRPRRESPATU"">Executor<option value=""GRPRPRIO"">Prioridade<option value=""GRPRPROJ"">Projeto<option value=""GRPRPROP"" selected>Proponente<option value=""GRPRRESP"">Gerente<option value=""GRPRSETOR"">Unidade responsável<option value=""GRPRLOCAL"">UF"
          Case "GRPRRESPATU" ShowHTML "          <option value=""GRPRRESPATU"" selected>Executor<option value=""GRPRPRIO"">Prioridade<option value=""GRPRPROJ"">Projeto<option value=""GRPRPROP"">Proponente<option value=""GRPRRESP"">Gerente<option value=""GRPRSETOR"">Unidade responsável<option value=""GRPRLOCAL"">UF"
          Case "GRPRSETOR"   ShowHTML "          <option value=""GRPRRESPATU"">Executor<option value=""GRPRPRIO"">Prioridade<option value=""GRPRPROJ"">Projeto<option value=""GRPRPROP"">Proponente<option value=""GRPRRESP"">Gerente<option value=""GRPRSETOR"" selected>Unidade responsável<option value=""GRPRLOCAL"">UF"
          Case "GRPRLOCAL"   ShowHTML "          <option value=""GRPRRESPATU"">Executor<option value=""GRPRPRIO"">Prioridade<option value=""GRPRPROJ"">Projeto<option value=""GRPRPROP"">Proponente<option value=""GRPRRESP"">Gerente<option value=""GRPRSETOR"">Unidade responsável<option value=""GRPRLOCAL"" selected>UF"
          Case Else          ShowHTML "          <option value=""GRPRRESPATU"">Executor<option value=""GRPRPRIO"">Prioridade<option value=""GRPRPROJ"">Projeto<option value=""GRPRPROP"">Proponente<option value=""GRPRRESP"" selected>Gerente<option value=""GRPRSETOR"">Unidade responsável<option value=""GRPRLOCAL"">UF"
       End Select
    End If
    ShowHTML "          </select></td>"
    MontaRadioNS "<b>Inibe exibição do gráfico?</b>", p_tipo, "p_tipo"
    MontaRadioSN "<b>Limita tamanho do título?</b>", p_tamanho, "p_tamanho"
    ShowHTML "           </table>"
    ShowHTML "         </tr>"
    ...
    ShowHTML "          <td valign=""top""><b>N<u>ú</u>mero do projeto:<br><INPUT ACCESSKEY=""U"" " & w_Disabled & " class=""sti"" type=""text"" name=""p_chave"" size=""18"" maxlength=""18"" value=""" & p_chave & """></td>"
    ...
    ShowHTML "      <tr valign=""top"">"
    SelecaoPessoa "Gere<u>n</u>te:", "N", "Selecione o gerente do projeto na relação.", p_solicitante, null, "p_solicitante", "Gerente"
    ...
    'SelecaoUnidade "<U>S</U>etor executor:", "S", "Selecione a unidade onde o projeto se encontra na relação.", p_uorg_resp, null, "p_uorg_resp", null, null
    'ShowHTML "      <tr>"
    ...
    ShowHTML "          <td valign=""top"" colspan=2><b>Nº do Pron<U>a</U>c:<br><INPUT ACCESSKEY=""A"" " & w_Disabled & " class=""sti"" type=""text"" name=""p_palavra"" size=""20"" maxlength=""20"" value=""" & p_palavra & """></td>"
    ShowHTML "      <tr>"
    ShowHTML "          <td valign=""top""><b>Iní<u>c</u>io do evento:</b><br><input " & w_Disabled & " accesskey=""C"" type=""text"" name=""p_ini_i"" class=""sti"" SIZE=""10"" MAXLENGTH=""10"" VALUE=""" & p_ini_i & """ onKeyDown=""FormataData(this,event);""> e <input " & w_Disabled & " accesskey=""C"" type=""text"" name=""p_ini_f"" class=""sti"" SIZE=""10"" MAXLENGTH=""10"" VALUE=""" & p_ini_f & """ onKeyDown=""FormataData(this,event);""></td>"
...
Sub ImprimeCabecalho
    ...
    Select case p_agrega
       ...
       Case "GRPRCC"      ShowHTML "          <td><b>Classificação</font></td>"
       Case "GRPRSETOR"   ShowHTML "          <td><b>Unidade responsável</font></td>"
       Case "GRPRPRIO"    ShowHTML "          <td><b>Prioridade</font></td>"
       Case "GRPRLOCAL"   ShowHTML "          <td><b>UF</font></td>"
       Case "GRPRAREA"    ShowHTML "          <td><b>Área envolvida</font></td>"
