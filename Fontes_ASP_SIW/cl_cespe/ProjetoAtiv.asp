...
Sub Inicial
  ...
  If O = "L" Then
     If Instr(uCase(R),"GR_") > 0 or Instr(uCase(R),"PROJETO") > 0 Then
        ...
        If p_projeto > ""  Then 
           ...
           w_filtro = w_filtro & "<tr valign=""top""><TD align=""right""><font size=1>Projeto <TD><font size=1>[<b><A class=""hl"" HREF=""" & w_dir & "Projeto.asp?par=Visual&O=L&w_chave=" & p_projeto & "&w_tipo=Volta&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & """ title=""Exibe as informações do projeto."">" & RS("titulo") & "</a></b>]"
        End If
        If p_atividade > ""  Then 
    ...
    Else
      ...
      While Not RS.EOF and RS.AbsolutePage = P3
        ...
        If p_projeto > "" Then
           ...
           End If
        Else
           ShowHTML "        <TD><A class=""hl"" HREF=""" & w_dir & "Projeto.asp?par=Visual&O=L&w_chave=" & RS("sq_solic_pai") & "&w_tipo=Volta&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & """ title=""Exibe as informações do projeto."">" & RS("nm_projeto") & "</a></td>"
        End If
        ...
        If P1 <> 3 Then ' Se não for acompanhamento
           ...
           ElseIf P1 = 1 Then ' Se for cadastramento
              ...
              Else
                 ShowHTML "          <A class=""hl"" HREF=""" & w_dir & w_Pagina & par & "&R=" & w_Pagina & par & "&O=A&w_chave=" & RS("sq_siw_solicitacao") & "&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & MontaFiltro("GET") & """ title=""Altera as informações cadastrais da atividade"">Alterar</A>&nbsp"
              End If
              ShowHTML "          <A class=""hl"" HREF=""" & w_dir & w_Pagina & "Excluir&R=" & w_Pagina & par & "&O=E&w_chave=" & RS("sq_siw_solicitacao") & "&w_tipo=Volta&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & MontaFiltro("GET") & """ title=""Exclusão da atividade."">Excluir</A>&nbsp"
           ElseIf P1 = 2 Then ' Se for execução
              If cDbl(w_usuario) = cDbl(RS("executor")) Then
                 ShowHTML "          <A class=""hl"" HREF=""" & w_dir & w_Pagina & "Anotacao&R=" & w_Pagina & par & "&O=V&w_chave=" & RS("sq_siw_solicitacao") & "&w_tipo=Volta&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & MontaFiltro("GET") & """ title=""Registra anotações para a atividade, sem enviá-la."">Anotar</A>&nbsp"
                 ShowHTML "          <A class=""hl"" HREF=""" & w_dir & w_Pagina & "envio&R=" & w_Pagina & par & "&O=V&w_chave=" & RS("sq_siw_solicitacao") & "&w_tipo=Volta&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & MontaFiltro("GET") & """ title=""Envia a atividade para outro responsável."">Enviar</A>&nbsp"
                 ShowHTML "          <A class=""hl"" HREF=""" & w_dir & w_Pagina & "Concluir&R=" & w_Pagina & par & "&O=V&w_chave=" & RS("sq_siw_solicitacao") & "&w_tipo=Volta&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & MontaFiltro("GET") & """ title=""Conclui a execução da atividade."">Concluir</A>&nbsp"
              Else
                 ShowHTML "          <A class=""hl"" HREF=""" & w_dir & w_Pagina & "envio&R=" & w_Pagina & par & "&O=V&w_chave=" & RS("sq_siw_solicitacao") & "&w_tipo=Volta&P1=" & P1 & "&P2=" & P2 & "&P3=" & P3 & "&P4=" & P4 & "&TP=" & TP & "&SG=" & SG & MontaFiltro("GET") & """ title=""Envia a atividade para outro responsável."">Enviar</A>&nbsp"
              End If
           End If
  ...
  ElseIf Instr("CP",O) > 0 Then
    ...
    SelecaoProjeto "Pro<u>j</u>eto:", "J", "Selecione o projeto da atividade na relação.", p_projeto, w_usuario, RS("sq_menu"), "p_projeto", "PJLIST", "onChange=""document.Form.action='" & w_dir & w_pagina & par & "'; document.Form.O.value='" & O & "'; document.Form.w_troca.value='p_atividade'; document.Form.submit();"""
    DesconectaBD
    ShowHTML "      </tr>"
    ShowHTML "      <tr>"
...
Sub Geral
  ...
  If Instr("IAEV",O) > 0 Then
    ...
    ShowHTML "      <tr>"
    DB_GetLinkData RS, w_cliente, "PJCAD"
    SelecaoProjeto "Pro<u>j</u>eto:", "J", "Selecione o projeto da atividade na relação.", w_projeto, w_usuario, RS("sq_menu"), "w_projeto", "PJLISTCAD", "onChange=""document.Form.action='" & w_dir & w_pagina & par & "'; document.Form.w_troca.value='w_atividade'; document.Form.submit();"""
    DesconectaBD
    ShowHTML "      </tr>"
    ...
    End If
    ShowHTML "      <tr><TD valign=""top"" colspan=""2""><table border=0 width=""100%"" cellspacing=0>"
    SelecaoPessoa "Respo<u>n</u>sável:", "N", "Selecione o responsável pela atividade na relação.", w_solicitante, null, "w_solicitante", "USUARIOS"
    SelecaoUnidade "<U>U</U>nidade responsável:", "U", "Selecione a unidade responsável pela execução da atividade", w_sq_unidade_resp, null, "w_sq_unidade_resp", null, null
  ...
  If O = "L" Then 
    ...
    Else 
      ...
      While Not RS.EOF 
        If w_cor = conTrBgColor or w_cor = "" Then w_cor = conTrAlternateBgColor Else w_cor = conTrBgColor End If 
        ShowHTML "      <tr bgcolor=""" & w_cor & """ valign=""top"">" 
        ShowHTML "        <TD><a class=""hl"" href=""" & conFileVirtual & w_cliente & "/" & RS("caminho") & """ target=""_blank"" title=""Clique para exibir o arquivo em outra janela."">" & RS("nome") & "</a></td>" 
  ...
  If O = "L" Then
    ...
    Else
      ...
      While Not RS.EOF
        ...
        ShowHTML "        " & Replace(Replace(RS("envia_email"),"S","Sim"),"N","Não") & "</td>"
        ShowHTML "        <TD align=""top"" nowrap>"
...
Sub Areas
  ...
  If O = "L" Then
    ...
    ShowHTML "    <TABLE WIDTH=""100%"" bgcolor=""" & conTableBgColor & """ BORDER=""" & conTableBorder & """ CELLSPACING=""" & conTableCellSpacing & """ CELLPADDING=""" & conTableCellPadding & """ BorderColorDark=""" & conTableBorderColorDark & """ BorderColorLight=""" & conTableBorderColorLight & """>"
    ShowHTML "        <tr bgcolor=""" & conTrBgColor & """ align=""center"">"
    ShowHTML "          <TD><b>Área/Instituição</font></td>"
...
Sub Encaminhamento
  ...
  If P1 <> 1 Then ' Se não for cadastramento
     SelecaoFase "<u>F</u>ase da atividade:", "F", "Se deseja alterar a fase atual da atividade, selecione a fase para a qual deseja enviá-la.", w_novo_tramite, w_menu, "w_novo_tramite", null, "onChange=""document.Form.action='" & w_dir & w_pagina & par & "'; document.Form.O.value='" & O & "'; document.Form.w_troca.value='w_destinatario'; document.Form.submit();"""
...
Sub Anotar
  ...
  ShowHTML "<HR>"
  ShowHTML "<FORM action=""" & w_dir & w_pagina & "Grava&SG=GDPENVIO&O="&O&"&w_menu="&w_menu&""" name=""Form"" onSubmit=""return(Validacao(this));"" enctype=""multipart/form-data"" method=""POST"">"
  ShowHTML "<INPUT type=""hidden"" name=""P1"" value=""" & P1 & """>"
  ShowHTML "<INPUT type=""hidden"" name=""P2"" value=""" & P2 & """>"
  ShowHTML "<INPUT type=""hidden"" name=""P3"" value=""" & P3 & """>"
  ShowHTML "<INPUT type=""hidden"" name=""P4"" value=""" & P4 & """>"
...
Sub SolicMail(p_solic, p_tipo)
  ...
  If p_tipo = 1 Then
     w_html = w_html & "      <tr valign=""top""><b>INCLUSÃO DE ATIVIDADE</b></font><br><br><TD></tr>" & VbCrLf
  ElseIf p_tipo = 2 Then
     w_html = w_html & "      <tr valign=""top""><b>TRAMITAÇÃO DE ATIVIDADE</b></font><br><br><TD></tr>" & VbCrLf
  ElseIf p_tipo = 3 Then
     w_html = w_html & "      <tr valign=""top""><b>CONCLUSÃO DE ATIVIDADE</b></font><br><br><TD></tr>" & VbCrLf
  End IF
  ...
  w_html = w_html & VbCrLf & "          <TD>Responsável:<br><b>" & RSM("nm_sol") & "</b></td>"
  ...
  w_html = w_html & VbCrLf & "          <TD>Limite para conclusão:<br><b>" & FormataDataEdicao(RSM("fim")) & " </b></td>"
  ...
  ' Recupera o e-mail do titular e do substituto pela unidade responsável
