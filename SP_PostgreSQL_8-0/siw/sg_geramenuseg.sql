create or replace FUNCTION SG_GeraMenuSeg(p_cliente_base numeric, p_modulo varchar, p_segmento numeric ) RETURNS VOID AS $$
DECLARE
...
-- Deve ser informada a chave do cliente que fornecerá o modelo e o módulo a ser gerado
  ...
  type rec_menu is record (
      sq_menu_destino       numeric(10) := null,
      sq_menu_origem        numeric(10) := null,
      sq_menu_pai_origem    numeric(10) := null
     );
