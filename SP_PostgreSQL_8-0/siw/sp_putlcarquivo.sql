create or replace FUNCTION SP_PutLcArquivo
   (p_operacao             varchar,
    p_cliente             numeric,
    p_chave                numeric,
    p_chave_aux            numeric,
...
BEGIN
   If p_operacao = 'I' Then -- Inclusão
      ...
      -- Insere registro em LC_ARQUIVO
      insert into lc_arquivo
        (sq_portal_lic, sq_siw_arquivo)
      values
        (p_chave, w_chave);
   ...
   Elsif p_operacao = 'E' Then -- Exclusão
      ...
      DELETE FROM lc_arquivo where sq_portal_lic = p_chave and sq_siw_arquivo = p_chave_aux;
