create or replace FUNCTION SP_GetGPColaborador
   (p_cliente                 numeric,
    p_chave                   numeric,
    p_nome                    varchar,
    p_ativo                   varchar,
      ...
      open p_result for 
         select distinct a.sq_pessoa chave, a.ctps_numero, a.ctps_serie, a.ctps_emissor, a.ctps_emissao_data,
          ...
          where a.cliente              = p_cliente 
            ...
            and (p_ativo               is null or ((p_ativo = 'S' and e.fim is null)) or (p_ativo = 'N' and e.fim is not null))
            and (p_unidade_lotacao     is null or (p_unidade_lotacao     is not null and ((p_filhos_lotacao   is null and e.sq_unidade_lotacao   = p_unidade_lotacao)   or (p_filhos_lotacao   is not null and e.sq_unidade_lotacao (select sq_unidade 
                                                                                                                                                                                                                                  from eo_unidade
                                                                                                                                                                                                                                start with sq_unidade = p_unidade_lotacao
                                                                                                                                                                                                                                connect by prior sq_unidade = sq_unidade_pai)))))
            and (p_unidade_exercicio   is null or (p_unidade_exercicio   is not null and ((p_filhos_exercicio is null and e.sq_unidade_exercicio = p_unidade_exercicio) or (p_filhos_exercicio is not null and e.sq_unidade_exercicio (select sq_unidade 
                                                                                                                                                                                                                                  from eo_unidade
