create or replace FUNCTION sp_getSolicSR
   (p_cliente      numeric,
    p_menu         numeric,
    p_pessoa       numeric,
    p_restricao    varchar,
...
BEGIN
   ...
   If Substr(p_restricao,1,2) = 'SR' or Substr(p_restricao,1,4) = 'GRSR' Then
      ...
      open p_result for 
         select a.sq_menu,            a.sq_modulo,                   a.nome,
          ...
          where a.sq_pessoa       = p_cliente
            ...
            and (p_prazo          is null or (p_prazo       is not null and b.conclusao          is null and b.fim-now()+1 <=p_prazo))
            ...
            and (Nvl(p_atraso,'N') = 'N'  or (p_atraso      = 'S'       and b.conclusao          is null and coalesce(b.fim,now())<(now()-1)))
