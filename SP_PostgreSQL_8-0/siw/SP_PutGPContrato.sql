create or replace FUNCTION SP_PutGPContrato
   (p_operacao                  varchar,
    p_cliente                   numeric,
    p_chave                     numeric,    
    p_cc                        numeric,    
    p_sq_pessoa                 numeric,
    p_sq_posto_trabalho         numeric,
    p_sq_modalidade_contrato    numeric,
    p_sq_unidade_lotacao        numeric,    
    p_sq_unidade_exercicio      numeric,
    p_sq_localizacao            numeric,
    p_matricula                 varchar,
    p_inicio                    date,
    p_fim                       date,
    p_trata_username            varchar,
    p_trata_ferias              varchar,
    p_trata_extras              varchar,        
    p_tipo_vinculo              numeric,
    p_entrada_manha             varchar,
    p_saida_manha               varchar,
    p_entrada_tarde             varchar,
    p_saida_tarde               varchar,    
    p_entrada_noite             varchar,
    p_saida_noite               varchar,
    p_sabado                    varchar,
    p_domingo                   varchar,
    p_banco_horas_saldo         varchar,             
    p_banco_horas_data          date,
    p_remuneracao_inicial       numeric,
    p_seguro_saude              varchar,
    p_seguro_odonto             varchar,
    p_seguro_vida               varchar,        
    p_plano_saude               varchar,
    p_plano_odonto              varchar,
    p_plano_vida                varchar,
    p_vale_refeicao             varchar,
    p_vale_transporte           varchar,
    p_observacao_beneficios     varchar,
    p_data_atestado             date,
    p_dias_experiencia          numeric
   ) RETURNS VOID AS $$
DECLARE
   
   w_colaborador      numeric(18);
