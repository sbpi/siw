create or replace FUNCTION SP_PutPAEmpGeral
   (p_operacao             varchar,
    p_chave                numeric,
    p_copia                numeric,
    p_menu                numeric,
...
BEGIN
   ...
   If p_operacao = 'I' Then -- Inclusão
      ...
      (select
         ...
         p_cadastrador,      trunc(now()),       p_fim,               p_justificativa,
   ...
   Elsif p_operacao = 'E' Then -- Exclusão
      ...
      Else
         ...
         DELETE FROM pa_emprestimo_item  where sq_siw_solicitacao = p_chave;
