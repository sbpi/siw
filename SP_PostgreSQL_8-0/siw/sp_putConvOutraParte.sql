create or replace FUNCTION SP_PutConvOutraParte
   ( p_operacao                     varchar,
     p_restricao                    varchar,
...
DECLARE
   ...
   w_sq_siw_solicitacao numeric(18);
...
BEGIN
   If p_operacao = 'E' Then 
      ...
      DELETE FROM ac_acordo_outra_parte  where sq_acordo_outra_parte = p_sq_acordo_outra_parte;
   ...
   Else
      ...
      If p_operacao = 'I' Then
         ...
         values
            (nextVal('sq_acordo_outra_parte'), p_chave, w_chave_pessoa,  p_tipo);
