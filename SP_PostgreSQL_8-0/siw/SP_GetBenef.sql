   ...
   open p_result for 
     select a.sq_pessoa, a.nome as nm_pessoa, a.nome_resumido, a.sq_pessoa_pai, 
       ...
       from co_pessoa                           a
            ...
            left outer join  (select w.sq_pessoa_conta, w.sq_pessoa, x.sq_banco, w.sq_agencia, 
            ...
            left outer join  (select w.sq_pessoa, sq_pessoa_endereco, sq_cidade, logradouro, complemento,
                                     bairro, cep
      ...
      where (a.sq_pessoa_pai      = p_cliente or (a.sq_pessoa = p_cliente and coalesce(a.sq_pessoa_pai,1) = 1))
        ...
        and (p_nome               is null     or (p_nome               is not null and (a.nome_indice       like(upper(acentos('%'||p_nome||'%',null)))) or (a.nome_resumido_ind like(upper(acentos('%'||p_nome||'%',null)))) ))
