   ...
   If w_interno = 'S' Then
      ...
      open p_result for
         select /*+ ordered */ c.sq_pessoa, 
                b.sq_modulo, b.nome as nm_modulo, b.sigla as sg_modulo, b.objetivo_geral, 
                c.sq_menu, c.nome as nm_servico, c.link, c.imagem, c.p1, c.p2, c.p3, c.p4, c.sigla as sg_servico, 
                count(d.sq_siw_solicitacao) as qtd 
           FROM siw_tramite                    e
