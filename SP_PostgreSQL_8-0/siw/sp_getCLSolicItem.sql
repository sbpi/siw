create or replace FUNCTION sp_getCLSolicItem
   (p_chave         numeric,
      ...
      open p_result for 
         select a.sq_solicitacao_item as chave, a.sq_siw_solicitacao, a.quantidade, a.valor_unit_est,
          ...
          where a.quantidade_autorizada > 0
            and a.sq_solicitacao_item   not (select x.item_pedido 
   ...
   ElsIf p_restricao = 'ARPITEM' Then
      ...
      open p_result for 
         select a.sq_solicitacao_item as chave, a.sq_siw_solicitacao, a.quantidade, a.valor_unit_est,
          ...
          where a.sq_solicitacao_item not (select x.item_licitacao from cl_solicitacao_item_vinc x inner join cl_solicitacao_item y on (x.item_pedido = y.sq_solicitacao_item) where y.sq_siw_solicitacao = p_solicitacao)
