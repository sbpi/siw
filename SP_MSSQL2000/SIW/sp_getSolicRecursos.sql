create  procedure sp_getSolicRecursos
   (@p_cliente        int,
    @p_usuario        int,
    @p_chave          int   = null,
    @p_chave_aux      int   = null,
    @p_solicitante    int   = null,
    @p_autorizador    int   = null,
    @p_unidade        int   = null,
    @p_gestora        int   = null,
    @p_recurso        int   = null,
    @p_tipo           varchar(32) = null,
...
begin
   If @p_restricao is null begin
      -- Recupera as indicadors de planejamento
         ...
         select a.sq_solic_recurso as chave_aux,                       a.sq_siw_solicitacao as chave, 
                ...
                dbo.montanometiporecurso(b.sq_tipo_recurso,null) as nm_tipo_completo,
           ...
           from siw_solic_recurso                 a
                inner     join siw_solicitacao    a1 on (a.sq_siw_solicitacao  = a1.sq_siw_solicitacao)
                  ...
                  inner   join ( select sq_siw_solicitacao, dbo.acesso(sq_siw_solicitacao, @p_usuario,null) acesso
   ...
   end else if @p_restricao = 'EXISTEREC' begin
   ...
   end else if @p_restricao = 'EXISTEPER' begin
   ...
   end else if @p_restricao = 'SOLICPER' begin
   ...
   end else if @p_restricao = 'ALOCACAO' begin
      -- Retorna os períodos de alocação do recurso, inseridos em uma solicitação, a partir da chave da solicitação ou do recurso
         ...
         select a.sq_solic_recurso_alocacao as chave_aux, a.sq_solic_recurso as chave, a.inicio, a.fim, 
                ...
                coalesce(c.codigo_interno, ltrim(rtrim( cast(c.sq_siw_solicitacao as varchar) ))) as cd_servico,
   ...
   end else if @p_restricao = 'RECDISP' begin
