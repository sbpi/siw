         ...
         from eo_recurso                        a
          ...
          where a.cliente        = @p_cliente
            ...
            and ((@p_restricao    is null  and
                 ...
                 (@p_restricao    is not null and ((charindex('EDICAO',@p_restricao) = 0 and coalesce(g.qtd,0) > 0) or -- Restrição para trazer apenas os recursos disponíveis para o serviço
