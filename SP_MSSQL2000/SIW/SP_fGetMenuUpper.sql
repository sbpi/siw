CREATE  function dbo.SP_fGetMenuUpper (@p_chave int = null, @p_direction varchar(50)) 
...
Begin
  ...
  If @p_chave is null and @p_direction = 'UP' Begin
      Insert @stack1 
          select sq_menu from siw_menu where sq_menu_pai is null;
  End Else If @p_chave is null and @p_direction = 'DOWN' Begin
      Insert @stack1 
          select sq_menu from siw_menu where 1 = 0;
  End Else Begin
      Declare @exists int
