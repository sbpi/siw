alter procedure dbo.SP_getSolicIndicador
   (@p_solicitacao  int   = null,
...
begin
   If @p_restricao is null or @p_restricao = 'VISUAL' begin
      -- Recupera os indicadores ligados a solicitações
         select a.sq_eoindicador as chave, a.cliente, a.nome, a.sigla, a.descricao, a.forma_afericao, 
                ...
                dbo.to_char(b1.data_afericao,'dd/mm/yyyy, hh24:mi:ss') as phpdt_afericao,
                dbo.to_char(b1.referencia_inicio,'dd/mm/yyyy, hh24:mi:ss') as phpdt_inicio,
                dbo.to_char(b1.referencia_fim,'dd/mm/yyyy, hh24:mi:ss') as phpdt_fim,
                dbo.to_char(b1.inclusao,'dd/mm/yyyy, hh24:mi:ss') as phpdt_inclusao,
                dbo.to_char(b1.ultima_alteracao,'dd/mm/yyyy, hh24:mi:ss') as phpdt_alteracao,
                ...
                dbo.to_char(g1.data_afericao,'dd/mm/yyyy, hh24:mi:ss') as phpdt_base_afericao,
                dbo.to_char(g1.referencia_inicio,'dd/mm/yyyy, hh24:mi:ss') as phpdt_base_inicio,
                dbo.to_char(g1.referencia_fim,'dd/mm/yyyy, hh24:mi:ss') as phpdt_base_fim,
                dbo.to_char(g1.inclusao,'dd/mm/yyyy, hh24:mi:ss') as phpdt_base_inclusao,
                dbo.to_char(g1.ultima_alteracao,'dd/mm/yyyy, hh24:mi:ss') as phpdt_base_alteracao,
