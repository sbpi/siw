alter procedure SP_GetBenef
   (@p_cliente            int,
    @p_sq_pessoa          int         = null,
    @p_username           varchar(60) = null,
    @p_cpf                varchar(14) = null,
    @p_cnpj               varchar(18) = null,
    @p_nome               varchar(80) = null,
    @p_tipo_pessoa        int         = null,
    @p_passaporte_numero  varchar(20) = null,
    @p_sq_pais_passaporte int         = null,
    @p_fornecedor         varchar( 1) = null,
    @p_pais               int         = null,
    @p_regiao             int         = null,
    @p_uf                 varchar( 2) = null,
    @p_cidade             int         = null,
