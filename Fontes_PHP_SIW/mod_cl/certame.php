...
function DadosAnalise() {
  ...
  foreach($RS as $row) { 
    ...
    ShowHTML('        <td align="center" nowrap><INPUT class="sti" type="text" name="w_ordem[]" size="2" maxlength="4" value="'.nvl(nvl($w_ordem[$i],f($row,'ordem')),$i).'" title="Ordem do item na licitação."></td>');
