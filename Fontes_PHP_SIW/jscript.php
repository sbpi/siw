...
function Validate($VariableName,$DisplayName,$DataType,$ValueRequired,$MinimumLength,$MaximumLength,$AllowLetters,$AllowDigits) {
  ...
  elseif (strtoupper($DataType)=="DATA") {
    ...
    "            //verificaÁıes b·sicas para o tipo ".strtoupper($DataType)."\r\n";
    ...
    if (strtoupper($DataType)=="HORA") print "       if (err==2) alert('Campo ".$DisplayName." inv·lido. Hora deve ser de 0 a 23');"."\r\n";
    print
