...
function Validate($VariableName,$DisplayName,$DataType,$ValueRequired,$MinimumLength,$MaximumLength,$AllowLetters,$AllowDigits) {
  ...
  if ($MinimumLength > "") {
    if (upper($DataType) == "CHECKBOX" && intval($MinimumLength) > 0) {
      ...
      print "    alert('Favor selecionar pelo menos " . $MinimumLength . " opÁıes de " . $DisplayName . ". \\nVocÍ selecionou apenas ' + marcados + ' opÁıes.');" . "\r\n";
      print " }";
    } else {
  ...
  if ($MaximumLength>"") {
    if (upper($DataType) == "CHECKBOX" && nvl($MaximumLength,'')!='' && nvl($MaximumLength,0) > 0 ) {
      ...
      print "    alert('Favor selecionar no m·ximo " . $MaximumLength . " opÁıes de " . $DisplayName . ". \\nVocÍ selecionou ' + marcados + ' opÁıes.');" . "\r\n";
    } else {
