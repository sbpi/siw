...
include_once($w_dir_volta.'classes/sp/db_getModData.php');
include_once($w_dir_volta.'classes/sp/db_getCustomerData.php');
include_once($w_dir_volta.'classes/sp/db_getSegModData.php');
include_once($w_dir_volta.'classes/sp/db_getLinkDataHelp.php');
...
// Descricao: Exibe documentação do módulo de compras
// Mail     : alex@sbpi.com.br
// Criacao  : 08/11/2011 12:25
// Versao   : 1.0.0.0
// Local    : Brasília - DF
// -------------------------------------------------------------------------
// 
...
// =========================================================================
// Exibe visão geral da documentação
// -------------------------------------------------------------------------
function Inicial() {
  extract($GLOBALS);
