...
function Inicial() {
  ...
  if ($O=='L') {
    if ((strpos(upper($R),'GR_')!==false) || ($w_tipo=='WORD')) {
      ...
      if (nvl($p_projeto,'')!='') {
        ...
        $w_filtro.='<tr valign="top"><td align="right">Programa <td>[<b>'.f($RS,'titulo').'</b>]';
      } 
      if ($p_atividade>'') {
        $RS = db_getSolicEtapa::getInstanceOf($dbms,$p_projeto,$p_atividade,'REGISTRO',null);
        $w_filtro.='<tr valign="top"><td align="right">Item <td>[<b>'.f($RS,'titulo').'</b>]';
      } 
      if ($p_sqcc>'') {
  ...
  if ($O == 'L') {
        ...
        if ($_SESSION['INTERNO']=='S'&& $w_tipo!='WORD') {
          ...
          if ($P1!=3) {
            ...
            if ($w_copia > '') {
              ...
              // Se for cadastramento
              if ($w_submenu>'') ShowHTML('          <A class="HL" HREF="menu.php?par=ExibeDocs&O=A&w_chave='.f($row,'sq_siw_solicitacao').'&R='.$w_pagina.$par.'&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&SG='.$SG.'&TP='.$TP.'&w_documento='.nvl(f($row,'codigo_interno'),'Nr. '.f($row,'sq_siw_solicitacao')).MontaFiltro('GET').'" title="Altera as informações cadastrais do programa" TARGET="menu">AL</a>&nbsp;');
              ...
              ShowHTML('          <A class="HL" href="'.$w_dir.$w_pagina.'Excluir&R='.$w_pagina.$par.'&O=E&w_chave='.f($row,'sq_siw_solicitacao').'&w_tipo=Volta&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&TP='.$TP.'&SG='.$SG.MontaFiltro('GET').'" title="Exclusão do programa.">EX</A>&nbsp');
            } elseif ($P1==2 || $P1==6) {
              // Se for execução ou consulta de usuário externo
              if ($w_usuario == f($row,'executor')) {
                ShowHTML('          <A class="HL" href="'.$w_dir.$w_pagina.'AtualizaEtapa&R='.$w_pagina.$par.'&O=L&w_chave='.f($row,'sq_siw_solicitacao').'&w_tipo=Volta&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&TP='.$TP.'&SG='.$SG.MontaFiltro('GET').'" title="Atualiza os itens do programa." target="Etapas">EA</A>&nbsp');
                ...
                ShowHTML('          <A class="HL" HREF="mod_pr/restricao.php?par=Restricao&w_chave='.f($row,'sq_siw_solicitacao').'&R='.$w_pagina.$par.'&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&SG='.$SG.'&TP='.$TP.' - Riscos&SG=RESTSOLIC'.MontaFiltro('GET').'" title="Riscos do programa." target="Restricao">RS</A>&nbsp');
                ShowHTML('          <A class="HL" HREF="mod_pr/restricao.php?par=Restricao&w_chave='.f($row,'sq_siw_solicitacao').'&R='.$w_pagina.$par.'&w_problema=S&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&SG='.$SG.'&TP='.$TP.' - Problema&SG=RESTSOLIC'.MontaFiltro('GET').'" title="Problemas do programa." target="Restricao">PB</A>&nbsp');
                /*
                ...
                */
                if (f($row,'qtd_meta')>0) ShowHTML('          <A class="HL" HREF="mod_pe/indicador.php?par=Meta&w_chave='.f($row,'sq_siw_solicitacao').'&R='.$w_pagina.$par.'&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&SG='.$SG.'&TP='.$TP.' - Metas&SG=METASOLIC'.MontaFiltro('GET').'" title="Metas do programa." target="Meta">MT</A>&nbsp');
                // Coloca as operações dependendo do trâmite
                if (f($row,'sg_tramite')=='EA' || f($row,'sg_tramite')=='EE') {
                  ShowHTML('          <A class="HL" href="'.$w_dir.$w_pagina.'Anotacao&R='.$w_pagina.$par.'&O=V&w_chave='.f($row,'sq_siw_solicitacao').'&w_tipo=Volta&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&TP='.$TP.'&SG='.$SG.MontaFiltro('GET').'" title="Registra anotações para o programa, sem enviá-la.">AN</A>&nbsp');
                } 
                ShowHTML('          <A class="HL" href="'.$w_dir.$w_pagina.'Informar&R='.$w_pagina.$par.'&O=A&w_chave='.f($row,'sq_siw_solicitacao').'&w_tipo=Volta&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&TP='.$TP.'&SG=PJANALISE'.MontaFiltro('GET').'" title="Informar a análise do programa.">IN</A>&nbsp');
                ShowHTML('          <A class="HL" href="'.$w_dir.$w_pagina.'Envio&R='.$w_pagina.$par.'&O=V&w_chave='.f($row,'sq_siw_solicitacao').'&w_tipo=Volta&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&TP='.$TP.'&SG='.$SG.MontaFiltro('GET').'" title="Envia o programa para outro responsável.">EN</A>&nbsp');
                if (f($row,'sg_tramite')=='EE') {
                  ...
                  if(count($RS2)>0) ShowHTML('          <A class="HL" href="'.$w_dir.$w_pagina.'PrestacaoContas&R='.$w_pagina.'PrestacaoContas'.'&O=P&w_siw_solicitacao='.f($row,'sq_siw_solicitacao').'&w_tipo=Volta&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&TP='.$TP.' - Prestação contas&SG=PJPREST'.MontaFiltro('GET').'" title="Inseri a prestação de contas do programa." target="Prestacao">PC</A>&nbsp');
                  ShowHTML('          <A class="HL" href="'.$w_dir.$w_pagina.'Concluir&R='.$w_pagina.$par.'&O=V&w_chave='.f($row,'sq_siw_solicitacao').'&w_tipo=Volta&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&TP='.$TP.'&SG='.$SG.MontaFiltro('GET').'" title="Conclui a execução do programa.">CO</A>&nbsp');
                } 
              } else {
                ShowHTML('          <A class="HL" href="'.$w_dir.$w_pagina.'AtualizaEtapa&R='.$w_pagina.$par.'&O=L&w_chave='.f($row,'sq_siw_solicitacao').'&w_tipo=Volta&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&TP='.$TP.'&SG='.$SG.MontaFiltro('GET').'" title="Consulta os itens do programa." target="Etapas">EA</A>&nbsp');
                if (f($row,'resp_risco')>0)    ShowHTML('          <A class="HL" HREF="mod_pr/restricao.php?par=Restricao&w_chave='.f($row,'sq_siw_solicitacao').'&R='.$w_pagina.$par.'&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&SG='.$SG.'&TP='.$TP.' - Riscos&SG=RESTSOLIC'.MontaFiltro('GET').'" title="Consulta os riscos do programa." target="Restricao">RS</A>&nbsp');
                if (f($row,'resp_problema')>0) ShowHTML('          <A class="HL" HREF="mod_pr/restricao.php?par=Restricao&w_chave='.f($row,'sq_siw_solicitacao').'&R='.$w_pagina.$par.'&w_problema=S&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&SG='.$SG.'&TP='.$TP.' - Problema&SG=RESTSOLIC'.MontaFiltro('GET').'" title="Consulta os problemas do programa." target="Restricao">PB</A>&nbsp');
                if (f($row,'resp_meta')>0)     ShowHTML('          <A class="HL" HREF="mod_pe/indicador.php?par=Meta&w_chave='.f($row,'sq_siw_solicitacao').'&R='.$w_pagina.$par.'&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&SG='.$SG.'&TP='.$TP.' - Metas&SG=METASOLIC'.MontaFiltro('GET').'" title="Metas do programa." target="Meta">MT</A>&nbsp');
    ...
    elseif ($O == 'C') // Se for cópia 
      ShowHTML('<tr bgcolor="'.$conTrBgColor.'"><td><div align="justify">Para selecionar o programa que deseja copiar, informe nos campos abaixo os critérios de seleção e clique sobre o botão <i>Aplicar filtro</i>. Clicando sobre o botão <i>Remover filtro</i>, o filtro existente será apagado.</div><hr>');
    ...
    if ($P1 != 1 || $O == 'C') { // Se não for cadastramento ou se for cópia
      ...
      ShowHTML('      <tr valign="top">');
      SelecaoPessoa('Responsável atua<u>l</u>:','L','Selecione o responsável atual pelo programa na relação.',$p_usu_resp,null,'p_usu_resp','USUARIOS');
      SelecaoUnidade('<U>S</U>etor atual:','S','Selecione a unidade onde o programa se encontra na relação.',$p_uorg_resp,null,'p_uorg_resp',null,null);
      ShowHTML('      <tr>');
      ...
      ShowHTML('      <tr>');
      SelecaoPrioridade('<u>P</u>rioridade:','P','Informe a prioridade deste programa.',$p_prioridade,null,'p_prioridade',null,null);
      ...
      if ($O!='C') { // Se não for cópia
        ShowHTML('      <tr>');
        ShowHTML('          <td valign="top"><b>Exibe somente programas em atraso?</b><br>');
    ...
    if ($p_ordena=='ASSUNTO')           ShowHTML('          <option value="assunto" SELECTED>Assunto<option value="inicio">Início<option value="">Data Término<option value="nm_tramite">Fase atual<option value="prioridade">Prioridade<option value="proponente">Gestor');
    elseif ($p_ordena=='INICIO')        ShowHTML('          <option value="assunto">Assunto<option value="inicio" SELECTED>Início<option value="">Data Término<option value="nm_tramite">Fase atual<option value="prioridade">Prioridade<option value="proponente">Gestor');
    elseif ($p_ordena=='NM_TRAMITE')    ShowHTML('          <option value="assunto">Assunto<option value="inicio">Início<option value="">Data Término<option value="nm_tramite" SELECTED>Fase atual<option value="prioridade">Prioridade<option value="proponente">Gestor');
    elseif ($p_ordena=='PRIORIDADE')    ShowHTML('          <option value="assunto">Assunto<option value="inicio">Início<option value="">Data Término<option value="nm_tramite">Fase atual<option value="prioridade" SELECTED>Prioridade<option value="proponente">Gestor');
    elseif ($p_ordena=='PROPONENTE')    ShowHTML('          <option value="assunto">Assunto<option value="inicio">Início<option value="">Data Término<option value="nm_tramite">Fase atual<option value="prioridade">Prioridade<option value="proponente" SELECTED>Gestor');
    else                                ShowHTML('          <option value="assunto">Assunto<option value="inicio">Início<option value="" SELECTED>Data Término<option value="nm_tramite">Fase atual<option value="prioridade">Prioridade<option value="proponente">Gestor');
    ShowHTML('          </select></td>');
...
function Geral() {
  ...
  if ($O=='I' || $O=='A') {
    ...
    switch (f($RS_Menu,'data_hora')) {
      case 1: Validate('w_fim','Término','DATA',1,10,10,'','0123456789/'); break;
      case 2: Validate('w_fim','Término','DATAHORA',1,17,17,'','0123456789/'); break;
      case 3: Validate('w_inicio','Início','DATA',1,10,10,'','0123456789/');
              Validate('w_fim','Término','DATA',1,10,10,'','0123456789/');
              CompData('w_inicio','Início','<=','w_fim','Término'); break;
      case 4: Validate('w_inicio','Início','DATAHORA',1,17,17,'','0123456789/,: ');
              Validate('w_fim','Término','DATAHORA',1,17,17,'','0123456789/,: ');
              CompData('w_inicio','Início','<=','w_fim','Término'); break;
    } 
    if (nvl($w_inicio_etapa,'')!='' && nvl($w_copia,'')=='') {
      CompData('w_inicio','Início','<=','w_inicio_etapa','Início da primeira etapa da estrutura analítica ('.$w_inicio_etapa.')');
      CompData('w_fim','Término','>=','w_fim_etapa','Término da primeira etapa da estrutura analítica ('.$w_fim_etapa.')');
    }
    ...
    Validate('w_dias','Dias de alerta do programa','1','',1,3,'','0123456789');
  ...
  if (strpos('IAEV',$O)!==false) {
    ...
    ShowHTML('      <tr><td valign="top"><b><u>T</u>ítulo:</b><br><INPUT ACCESSKEY="T" '.$w_Disabled.' class="STI" type="text" name="w_titulo" size="90" maxlength="100" value="'.$w_titulo.'" title="Informe um título para o programa."></td>');
    ...
    switch (f($RS_Menu,'data_hora')) {
      ...
      case 4: ShowHTML('              <td valign="top"><b>Iní<u>c</u>io:</b><br><input '.$w_Disabled.' accesskey="C" type="text" name="w_inicio" class="STI" SIZE="17" MAXLENGTH="17" VALUE="'.$w_inicio.'" onKeyDown="FormataDataHora(this,event);" onKeyUp="SaltaCampo(this.form.name,this,17,event);" title="Data/hora de início do programa."></td>');
              ShowHTML('              <td valign="top"><b><u>T</u>érmino:</b><br><input '.$w_Disabled.' accesskey="T" type="text" name="w_fim" class="STI" SIZE="17" MAXLENGTH="17" VALUE="'.$w_fim.'" onKeyDown="FormataDataHora(this,event);" onKeyUp="SaltaCampo(this.form.name,this,17,event);" title="Data/hora limite para que a execução do programa esteja concluído."></td>'); break;
    } 
    //ShowHTML('              <td><b>O<u>r</u>çamento disponível:</b><br><input '.$w_Disabled.' accesskey="O" type="text" name="w_valor" class="STI" SIZE="18" MAXLENGTH="18" VALUE="'.$w_valor.'" style="text-align:right;" onKeyDown="FormataValor(this,18,2,event);" title="Informe o orçamento disponível para execução do programa, ou zero se não for o caso."></td>');
    ShowHTML('<INPUT type="hidden" name="w_valor" value="0,00">');
    ShowHTML('          </table>');
    ShowHTML('      <tr><td><b>Pa<u>l</u>avras-chave:<br><INPUT ACCESSKEY="L" '.$w_Disabled.' class="STI" type="text" name="w_palavra_chave" size="90" maxlength="90" value="'.$w_palavra_chave.'" title="Se desejar, informe palavras-chave adicionais aos campos informados e que permitam a identificação deste programa."></td>');
    ShowHTML('      <tr><td><b><U>C</U>oordenador:<br><INPUT ACCESSKEY="C" '.$w_Disabled.' class="STI" type="text" name="w_proponente" size="90" maxlength="90" value="'.$w_proponente.'" title="Gestor do programa. Preencha apenas se houver."></td>');
    ShowHTML('      <tr><td align="center" height="2" bgcolor="#000000"></td></tr>');
    ShowHTML('      <tr><td align="center" height="1" bgcolor="#000000"></td></tr>');
    ShowHTML('      <tr><td valign="top" align="center" bgcolor="#D0D0D0"><b>Local da execução</td></td></tr>');
    ShowHTML('      <tr><td align="center" height="1" bgcolor="#000000"></td></tr>');
    ShowHTML('      <tr><td>Os dados deste bloco identificam o local onde o programa será executado, sendo utilizados para consultas gerenciais por distribuição geográfica.</td></tr>');
    ShowHTML('      <tr><td align="center" height="1" bgcolor="#000000"></td></tr>');
    ShowHTML('      <tr><td><table border=0 width="100%" cellspacing=0>');
    ShowHTML('      <tr valign="top">');
    ...
    ShowHTML('      <tr><td align="center" height="1" bgcolor="#000000"></td></tr>');
    ShowHTML('      <tr><td>Os dados abaixo indicam como deve ser tratada a proximidade da data de término prevista para o programa.</td></tr>');
    ShowHTML('      <tr><td align="center" height="1" bgcolor="#000000"></td></tr>');
    ShowHTML('      <tr><td><table border="0" width="100%">');
    ShowHTML('          <tr valign="top">');
    MontaRadioNS('<b>Emite alerta?</b>',$w_aviso,'w_aviso');
    ShowHTML('              <td><b>Quantos <U>d</U>ias antes da data limite?<br><INPUT ACCESSKEY="D" '.$w_Disabled.' class="STI" type="text" name="w_dias" size="3" maxlength="3" value="'.$w_dias.'" title="Número de dias para emissão do alerta de proximidade da data Término do programa."></td>');
    ShowHTML('          </table>');
    ShowHTML('      <tr><td align="center" height="2" bgcolor="#000000"></td></tr>');
    ShowHTML('      <tr><td align="center" height="1" bgcolor="#000000"></td></tr>');
    ShowHTML('      <tr><td valign="top" align="center" bgcolor="#D0D0D0"><b>Alerta para Pacotes de Trabalho</td></td></tr>');
    ShowHTML('      <tr><td align="center" height="1" bgcolor="#000000"></td></tr>');
    ShowHTML('      <tr><td>Os dados abaixo indicam como deve ser tratada a proximidade da data prevista para término dos pacotes de trabalho deste programa.</td></tr>');
    ShowHTML('      <tr><td align="center" height="1" bgcolor="#000000"></td></tr>');
    ShowHTML('      <tr><td><table border="0" width="100%">');
    ShowHTML('          <tr valign="top">');
    MontaRadioNS('<b>Emite alerta para pacotes de trabalho?</b>',$w_aviso_pacote,'w_aviso_pacote');
    ShowHTML('              <td><b><U>P</U>ercentual desejado de dias?<br><INPUT ACCESSKEY="P" '.$w_Disabled.' class="STI" type="text" name="w_dias_pacote" size="3" maxlength="3" value="'.$w_dias_pacote.'" title="Número de dias para emissão do alerta de proximidade da data prevista para término dos pacotes de trabalho deste o programa."></td>');
    ShowHTML('          </table>');
    ShowHTML('      <tr><td align="center" height="1" bgcolor="#000000"></TD></TR>');
...
function Informar() {
  ...
  ShowHTML('<tr><td colspan="2"  bgcolor="#f0f0f0"><div align=justify><font size="2"><b>PROGRAMA: '.$w_cabecalho.'</b></font></div></td></tr>');
  ShowHTML('<tr><td colspan="2"><hr NOSHADE color=#000000 size=4></td></tr>');
  ShowHTML('<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">');
  if (strpos('IAEV',$O)!==false) {
...
function AnexosEtapas() {
  ...
  if ($w_troca>'' && $O!='E') {
    ...
    // Recupera todos os registros para a listagem 
    $RS = db_getEtapaAnexo::getInstanceOf($dbms,$w_etapa,null,$w_cliente);
    $RS = SortArray($RS,'nome','asc');
  } elseif (strpos('AEV',$O)!==false) {
    // Recupera os dados do endereço informado 
    $RS = db_getEtapaAnexo::getInstanceOf($dbms,$w_etapa,$w_chave_aux,$w_cliente);
    foreach ($RS as $row) {
      $w_nome      = f($row,'nome');
      $w_descricao = f($row,'descricao');
      $w_caminho   = f($row,'chave_aux');
  ...
  ShowHTML('        <tr valign="top">');
  ShowHTML('          <td colspan=3>Programa: <b>'.f($RS_Solic,'titulo').' ('.$w_chave.')</td>');
  ShowHTML('        <tr valign="top">');
  $RS_Etp = db_getSolicEtapa::getInstanceOf($dbms,$w_chave,$w_etapa,'REGISTRO',null);
  foreach ($RS_Etp as $row) {
    ShowHTML('          <td>Item: <b>'.MontaOrdemEtapa($w_etapa).' - '.f($row,'titulo').'</td>');
    ShowHTML('          <td>Início: <b>'.FormataDataEdicao(f($row,'inicio_previsto'),9).'</td>');
    ShowHTML('          <td>Fim: <b>'.FormataDataEdicao(f($row,'fim_previsto'),9).'</td>');
    ShowHTML('        <tr><td colspan=3>Descrição/justificativa: <b>'.CRLF2BR(f($row,'descricao')).'</td></tr>');
  }
  ShowHTML('    </TABLE>');
  ShowHTML('</table>');    
  if ($O=='L') {
    ...
    if (count($RS)<=0) {
      ...
      foreach($RS as $row) {
        ...
        ShowHTML('        <td align="right">'.round(f($row,'tamanho')/1024,1).'&nbsp;</td>');
        ShowHTML('        <td align="top" nowrap>');
        ShowHTML('          <A class="HL" href="'.$w_dir.$w_pagina.$par.'&R='.$R.'&O=A&w_chave='.$w_chave.'&w_etapa='.$w_etapa.'&w_chave_aux='.f($row,'chave_aux').'&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&TP='.$TP.'&SG='.$SG.'">AL</A>&nbsp');
        ShowHTML('          <A class="HL" href="'.$w_dir.$w_pagina.$par.'&R='.$R.'&O=E&w_chave='.$w_chave.'&w_etapa='.$w_etapa.'&w_chave_aux='.f($row,'chave_aux').'&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&TP='.$TP.'&SG='.$SG.'">EX</A>&nbsp');
        ShowHTML('        </td>');
        ShowHTML('      </tr>');
      } 
    } 
    ...
    ShowHTML('            <input class="stb" type="button" onClick="location.href=\''.montaURL_JS($w_dir,$w_pagina.$par.'&w_chave='.$w_chave.'&w_etapa='.$w_etapa.'&O=L&SG='.$SG.'&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&TP='.$TP).'\';" name="Botao" value="Cancelar">');
    ShowHTML('          </td>');
    ShowHTML('      </tr>');
    ShowHTML('    </table>');
    ShowHTML('    </TD>');
...
function Etapas() {
  ...
  if (!count($RS)<=0) {
    $w_texto_titulo = '<b>Dados dos itens de mesma subordinação:</b>:<br>';
    $w_texto = '<table border=1 bgcolor="#FAEBD7">'.
               '<tr valign="top" align=center><td><b>Ordem<td><b>Título<td><b>Início<td><b>Fim';
    foreach ($RS as $row) {
      if (f($row,'ordena')=='0') {
        ...
        $w_texto_titulo = '<b>Dados do item superior e dos itens de mesma subordinação:</b>:<br>';
    ...
    $w_texto='Não há outros números de ordem subordinados a esta etapa e nem itens de mesma subordinação.';
  }
  ...
  if (strpos('IAEP',$O)!==false) {
    ...
    if (strpos('IA',$O)!==false) {
      ...
      Validate('w_desafio','Processo','','','','30','1','1');
      ...
      CompData('w_inicio','Início','>=',$w_inicio_pai,$w_inicio_pai);
      CompData('w_fim','Fim','<=',$w_fim_pai,$w_fim_pai);
  ...
  if ($O=='L') {
    ...
    ShowHTML('          <td rowspan=2><b>Agenda de ação</td>');
    ShowHTML('          <td rowspan=2><b>Entidade Executora</td>');
    ShowHTML('          <td rowspan=2><b>Responsável atualização</td>');
    ShowHTML('          <td colspan=2><b>Execução</td>');
    ...
    */
    ...
    ShowHTML('        <td colspan=2 style="display:none"><b><u>P</u>eso da etapa:<br><INPUT ACCESSKEY="O" TYPE="TEXT" CLASS="STI" NAME="w_peso" SIZE=2 MAXLENGTH=2 VALUE="'.nvl($w_peso,1).'" '.$w_Disabled.' title="Informe o peso da etapa no cálculo do percentual de execução."></td>');
    ShowHTML('      </tr>');
    ...
    ShowHTML('      <tr><td colspan=2><b><u>P</u>rocesso:<br><INPUT ACCESSKEY="P" TYPE="TEXT" CLASS="STI" NAME="w_desafio" SIZE=30 MAXLENGTH=30 VALUE="'.nvl($w_desafio,'').'" '.$w_Disabled.' title="Informe o desafio da etapa."></td>');
    ...
    ShowHTML('        <td><b>Iní<u>c</u>io:</b><br><input '.$w_Disabled.' accesskey="C" type="text" name="w_inicio" class="STI" SIZE="10" MAXLENGTH="10" VALUE="'.FormataDataEdicao(Nvl($w_inicio,time())).'" onKeyDown="FormataData(this,event);"  onKeyUp="SaltaCampo(this.form.name,this,10,event);" title="Data prevista para início da etapa.">'.ExibeCalendario('Form','w_inicio').'</td>');
    ShowHTML('        <td><b><u>T</u>érmino:</b><br><input '.$w_Disabled.' accesskey="T" type="text" name="w_fim" class="STI" SIZE="10" MAXLENGTH="10" VALUE="'.FormataDataEdicao($w_fim).'" onKeyDown="FormataData(this,event);" onKeyUp="SaltaCampo(this.form.name,this,10,event);" title="Data prevista para término da etapa.">'.ExibeCalendario('Form','w_fim').'</td>');
    /*
    ShowHTML('      <tr valign="top">');
    ShowHTML('        <td><b>Orça<u>m</u>ento:</b><br><input '.$w_Disabled.' accesskey="M" type="text" name="w_orcamento" class="STI" SIZE="18" MAXLENGTH="18" VALUE="'.formatNumber(nvl($w_orcamento,0)).'" style="text-align:right;" onKeyDown="FormataValor(this,18,2,event);" title="Orçamento para execução desta etapa."></td>');
    ...
    */
    ...
    ShowHTML('<INPUT type="hidden" name="w_vincula_contrato" value="N">');
    if ($w_pacote=='N') {
...
function AtualizaEtapa() {
  ...
  if (strpos('IAEP',$O)!==false) {
    ...
    if (strpos('IA',$O)!==false) {
      ...
      Validate('w_situacao_atual','Contexto inicial','','','5','4000','1','1');
    }
    if ($P1==2 || $P1==6) {
  ...
  ShowHTML('<B><FONT COLOR="#000000">'.substr($w_TP,0,(strpos($w_TP,'-')-1)).'- Itens'.'</font></B>');
  ShowHTML('<HR>');
  ShowHTML('<div align=center><center>');
  ShowHTML('<table border="0" cellpadding="0" cellspacing="0" width="100%">');
  ShowHTML('<tr><td colspan="2"><hr NOSHADE color=#000000 size=4></td></tr>');
  ...
  if ($O=='L') {
    ...
    ShowHTML('        <tr bgcolor="'.$conTrBgColor.'" align="center">');
    ShowHTML('          <td rowspan=2><b>Item</td>'); 
    ShowHTML('          <td rowspan=2><b>'.colapsar($w_chave).'Agenda de ação</td>');
    ShowHTML('          <td rowspan=2><b>Entidade executora</td>');
    ...
    */
    ...
    $RS_Etapa = db_getSolicEtapa::getInstanceOf($dbms,$w_chave,$w_chave_aux,'REGISTRO',null);
    ...
    ShowHTML('          <tr><td colspan="3">Item:<b><br>'.ExibeImagemSolic('ETAPA',f($RS_Etapa,'inicio_previsto'),f($RS_Etapa,'fim_previsto'),f($RS_Etapa,'inicio_real'),f($RS_Etapa,'fim_real'),null,null,null,f($RS_Etapa,'perc_conclusao')).MontaOrdemEtapa($w_chave_aux).'. '.f($RS_Etapa,'titulo').'</td>');
    ShowHTML('          <tr><td colspan="3">Descrição/justificativa:<b><br>'.f($RS_Etapa,'descricao').'</td>');
    ShowHTML('          <tr valign="top">');
    ShowHTML('              <td>Início:<b><br>'.FormataDataEdicao(Nvl(f($RS_Etapa,'inicio_previsto'),time())).'</td>');
    ShowHTML('              <td>Fim:<b><br>'.FormataDataEdicao(f($RS_Etapa,'fim_previsto')).'</td>');
    //ShowHTML('              <td>Orçamento:<b><br>'.formatNumber(f($RS_Etapa,'orcamento')).'</td>');
    ShowHTML('          <tr valign="top">');
    $RS = db_getPersonData::getInstanceOf($dbms,$w_cliente,$w_sq_pessoa,null,null);
    ShowHTML('              <td>Responsável pela atualização:<b><br>'.f($RS,'nome_resumido').'</td>');
    $RS = db_getUorgData::getInstanceOf($dbms,f($RS_Etapa,'sq_unidade'));
    ShowHTML('              <td colspan=2>Entidade executora:<b><br>'.f($RS,'nome').' ('.f($RS,'sigla').')</td>');
    /*
    ShowHTML('          <tr valign="top">');
    ...
    */
    $RS = db_getPersonData::getInstanceOf($dbms,$w_cliente,f($RS_Etapa,'sq_pessoa_atualizacao'),null,null);
    ...
    if ($O=='V') {
      ...
      ShowHTML('      <tr><td colspan=3>Situação atual do item:<b><br>'.crlf2br(Nvl($w_situacao_atual,'---')).'</td>');
    } else {
      if ($w_pacote=='N') {
        ShowHTML('      <tr valign="top">');
        ShowHTML('        <td>Percentual de conclusão:<br><b>'.formatNumber(nvl($w_perc_conclusao,0)).'%</b></td>');
    ...
    ShowHTML('            <td rowspan=2 bgColor="#f0f0f0"><b>Desafios</b></td>');
      ...
      foreach($RS as $row){
        if (f($row,'vinculado_inter')>0) {
          ...
          ShowHTML('        <td align="center" width="1%" nowrap>'.nvl(formataDataEdicao(f($row,'inicio_real'),9),'---').'</td>');
          ShowHTML('        <td align="center" width="1%" nowrap>'.nvl(formataDataEdicao(f($row,'fim_real'),9),'---').'</td>');
          ShowHTML('        <td align="right" width="1%" nowrap>'.f($row,'peso').'</td>');
...
function Recursos() {
  ...
  if ($O=='L') {
    ...
    ShowHTML('      <tr>');
    ShowHTML('      </tr>');
    ShowHTML('      <tr><td valign="top"><b><u>F</u>inalidade:</b><br><textarea '.$w_Disabled.' accesskey="F" name="w_finalidade" class="STI" ROWS=5 cols=75 title="Descreva, se necessário, a finalidade deste recurso para o programa (funções desempenhadas, papel, objetivos etc).">'.$w_finalidade.'</TEXTAREA></td>');
    ShowHTML('      <tr>');
    ShowHTML('      <tr><td align="center" colspan=4><hr>');
    if ($O=='E') {
      ShowHTML('   <input class="STB" type="submit" name="Botao" value="Excluir">');
...
function EtapaRecursos() {
  ...
  ShowHTML('        <tr valign="top">');
  foreach ($RS as $row) {
    ShowHTML('          <td>Item<br><b>'.MontaOrdemEtapa($w_chave_aux).' - '.f($row,'titulo').'</td>');
    ShowHTML('          <td>Início:<br> <b>'.FormataDataEdicao(f($row,'inicio_previsto'),9).'</td>');
    ShowHTML('          <td>Fim:<br><b>'.FormataDataEdicao(f($row,'fim_previsto'),9).'</td>');
    ShowHTML('        <tr><td colspan=3>Descrição/justificativa:<br><b>'.CRLF2BR(f($row,'descricao')).'</td></tr>');
  }
  ShowHTML('    </TABLE>');
  ShowHTML('</table>');
  ...
  ShowHTML('<tr><td><ul><b>Informações:</b><li>Indique abaixo quais recursos estarão alocados a esta etapa do programa.<li>A princípio, uma etapa não tem nenhum recurso alocado.<li>Para remover um recurso, desmarque o quadrado ao seu lado.</ul>');
  ShowHTML('<tr><td align="center" colspan=3>');
  ShowHTML('    <TABLE WIDTH="100%" bgcolor="'.$conTableBgColor.'" BORDER="'.$conTableBorder.'" CELLSPACING="'.$conTableCellSpacing.'" CELLPADDING="'.$conTableCellPadding.'" BorderColorDark="'.$conTableBorderColorDark.'" BorderColorLight="'.$conTableBorderColorLight.'">');
  ShowHTML('        <tr bgcolor="'.$conTrBgColor.'" align="center">');
  ShowHTML('          <td><b>&nbsp;</td>');
...
function Interessados() {
  ...
  if ($O=='L') {
    ...
    SelecaoTipoVisao('<u>T</u>ipo de visão:','T','Selecione o tipo de visão que o interessado terá deste programa.',$w_tipo_visao,null,'w_tipo_visao',null,null);
    ShowHTML('          </table>');
    ShowHTML('      <tr>');
...
function Areas() {
  ...
  if ($O=='L') {
    ...
    ShowHTML('      <tr><td valign="top"><b><u>P</u>apel desempenhado:</b><br><textarea '.$w_Disabled.' accesskey="P" name="w_papel" class="STI" ROWS=5 cols=75 title="Descreva o papel desempenhado pela área ou instituição na execução do programa.">'.$w_papel.'</TEXTAREA></td>');
    ShowHTML('          </table>');
    ShowHTML('      <tr><td align="center" colspan=4><hr>');
    if ($O=='E') {
      ShowHTML('   <input class="STB" type="submit" name="Botao" value="Excluir">');
...
function Pacote() {
  ...
  if ($P1!=1) {
    ...
    ShowHTML('<tr><td colspan="2" bgcolor="#f0f0f0"><div align=justify><font size="1"><b>PROGRAMA: '.$w_cabecalho.'</b></font></div></td></tr>');
...
function Excluir() {
  ...
  ShowHTML('<HR>');
  AbreForm('Form',$w_dir.$w_pagina.'Grava','POST','return(Validacao(this));',null,$P1,$P2,$P3,$P4,$TP,'PJGERAL',$w_pagina.$par,$O);
  ShowHTML('<INPUT type="hidden" name="w_chave" value="'.$w_chave.'">');
  ShowHTML('<INPUT type="hidden" name="w_troca" value="">');
...
function Concluir() {
  ...
  if ($O=='V') {
    ...
    ValidateOpen('Validacao');
    switch (f($RS_Menu,'data_hora')) {
      case 1: Validate('w_fim_real','Término','DATA',1,10,10,'','0123456789/'); break;
      case 2: Validate('w_fim_real','Término','DATAHORA',1,17,17,'','0123456789/'); break;
      case 3: 
        Validate('w_inicio_real','Início','DATA',1,10,10,'','0123456789/');
        Validate('w_fim_real','Término','DATA',1,10,10,'','0123456789/');
        CompData('w_inicio_real','Início','<=','w_fim_real','Término');
        CompData('w_fim_real','Término','<=',FormataDataEdicao(time()),'data atual'); break;
      case 4: 
        Validate('w_inicio_real','Início','DATAHORA',1,17,17,'','0123456789/,: ');
        Validate('w_fim_real','Término','DATAHORA',1,17,17,'','0123456789/,: ');
        CompData('w_inicio_real','Início','<=','w_fim_real','Término'); break;
    } 
...
function EtapaLinha($l_chave,$l_chave_aux,$l_titulo,$l_resp,$l_setor,$l_inicio,$l_fim,$l_inicio_real,$l_fim_real,$l_perc,$l_ativ,$l_destaque,$l_oper,$l_tipo,$l_sq_resp,$l_sq_setor,$l_vincula_contrato,$l_contr, $l_valor=null,$l_nivel=0,$l_restricao='N',$l_peso='1',$l_arquivo=0, $l_desafio='', $l_pacote='N') {
  ...
  */
  ...
  if ($l_oper == 'S') {
    ...
    if ($l_tipo == 'ETAPA') {
      $l_html .= chr(13).'        <td align="top" nowrap '.$l_row.'>';
      $l_html .= chr(13).'          <A class="HL" href="'.$w_dir.$w_pagina.$par.'&R='.$w_dir.$w_pagina.$par.'&O=V&w_chave='.$l_chave.'&w_chave_aux='.$l_chave_aux.'&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&TP='.$TP.'&SG='.$SG.'" title="Atualiza dados da etapa">Exibir</A>&nbsp';
      $l_html .= chr(13).'        </td>';
    } 
  } 
  $l_html .= chr(13).'      </tr>';
  ...
  */
  ...
  if ($l_oper == 'S') {
    ...
    if ($l_tipo == 'PROJETO') {
      ...
      $l_html .= chr(13).'          <A class="HL" href="'.$w_dir.$w_pagina.'GRAVA&R='.$w_pagina.$par.'&O=E&w_chave='.$l_chave.'&w_chave_aux='.$l_chave_aux.'&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&TP='.$TP.'&SG='.$SG.'" onClick="return confirm(\'Confirma a exclusão do registro?\');" title="Excluir">EX</A>&nbsp';
      if($SG!='PJBETAPA') $l_html .= chr(13).'          <A class="HL" href="'.$w_dir.$w_pagina.'EtapaRecurso&R='.$w_pagina.$par.'&O=A&w_chave='.$l_chave.'&w_chave_aux='.$l_chave_aux.'&w_menu='.$w_menu.'&w_sg='.$SG.'&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&TP='.$TP.' - Recursos&SG='.$SG.'" title="Recursos da etapa">Rec</A>&nbsp';
      // Caso contrário, é listagem de atualização de etapas. Neste caso, coloca apenas a opção de alteração
    } else {
  ...
  if (count($RS_Contr)>0) {
    foreach ($RS_Contr as $row) {
      ...
      if($P4!=1) $l_contr1 .= chr(13).'     <td>'.ExibePessoa(null,$w_cliente,f($row,'solicitante'),$TP,f($row,'nm_resp')).'</td>';
      else       $l_contr1 .= chr(13).'     <td>'.f($row,'nm_resp').'</td>';
      if($P4!=1) $l_contr1 .= chr(13).'     <td>'.ExibeUnidade(null,$w_cliente,f($row,'sg_unidade_resp'),f($row,'sq_unidade_resp'),$TP).'</td>';
      else       $l_contr1 .= chr(13).'     <td>'.f($row,'sg_unidade_resp').'</td>';
...
function SolicMail($p_solic,$p_tipo) {
  ...
  if(f($RS,'envia_mail_tramite')=='S' && (f($RS_Menu,'envia_email')=='S') && (f($RSM,'envia_mail')=='S')) {
    ...
    $w_html .= $crlf.'      <tr><td><b>Início:</b></td>';
    $w_html .= $crlf.'        <td>'.FormataDataEdicao(f($RSM,'inicio'),9).' </td></tr>';
    $w_html .= $crlf.'      <tr><td><b>Término:</b></td>';
    $w_html .= $crlf.'        <td>'.FormataDataEdicao(f($RSM,'fim'),9).' </td></tr>';
    ...
    if (f($RSM,'concluida') == 'S' && Nvl(f($RSM,'data_conclusao'),'') > '') {
      ...
      $w_html .= $crlf.'      <tr><td valign="top" colspan="2">';
      $w_html .= $crlf.'      <tr><td>Início:</b></td>';
      $w_html .=$crlf.'          <td>'.FormataDataEdicao(f($RSM,'inicio_real'),9).' </td></tr>';
      $w_html .= $crlf.'      <tr><td>Término:</b></td>';
      $w_html .=$crlf.'          <td>'.FormataDataEdicao(f($RSM,'fim_real'),9).' </td></tr>';
...
function EtapaMail($p_solic) {
  ...
  if(f($RS,'envia_mail_tramite')=='S') {
    ...
    // Prepara os dados necessários ao envio
    $w_assunto='Atualização de itens - '.$w_nome;
...
function Grava() {
  ...
  if($SG=='PJGERAL' || $SG=='PJBGERAL') {
    ...
    if (verificaAssinaturaEletronica($_SESSION['USERNAME'],upper($_REQUEST['w_assinatura'])) || $w_assinatura=='') {
      ...
      if ($O=='E') {
        ...
        if(nvl($_REQUEST['w_solic_pai'],0)!=nvl($_REQUEST['w_chave_pai'],0)) {
          ...
          //ScriptClose();
          dml_putContasCronograma::getInstanceOf($dbms,'F',null,$_REQUEST['w_chave'],null,null,null,null);          
        }
      }
      ...
      if ($O == 'I') {
        ...
        ScriptOpen('JavaScript');
        ShowHTML('  parent.menu.location=\''.montaURL_JS(null,$conRootSIW.'menu.php?par=ExibeDocs&O=A&w_chave='.$w_chave_nova.'&w_documento='.$_REQUEST['w_codigo_interno'].'&R='.$R.'&w_menu='.$w_menu.'&SG='.f($RS1,'sigla').'&TP='.$TP.MontaFiltro('GET')).'\';');
      }elseif ($O=='E') {
        ScriptOpen('JavaScript');
    ...
    if (verificaAssinaturaEletronica($_SESSION['USERNAME'],upper($_REQUEST['w_assinatura'])) || $w_assinatura=='') {
      ...
      if ($O=='E'){
        ...
        if(f($row,'qt_filhos')>0) {
          ScriptOpen('JavaScript');
          ShowHTML('  alert(\'Exite EAP vinculada a esta EAP!\');');
          ShowHTML(' history.back(1);');
          ScriptClose();
          exit();          
        }
      ...
      if($O=='V') {
        ...
        for ($i=1; $i<=count($_POST['w_chave_aux'])-1; $i=$i+1) {
          if (Nvl($_POST['w_valor_real'][$i],'')>'') {
             dml_putCronograma::getInstanceOf($dbms,'V',$_REQUEST['w_chave_rub'],$_POST['w_chave_aux'][$i],
        ...
        if($O=='I') {
          $RS = db_getCronograma::getInstanceOf($dbms,$_REQUEST['w_chave'],$_REQUEST['w_chave_aux'],$_REQUEST['w_inicio'],$_REQUEST['w_fim']);
          if(count($RS)>0) {
            ScriptOpen('JavaScript');
        ...
        $RS = db_getSolicRubrica::getInstanceOf($dbms,$_REQUEST['w_chave_pai'],null,null,null,null,null,null,null,null);
        foreach($RS as $row) {
        ...
        dml_putCronograma::getInstanceOf($dbms,$O,$_REQUEST['w_chave'],$_REQUEST['w_chave_aux'],
    ...
    if (verificaAssinaturaEletronica($_SESSION['USERNAME'],upper($_REQUEST['w_assinatura'])) || $w_assinatura=='') {
      ...
      for ($i=1; $i<=count($_POST['w_prestacao_contas'])-1; $i=$i+1) {
        if (Nvl($_POST['w_prestacao_contas'][$i],'')>'') {
          dml_putContasRegistro::getInstanceOf($dbms,'I',null,$_REQUEST['w_contas_cronograma'],$_POST['w_prestacao_contas'][$i],$_POST['w_pendencia'.$_POST['w_prestacao_contas'][$i]],$_POST['w_observacao'][$i],$_SESSION['SQ_PESSOA']);
        }
      }
      // Recupera a sigla do serviço pai, para fazer a chamada ao menu
      ScriptOpen('JavaScript');
      $RS = db_getLinkData::getInstanceOf($dbms,$_SESSION['P_CLIENTE'],$SG);
      ShowHTML('  location.href=\''.$R.'&R='.$R.'&O=P&w_siw_solicitacao='.$_REQUEST['w_siw_solicitacao'].'&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&TP='.$TP.'&SG='.$SG.MontaFiltro('GET').'\';');
      ScriptClose();
    } else {
      ScriptOpen('JavaScript');
      ShowHTML('  alert(\'Assinatura Eletrônica inválida!\');');
    ...
    if (verificaAssinaturaEletronica($_SESSION['USERNAME'],upper($_REQUEST['w_assinatura'])) || $w_assinatura=='') {
      ...
      $RS = db_getsolicRubrica::getInstanceOf($dbms,$_REQUEST['w_chave'],null,null,null,null,null,null,null,null);
      if(count($RS)>0) {
        foreach($RS as $row) {
    ...
    if (verificaAssinaturaEletronica($_SESSION['USERNAME'],upper($_REQUEST['w_assinatura'])) || $w_assinatura=='') {
      ...
      for ($i=0; $i<=count($_POST['w_sq_projeto_etapa'])-1; $i=$i+1) {
        if (Nvl($_POST['w_sq_projeto_etapa'][$i],'')>'') {
          dml_putRestricaoEtapaInter::getInstanceOf($dbms,'I',$_REQUEST['w_chave_aux'],$_POST['w_sq_projeto_etapa'][$i]);
        } 
      }
      ScriptOpen('JavaScript');
    ...
    if (verificaAssinaturaEletronica($_SESSION['USERNAME'],upper($_REQUEST['w_assinatura'])) || $w_assinatura=='') {
      if (UPLOAD_ERR_OK==0) {
        ...
        foreach ($_FILES as $Chv => $Field) {
          ...
          if ($Field['size'] > 0) {
            ...
            // Se já há um nome para o arquivo, mantém 
            if ($_REQUEST['w_atual']>'') {
              $RS = db_getEtapaAnexo::getInstanceOf($dbms,$_REQUEST['w_etapa'],$_REQUEST['w_atual'],$w_cliente);
              foreach ($RS as $row) {
                if (file_exists($conFilePhysical.$w_cliente.'/'.f($row,'caminho'))) unlink($conFilePhysical.$w_cliente.'/'.f($row,'caminho'));
                if (strpos(f($row,'caminho'),'.')!==false) {
                  $w_file = substr(basename(f($row,'caminho')),0,(strpos(basename(f($row,'caminho')),'.') ? strpos(basename(f($row,'caminho')),'.')+1 : 0)-1).substr($Field['name'],(strpos($Field['name'],'.') ? strpos($Field['name'],'.')+1 : 0)-1,30);
        ...
        dml_putEtapaArquivo::getInstanceOf($dbms,$O,
      ...
      ScriptOpen('JavaScript');
      // Recupera a sigla do serviço pai, para fazer a chamada ao menu 
      ShowHTML('  location.href=\''.montaURL_JS(null,$w_dir.$w_pagina.'AnexosEtapas&R='.$R.'&O=L&w_chave='.$_REQUEST['w_chave'].'&w_etapa='.$_REQUEST['w_etapa'].'&P1='.$P1.'&P2='.$P2.'&P3='.$P3.'&P4='.$P4.'&TP='.$TP.'&SG='.$SG).'\';');
      ScriptClose();
    } else {
      ScriptOpen('JavaScript');
      ShowHTML('  alert(\'Assinatura Eletrônica inválida!\');');
