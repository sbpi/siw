...
class gantt {
    ...
    function today(){
        ...
        if ($this->definitions['today']['data'] - $this->limit['start'] > 0) {
    ...
    function phases($group){
        ...
        if (count($this->groups['group'][$group]['phase'])>0) {
    ...
    function legend(){
        ...
        if (isset($this->definitions['today']['data'])) {
            ...
            $this->text($this->definitions['today']['legend'].' ('.date(d.'/'.m.'/'.y,$this->definitions['today']['data']).')',$x2+$xdiff,$y,$this->definitions['legend']['text_color']);
            $y +=$ydiff;
            if ($this->img_height-$y < $y_) {
                $y = $y = $this->img_height - $this->definitions['legend']['y'];
                $x += $this->definitions['legend']['x'];
