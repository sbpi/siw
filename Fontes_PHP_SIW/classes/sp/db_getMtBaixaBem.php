...
/**
* class db_getMtBaixaBem
*
* { Description :- 
*    Recupera as baixas de bem patrimonial
* }
*/

class db_getMtBaixaBem {
   function getInstanceOf($dbms, $p_cliente, $p_pessoa, $p_restricao, $p_tipo, 
     ...
     extract($GLOBALS,EXTR_PREFIX_SAME,'strchema'); $sql=$strschema.'sp_getMtBaixaBem';
