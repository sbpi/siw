...
class dml_putProgramaGeral {
   function getInstanceOf($dbms, $operacao, $p_chave, $p_copia, $p_menu, $p_objetivo, $p_codigo, $p_titulo, $p_unidade, 
        $p_solicitante, $p_unid_resp, $p_horizonte, $p_natureza, $p_inicio, $p_fim, $p_parcerias, $p_ln_programa, 
        $p_cadastrador, $p_executor, $p_solic_pai, $p_valor, $p_data_hora, $p_aviso, $p_dias, $p_chave_nova) {
