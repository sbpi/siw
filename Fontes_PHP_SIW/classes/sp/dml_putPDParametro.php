...
*
* { Description :- 
*    Mantém a tabela de parâmetros do módulo de passagens e diárias
* }
*/
...
class dml_putPDParametro {
   function getInstanceOf($dbms, $p_cliente, $p_sequencial, $p_ano_corrente, $p_prefixo, $p_sufixo, $p_dias_antecedencia, 
     ...
     $params=array('p_cliente'                   =>array(tvl($p_cliente),                                  B_INTEGER,        32),
                   ...
                   'p_dias_antecedencia'         =>array(tvl($p_dias_antecedencia),                        B_INTEGER,        32),
                   'p_dias_prest_contas'         =>array(tvl($p_dias_prest_contas),                        B_INTEGER,        32),
