...
class dml_putMtEntItem {
   function getInstanceOf($dbms, $operacao, $p_chave, $p_chave_aux, $p_almoxarifado, $p_situacao, $p_ordem, $p_material, 
           $p_quantidade, $p_valor, $p_fator, $p_validade, $p_fabricacao, $p_vida_util, $p_lote, $p_marca, $p_modelo,
           $p_bloqueio, $p_motivo) {
