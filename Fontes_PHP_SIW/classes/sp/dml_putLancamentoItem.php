...
class dml_putLancamentoItem {
   function getInstanceOf($dbms, $operacao, $p_chave, $p_chave_aux, $p_sq_projeto_rubrica, $p_solic_apoio, 
           $p_descricao, $p_quantidade, $p_valor_unitario, $p_ordem, $p_data_cotacao, $p_valor_cotacao, $p_solic_item) {
