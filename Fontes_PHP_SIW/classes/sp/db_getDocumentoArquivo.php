...
/**
* class db_getDocumentoArquivo
*
* { Description :- 
*    Recupera os anexos de um documento financeiro
* }
*/

class db_getDocumentoArquivo {
   function getInstanceOf($dbms, $p_chave, $p_chave_aux, $p_tipo_arquivo, $p_titulo, $p_cliente) {
     extract($GLOBALS,EXTR_PREFIX_SAME,'strchema'); $sql=$strschema.'sp_getDocumentoArquivo';
