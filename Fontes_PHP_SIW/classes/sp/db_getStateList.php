...
*
* { Description :- 
*    Recupera as cidades existentes em relaзгo a um paнs
* }
*/
   ...
   function getInstanceOf($dbms, $p_pais, $p_regiao, $p_ativo, $p_restricao) {
    ...
    extract($par, EXTR_OVERWRITE);
     ...
     $SQL = " select a.co_uf, a.sq_pais, a.sq_regiao, a.nome, a.ativo, a.padrao,$crlf" .
            ...
            "       case a.padrao when 'S' then 'Sim' else 'Nгo' end as padraodesc,$crlf" .
            "       case a.ativo when 'S' then 'Sim' else 'Nгo' end as ativodesc,$crlf" .
