...
class dml_putEsquema {
   function getInstanceOf($dbms, $operacao, $p_cliente, $p_sq_esquema, $p_sq_modulo, $p_nome, $p_descricao, $p_tipo, $p_ativo, $p_formato, $p_ws_servidor, $p_ws_url, $p_ws_acao, $p_ws_mensagem, $p_no_raiz) {
