...
class dml_putMacroObjetivo_IS {
   function getInstanceOf($dbms, $operacao, $p_chave, $p_opcao, $p_nome, $p_ativo,$p_chave_aux ) {
     extract($GLOBALS,EXTR_PREFIX_SAME,'strchema'); $sql=$strschema_is.'SP_PUTMACROOBJETIVO_IS';
