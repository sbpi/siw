...
class dml_putXMLOrgao_PPA {
   function getInstanceOf($dbms, $p_resultado, $p_chave, $p_tipo_org, $p_nome, $p_sigla, $p_ativo) {
     extract($GLOBALS,EXTR_PREFIX_SAME,'strchema'); $sql=$strschema_is.'SP_PUTXMLORGAO_PPA';
