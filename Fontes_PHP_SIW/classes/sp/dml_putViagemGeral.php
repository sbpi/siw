...
class dml_putViagemGeral {
   function getInstanceOf($dbms, $operacao, $p_cliente, $p_chave, $p_menu, $p_unidade, $p_unid_resp, $p_solicitante, 
        $p_cadastrador, $p_tipo, $p_descricao, $p_justificativa, $p_inicio, $p_fim, $p_data_hora, $p_aviso, $p_dias, 
        $p_projeto, $p_atividade, $p_cpf, $p_nome, $p_nome_resumido, $p_sexo, $p_vinculo, $p_inicio_atual, 
