...
*
* { Description :- 
*    Recupera dados da tabela de indicadores
* }
*/

class db_getIndicador {
   function getInstanceOf($dbms, $p_cliente, $p_chave, $p_ativo, $p_pais, $p_regiao, $p_uf, $p_cidade, 
            $p_afe_i, $p_afe_f, $p_ref_i, $p_ref_f, $p_restricao) {
     ...
     $params=array('p_cliente'                =>array(tvl($p_cliente),                                  B_INTEGER,        32),
                   ...
                   'p_uf'                     =>array(tvl($p_uf),                                       B_VARCHAR,         1),
