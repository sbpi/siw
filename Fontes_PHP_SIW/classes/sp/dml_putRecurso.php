...
class dml_putRecurso {
   function getInstanceOf($dbms, $operacao, $p_cliente, $p_usuario, $p_chave, $p_copia, $p_tipo_recurso, $p_unidade_medida, $p_gestora,
            $p_nome, $p_codigo, $p_descricao, $p_finalidade, $p_disponibilidade, $p_ativo) {
