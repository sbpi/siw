...
class dml_putAcordoParc {
   function getInstanceOf($dbms, $operacao, $p_chave, $p_chave_aux, $p_aditivo, $p_ordem, $p_data, $p_valor, 
     ...
     $params=array('p_operacao'                 =>array($operacao,                                  B_VARCHAR,         1),
                   ...
                   'p_valor_inicial'            =>array(toNumber(nvl($p_valor_inicial,0)),          B_NUMERIC,      18,2),
                   'p_valor_excedente'          =>array(toNumber(nvl($p_valor_excedente,0)),        B_NUMERIC,      18,2),
                   'p_valor_reajuste'           =>array(toNumber(nvl($p_valor_reajuste,0)),         B_NUMERIC,      18,2)
                  );
