...
class dml_putAcordoTermo {
   function getInstanceOf($dbms, $operacao, $p_chave, $p_atividades, $p_produtos, $p_requisitos, $p_codigo_externo, $p_vincula_projeto, $p_vincula_demanda, $p_vincula_viagem) {
     $sql=$strschema.'SP_PUTACORDOTERMO';
