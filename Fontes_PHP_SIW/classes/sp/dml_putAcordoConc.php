...
class dml_putAcordoConc {
   function getInstanceOf($dbms, $p_menu, $p_chave, $p_pessoa, $p_tramite, $p_inicio_real, $p_fim_real, $p_nota_conclusao, 
        $p_custo_real, $p_tipo) {
     extract($GLOBALS,EXTR_PREFIX_SAME,'strchema'); $sql=$strschema.'SP_PUTACORDOCONC';
