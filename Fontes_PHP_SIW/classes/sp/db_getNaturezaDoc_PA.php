...
/**
* class db_getNaturezaDoc_PA
*
* { Description :- 
*    Recupera dados da tabela de natureza do documento
* }
*/

class db_getNaturezaDoc_PA {
   function getInstanceOf($dbms, $p_chave, $p_cliente, $p_nome, $p_sigla, $p_ativo, $p_restricao) {
     extract($GLOBALS,EXTR_PREFIX_SAME,'strchema'); $sql=$strschema_PE.'SP_GETNATUREZADOC_PA';
