...
class dml_putAcordoGeral {
   function getInstanceOf($dbms, $operacao, $p_cliente, $p_chave, $p_menu, $p_unid_resp, $p_solicitante, $p_cadastrador, $p_sqcc, 
        ...
        $p_codigo, $p_titulo, $p_numero_empenho, $p_numero_processo, $p_data_assinatura,  $p_data_publicacao, $p_moeda,
        &$p_chave_nova, $p_copia, $p_herda, $p_pessoa, &$p_codigo_interno) {
