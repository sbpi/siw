...
class dml_putCLDados {
   function getInstanceOf($dbms, $restricao, $p_chave, $p_sq_lcmodalidade, $p_numero_processo, $p_abertura,
                $p_numero_certame,$p_numero_ata, $p_tipo_reajuste, $p_indice_base, $p_sq_eoindicador, $p_limite_variacao, 
                ...
                $p_fim, $p_prioridade, $p_observacao, $p_fundo_fixo, $p_detalhamento) {
