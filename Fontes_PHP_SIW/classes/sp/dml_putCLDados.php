...
class dml_putCLDados {
   function getInstanceOf($dbms, $restricao, $p_chave, $p_executor, $p_sq_lcmodalidade, $p_numero_processo, $p_abertura,
                ...
                $p_just_valor, $p_arquivo_justificativa
            ) {
     ...
     $params=array('p_restricao'              =>array($restricao,                                 B_VARCHAR,        30),
                   ...
                   'p_envelope_2'             =>array(tvl($p_envelope_2),                         B_VARCHAR,        17),
                   'p_envelope_3'             =>array(tvl($p_envelope_3),                         B_VARCHAR,        17),
                   ...
                   'p_just_valor'             =>array(tvl($p_just_valor),                         B_VARCHAR,      2000),
                   'p_arquivo_justificativa'  =>array(tvl($p_arquivo_justificativa),              B_INTEGER,        32)
                  );
