...
class dml_putConvOutraParte {
   function getInstanceOf($dbms, $operacao, $p_restricao, $p_sq_acordo_outra_parte, $p_chave, $p_sq_pessoa, $p_tipo, $p_chave_aux, $p_cnpj, $p_nome, 
        $p_nome_resumido, $p_inscricao_estadual, $p_logradouro, $p_complemento, $p_bairro, $p_sq_cidade, $p_cep, $p_ddd, $p_nr_telefone, $p_nr_fax, 
