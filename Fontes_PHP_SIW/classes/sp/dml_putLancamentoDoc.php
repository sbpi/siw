...
class dml_putLancamentoDoc {
   function getInstanceOf($dbms, $operacao, $p_chave, $p_chave_aux, $p_sq_tipo_documento, $p_numero, $p_data, $p_serie, $p_valor, $p_patrimonio, $p_retencao, $p_tributo) {
     $sql=$strschema.'SP_PUTLANCAMENTODOC';
