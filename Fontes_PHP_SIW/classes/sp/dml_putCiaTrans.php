...
class dml_putCiaTrans {
   function getInstanceOf($dbms, $operacao, $p_cliente, $p_chave, $p_nome,$p_sigla, $p_aereo, $p_rodoviario, $p_aquaviario, $p_padrao, $p_ativo) {
     extract($GLOBALS,EXTR_PREFIX_SAME,'strchema'); $sql=$strschema.'SP_PUTCIATRANS';
