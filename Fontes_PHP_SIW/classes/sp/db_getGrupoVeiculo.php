...
class db_getGrupoVeiculo {
   function getInstanceOf($dbms, $p_chave, $p_cliente, $p_nome, $p_sigla, $p_ativo) {
     extract($GLOBALS,EXTR_PREFIX_SAME,'strchema'); $sql=$strschema.'SP_GETGRUPOVEICULO';
