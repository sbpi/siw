...
class dml_putSolicArquivo {
   function getInstanceOf($dbms, $operacao, $p_cliente, $p_chave, $p_chave_aux, $p_nome, $p_descricao, $p_caminho, $p_tamanho, $p_tipo, $p_nome_original, &$p_chave_nova) {
     extract($GLOBALS,EXTR_PREFIX_SAME,'strchema'); $sql=$strschema.'sp_putSolicArquivo';
