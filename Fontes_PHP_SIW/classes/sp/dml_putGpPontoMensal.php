...
class dml_putGpPontoMensal {
   function getInstanceOf($dbms, $p_operacao, $p_contrato, $p_mes, $p_horas_trabalhadas, $p_horas_extras, $p_horas_atrasos, $p_horas_banco){
     extract($GLOBALS,EXTR_PREFIX_SAME,'strchema');
     $sql=$strschema.'sp_putGpPontoMensal';
