...
class dml_putPD_Contas {
   function getInstanceOf($dbms, $p_cliente, $p_chave, $p_cumprimento, $p_nota_conclusao, $p_sq_relatorio, 
        $p_exclui, $p_nome, $p_descricao, $p_caminho, $p_tamanho, $p_tipo, $p_nome_original) {
