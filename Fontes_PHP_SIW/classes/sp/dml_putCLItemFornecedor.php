...
class dml_putCLItemFornecedor {
   function getInstanceOf($dbms, $operacao, $p_cliente, $p_chave, $p_chave_aux, $p_material,  $p_fornecedor, $p_inicio, $p_fim, 
                          $p_valor, $p_quantidade, $p_fabricante, $p_marca_modelo, $p_embalagem, $p_ordem, $p_vencedor, $p_pesquisa) {
