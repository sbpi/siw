...
/**
* class dml_putRestricaoAcao_IS
*
* { Description :- 
*    Mantém a tabela de restrições da ação
* }
*/

class dml_putRestricaoAcao_IS {
   function getInstanceOf($dbms, $operacao, $cliente, $ano, $p_programa, $p_acao, $p_subacao, $p_chave_aux, $p_cd_tipo_restricao, $p_cd_tipo_inclusao, $p_cd_competencia, $p_superacao, $p_relatorio, $p_tempo_habil, $p_descricao, $p_providencia, $p_observacao_controle, $p_observacao_monitor) {
     extract($GLOBALS,EXTR_PREFIX_SAME,'strchema'); $sql=$strschema_is.'SP_PUTRESTRICAOACAO_IS';
     $params=array('p_operacao'                  =>array($operacao,                                        B_VARCHAR,         1),
                   'p_cliente'                   =>array($cliente,                                         B_INTEGER,        32),
                   'p_ano'                       =>array($ano,                                             B_INTEGER,        32),
                   'p_programa'                  =>array($p_programa,                                      B_VARCHAR,         4),
                   'p_acao'                      =>array($p_acao,                                          B_VARCHAR,         4),
                   'p_subacao'                   =>array($p_subacao,                                       B_VARCHAR,         4),
