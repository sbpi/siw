...
*/	                  
class dml_putCaixa {
   function getInstanceOf($dbms, $operacao, $p_cliente, $p_chave,$p_sq_unidade ,$p_sq_arquivo_local,$p_assunto,$p_descricao ,$p_data_limite,$p_numero,$p_intermediario,$p_destinacao_final,$p_arquivo_data,$p_arquivo_guia_numero,$p_arquivo_guia_ano,$p_elimin_data,$p_elimin_guia_numero,$p_elimin_guia_ano) {
