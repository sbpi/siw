...
/**
* class dml_putDocumentoArquivo
*
* { Description :- 
*    Mantém a tabela de arquivos de um documento financeiro
* }
*/
...
class dml_putDocumentoArquivo {
   function getInstanceOf($dbms, $operacao, $p_cliente, $p_chave, $p_chave_aux, $p_nome, $p_ordem, $p_tipo_arquivo, $p_descricao, 
     ...
     extract($GLOBALS,EXTR_PREFIX_SAME,'strchema'); $sql=$strschema.'sp_putDocumentoArquivo';
