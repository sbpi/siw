...
/**
* class db_getTipoDespacho_PA
*
* { Description :- 
*    Recupera dados da tabela de tipo de despacho do documento
* }
*/

class db_getTipoDespacho_PA {
   function getInstanceOf($dbms, $p_chave, $p_cliente, $p_nome, $p_sigla, $p_ativo,$p_restricao) {
     extract($GLOBALS,EXTR_PREFIX_SAME,'strchema'); $sql=$strschema_PE.'SP_GETTIPODESPACHO_PA';
