 ...
 **/
 ...
 function barra() {
     ...
     switch($p_genero) {
         case 'M' : $datax = array('Total','Encerrados','Tramitaчуo','Casdastramento','Atrasados','Em aviso de atraso', 'Acima do valor previsto');  break;
         case 'F' : $datax = array('Total','Encerradas','Tramitaчуo','Casdastramento','Atrasadas','Em aviso de atraso', 'Acima do valor previsto');  break;
     }
 ...
 function barra2() {
    ...
    $datax = array('No prazo','Aviso','Atrasados(as)');  
 ...
 function pizza() {
    ...
    $p1->SetLabelPos(0.8);
     switch($p_genero) {
         case 'M' : $p1->SetLegends(array('No prazo', 'Aviso', 'Atrasados')); break;
         case 'F' : $p1->SetLegends(array('No prazo', 'Aviso', 'Atrasadas')); break;
     }
