...
// -------------------------------------------------------------------------
function visualFatura($w_sq_cliente, $p_fatura) {
  extract($GLOBALS);
  ...
  if ($l_tipo != 'WORD')
    ...
    $l_html.=chr(13) . '        <td>' . exibeSolic($w_dir, f($RS, 'sq_projeto'), f($RS, 'sq_projeto'), 'S', 'S') . '</td></tr>';
