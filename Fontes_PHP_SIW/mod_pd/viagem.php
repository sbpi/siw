...
function DadosFinanceiros() {
  ...
  if (count($RS)>0) {
    ...
    foreach($RS as $row) {
      ...
      if ($i>1) {
        $w_vetor_trechos[$i-1][5] = FormataDataEdicao(f($row,'phpdt_saida'),3);
      }
      $i += 1;
    } 
...
function RelatorioViagem($w_chave) {
  ...
  $w_html .= "\\par }\\pard \\ql \\li0\\ri0\\widctlpar\\intbl\\tx5220\\aspalpha\\aspnum\\faauto\\adjustright\\rin0\\lin0 {\\insrsid1469200 Nome:  }{\\insrsid6709522" .f($RS1,"nm_pessoa"). "}{\\insrsid1469200                }{\\insrsid6709522                 }{\\insrsid1469200 Matr\\'edcula: ";
  ...
  $w_html .= "\\cltxlrtb\\clftsWidth3\\clwWidth9430\\clshdrawnil \\cellx9360\\row }\\pard \\ql \\li0\\ri0\\widctlpar\\intbl\\aspalpha\\aspnum\\faauto\\adjustright\\rin0\\lin0 {\\insrsid1469200 Autoriza\\'e7\\'e3o do Afastamento: " . f($RS,"codigo_interno");
  $w_html .= "\\par ";
...
function SolicMail($p_solic,$p_tipo) {
  ...
  if ($p_tipo==2) {
    ...
    $w_html .= chr(13).'      <tr><td valign="top" colspan="2"><table border=0 width="100%" cellspacing=0>';
    $w_html .= chr(13).'          <tr><td>De:<br><b>'.f($RS,'responsavel').'</b></td>';
    $w_html .= chr(13).'          <tr><td>Despacho:<br><b>'.CRLF2BR(Nvl(f($RS,'despacho'),'---')).' </b></td>';
    $w_html .= chr(13).'          </table>';
  } 
