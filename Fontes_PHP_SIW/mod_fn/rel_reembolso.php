...
$w_pagina       = 'rel_reembolso.php?par=';
$w_Disabled     = 'ENABLED';
$w_dir          = 'mod_fn/';
...
function Inicial() {
  ...
  // Coloca o gráfico somente se o usuário desejar
    ...
    ShowHTML('      <tr valign="top">');
    ShowHTML('          <td><b>Código da solicitação:<br><INPUT class="STI" type="text" name="p_empenho" size="10" maxlength="30" value="'.$p_empenho.'">');
    ShowHTML('      <tr valign="top">');
    ShowHTML('         <td><font size=1><b><u>P</u>rocurar pelo nome:</b> (Informe qualquer parte do nome SEM ACENTOS)<br><INPUT ACCESSKEY="P" TYPE="text" class="sti" NAME="p_nome" VALUE="' . $p_nome . '" SIZE="20" MaxLength="20">');
    ...
    ShowHTML('      <tr valign="top">');
    SelecaoUnidade('<U>U</U>nidade solicitante:','U',null,$p_unidade,null,'p_unidade',null,null);
    if ($p_nome > '') {
      $sql = new db_getBenef;
