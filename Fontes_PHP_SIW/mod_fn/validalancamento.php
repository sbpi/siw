...
function ValidaLancamento($p_cliente,$l_chave,$p_sg1,$p_sg2,$p_sg3,$p_sg4,$p_tramite) {
  ...
  /* Desabilitado porque está dando problema quando o valor do contrato é em dolar e o do pagamento é em reais (FN-386/2019)
     Para ficar certo, precisa testar convertendo a moeda do pagamento para a moeda do contrato
  ...
  */
  ...
  if ($v_modulo_pai=='CO') {
    ...
    $sql = new db_getSolicCL; $l_rs_comp = $sql->getInstanceOf($dbms,$v_dados_pai[3],$_SESSION['SQ_PESSOA'],'FINANCEIRO',3,
        ...
        null,null,null,null,null,null,null,$l_chave,null,null,null,null,null,null,null,Nvl(f($l_rs_solic,'pessoa'),0),null,null,null,null);
