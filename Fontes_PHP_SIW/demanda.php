...
function SolicMail($p_solic,$p_tipo) {
  ...
  if ($p_tipo==1) {
    $w_html=$w_html.'      <tr valign="top"><td align="center"><font size=2><b>INCLUSÃO DE DEMANDA</b><br><br><td></tr>'.chr(13);
  } elseif ($p_tipo==2) {
    $w_html=$w_html.'      <tr valign="top"><td align="center"><font size=2><b>TRAMITAÇÃO DE DEMANDA</b><br><br><td></tr>'.chr(13);
  } elseif ($p_tipo==3) {
    $w_html=$w_html.'      <tr valign="top"><td align="center"><font size=2><b>CONCLUSÃO DE DEMANDA</b><br><br><td></tr>'.chr(13);
  } 
  ...
  $w_html=$w_html.chr(13).'      <tr><td valign="top" colspan="2" align="center" bgcolor="#D0D0D0" style="border: 2px solid rgb(0,0,0);"><b>EXTRATO DA DEMANDA</td>';
  ...
  if (Nvl(f($RSM,'descricao'),'')>'') {
    $w_html=$w_html.chr(13).'      <tr><td valign="top">Resultados da demanda:<br><b>'.CRLF2BR(f($RSM,'descricao')).' </b></td>';
  }
  $w_html=$w_html.chr(13).'    </table>';
