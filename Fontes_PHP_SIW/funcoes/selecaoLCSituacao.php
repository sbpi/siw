...
// -------------------------------------------------------------------------
function selecaoLCSituacao($label,$accesskey,$hint,$chave,$chaveAux,$campo,$restricao,$atributo,$colspan=1) {
  extract($GLOBALS);
  $sql = new db_getLCSituacao; $RS = $sql->getInstanceOf($dbms,null,$w_cliente,null,'S',null,null,$restricao);
