...
function selecaoRubrica($label,$accesskey,$hint,$chave,$chaveAux,$sq_rubrica_destino,$campo,$restricao,$atributo) {
  extract($GLOBALS);
  if ($restricao=='RUBRICAS')   $RS = db_getSolicRubrica::getInstanceOf($dbms,$chaveAux,null,'S',$sq_rubrica_destino,'N',null);
  else                          $RS = db_getSolicRubrica::getInstanceOf($dbms,$chaveAux,null,'S',$sq_rubrica_destino,null,$restricao);
