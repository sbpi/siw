...
// -------------------------------------------------------------------------
function selecaoPeriodicidade_IS($label,$accesskey,$hint,$l_chave,$campo,$restricao,$atributo,$colspan=1) {
  extract($GLOBALS);
  $sql = new db_getPeriodicidade_IS; $RS = $sql->getInstanceOf($dbms,null,'S');
