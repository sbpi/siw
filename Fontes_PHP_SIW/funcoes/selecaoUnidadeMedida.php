...
// -------------------------------------------------------------------------
function selecaoUnidadeMedida($label,$accesskey,$hint,$chave,$chaveAux,$campo,$restricao,$atributo) {
  extract($GLOBALS);
  $RS = db_getUnidadeMedida::getInstanceOf($dbms,$w_cliente,null,null,null,'S', $restricao);
