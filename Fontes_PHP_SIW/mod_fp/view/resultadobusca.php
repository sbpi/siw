    ...
    <td height="300" colspan="5"><div align="center">
      <form id="form2" name="form2" method="post" action="../negocio/login.php?action=login">
        <table width="539" border="0" align="center">
          <tr>
            <td bgcolor="#CCCCCC"><div align="center">MATR&Iacute;CULA</div></td>
            <td bgcolor="#CCCCCC"><div align="center">NOME</div></td>
            <td bgcolor="#CCCCCC"><div align="center">A&Ccedil;&Atilde;O</div></td>
          </tr>
          <?php do{?>
          <tr>
            <td width="147" bgcolor="#F4F4F4"><div align="center"><?php echo $data->Lista['matricula'];?></div></td>
            <td width="279" bgcolor="#F4F4F4"><div align="center"><?php echo $data->Lista['nome'];?></div></td>
            <td width="99" bgcolor="#F4F4F4"><div align="center"><a href="../negocio/usuario.php?action=cadastro&id_funcionario=<?php echo $data->Lista['id_funcionario'];?>">COPIAR</a></div></td>
          </tr>
