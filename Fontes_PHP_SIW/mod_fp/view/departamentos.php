...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td height="300" colspan="5"><div align="center">
      <form id="form" name="form" method="post" action="../negocio/login.php?action=login">
        <table width="291" border="0" align="center">
          <tr>
            <td bgcolor="#CCCCCC"><div align="center">DEPARTAMENTO</div></td>
            <td bgcolor="#CCCCCC"><div align="center">A&Ccedil;&Atilde;O</div></td>
          </tr>
          <?php do{?>
          <tr>
            <td bgcolor="#F4F4F4"><div align="center"><a href="../negocio/departamento.php?action=alteracao&id_departamento=<?php echo $data->Lista['id_departamento'];?>"><?php echo $data->Lista['departamento'];?></a></div></td>
            <td width="99" bgcolor="#F4F4F4"><div align="center"><a href="../negocio/departamento.php?action=excluir&id_departamento=<?php echo $data->Lista['id_departamento'];?>">DELETAR</a></div></td>
          </tr>
          <?php }while( $data->ViewDatabase() );?>
          <tr>
            <td colspan="2" bgcolor="#F4F4F4"><div align="right"><a href="../negocio/departamento.php?action=cadastro">+ Incluir departamento </a></div></td>
            </tr>
        </table>
      </form>
    </div></td>
