...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td height="300" colspan="5"><div align="center">
      <form id="form2" name="form2" method="post" action="../negocio/usuario.php?action=alterar">
        <table border="0" align="center">
          <tr>
            <td colspan="2"><div align="center"><strong>ALTERAR USU&Aacute;RIO</strong></div></td>
            </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td width="107"><div align="right">Funcionário: </div></td>
            <td width="183"><?php echo $data->Lista['nome'];?>            </td>
          </tr>
          <tr>
            <td width="107"><div align="right">Login: </div></td>
            <td width="183"><input type="text" name="login" value="<?php echo $data->Lista['login'];?>"/>            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td><div align="right">Permiss&atilde;o:</div></td>
            <td><select name="id_permissao">
            
            		<?php do{?>
            		<option value="<?php echo $permissao->Lista['id_permissao'];?>" <?php if($permissao->Lista['id_permissao'] == $data->Lista['id_permissao']) echo "selected=selected";?> ><?php echo $permissao->Lista['permissao'];?></option>
            		<?php }while( $permissao->ViewDatabase() );?>
            	</select></td>
          </tr>
          <tr>
            <td><div align="right">Status:</div></td>
            <td><select name="status">
              <option value="ATIVO" <?php if( $data->Lista['status'] == "ATIVO" ){ echo "selected=selected"; }?> >ATIVO</option>
              <option value="INATIVO" <?php if( $data->Lista['status'] == "INATIVO" ){ echo "selected=selected"; }?> >INATIVO</option>
            </select>            </td>
          </tr>
          <tr>
            <td colspan="2"><div align="center">
              <input type="hidden" name="id_usuario" value="<?php echo $data->Lista['id_usuario'];?>" />
