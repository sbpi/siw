...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td height="300" colspan="5"><div align="center">
      <form id="form" name="form" method="post" action="../negocio/dependente.php?action=alterar">
        <table border="0" align="center">
          <tr>
            <td colspan="2"><div align="center"><strong>ALTERAR DEPENDENTE </strong></div></td>
            </tr>
          <tr>
            <td width="107"><div align="right">Funcionário: </div></td>
            <td width="183"><input type="text" name="id_funcionario" value="<?php echo $data->Lista['id_funcionario'];?>" disabled/></td>
          ...
          <tr>
            ...
            <td><input name="parentesco" type="text" id="parentesco" value="<?php echo $data->Lista['parentesco']?>" /></td>
          </tr>
          <tr>
            <td colspan="2"><div align="center">
				<input type="hidden" name="id_dependente" value="<?php echo $data->Lista['id_dependente'];?>"/>
