...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td height="300" colspan="5"><div align="center">
      <form id="form" name="form" method="post" action="../negocio/beneficio.php?action=cadastrar">
        <p>&nbsp;</p>
        <table border="0" align="center">
          ...
          <tr>
            ...
            <td><input name="funcionario" type="text" id="funcionario" value="<?php echo $data->Lista['nome'];?>" disabled="disabled"/>            </td>
          </tr>
          <tr>
            <td><div align="right">Nome: </div></td>
            <td><select name="id_beneficio" id="id_beneficio">
          <option value="">Selecione</option>
		  <?php do{ ?>
          <option value="<?php echo $dataBeneficio->Lista['id_lista_beneficio']; ?>"><?php echo $dataBeneficio->Lista['nome'];  }while( $dataBeneficio->ViewDatabase() ); ?> </option>

        </select>            </td>
          </tr>
          <tr>
            <td><div align="right">Periodicidade: </div></td>
            <td><input name="periodicidade" type="text" id="periodicidade" />            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="173"><input name="valor_beneficio" type="text" id="valor_beneficio" />            </td>
          </tr>
          <tr>
