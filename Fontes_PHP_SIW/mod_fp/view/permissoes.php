    ...
    <td height="300" colspan="5"><div align="center">
      <form id="form2" name="form2" method="post" action="../negocio/login.php?action=login">
        <table width="291" border="0" align="center">
          <tr>
            <td bgcolor="#CCCCCC"><div align="center">PERMISS&Otilde;ES</div></td>
            <td bgcolor="#CCCCCC"><div align="center">A&Ccedil;&Atilde;O</div></td>
          </tr>
          <?php do{?>
          <tr>
            <td bgcolor="#F4F4F4"><div align="center"><a href="../negocio/permissao.php?action=alteracao&id_permissao=<?php echo $data->Lista['id_permissao'];?>"><?php echo $data->Lista['permissao'];?></a></div></td>
            <td width="99" bgcolor="#F4F4F4"><div align="center"><a href="../negocio/permissao.php?action=excluir&id_permissao=<?php echo $data->Lista['id_permissao'];?>">DELETAR</a></div></td>
          </tr>
          <?php }while( $data->ViewDatabase() );?>
          <tr>
            <td colspan="2" bgcolor="#F4F4F4"><div align="right"><a href="../negocio/permissao.php?action=cadastro">+ Incluir usu&aacute;rio</a></div></td>
            </tr>
        </table>
      </form>
    </div></td>
