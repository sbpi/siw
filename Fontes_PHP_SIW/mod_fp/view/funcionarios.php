    ...
    <td height="300" colspan="5"><div align="center">
      <form id="form2" name="form2" method="post" action="../negocio/login.php?action=login">
        <table width="691" border="0" align="center">
          <tr>
            <td bgcolor="#CCCCCC"><div align="center">MATRICULA</div></td>
            <td bgcolor="#CCCCCC"><div align="center">NOME</div></td>
            <td colspan="3" bgcolor="#CCCCCC"><div align="center">A&Ccedil;&Atilde;O</div></td>
            </tr>
          <?php do{?>
          <tr>
            <td width="140" bgcolor="#F4F4F4"><div align="center"><a href="../negocio/funcionario.php?action=alteracao&id=<?php echo $data->Lista['id_funcionario'];?>"><?php echo $data->Lista['matricula'];?></a></div></td>
            <td width="274" bgcolor="#F4F4F4"><div align="center"><?php echo $data->Lista['nome'];?></div></td>
            <td width="81" bgcolor="#F4F4F4"><div align="center"><a href="../negocio/beneficio.php?action=listar&amp;id_funcionario=<?php echo $data->Lista['id_funcionario'];?>">BENEF&Iacute;CIOS</a></div></td>
            <td width="105" bgcolor="#F4F4F4"><div align="center"><a href="../negocio/dependente.php?action=listar&id_funcionario=<?php echo $data->Lista['id_funcionario'];?>">DEPENDENTES</a></div></td>
            <td width="69" bgcolor="#F4F4F4"><div align="center"><a href="../negocio/funcionario.php?action=excluir&id_funcionario=<?php echo $data->Lista['id_funcionario'];?>">DELETAR</a></div></td>
          </tr>
          <?php }while( $data->ViewDatabase() );?>
          <tr>
            <td colspan="5" bgcolor="#F4F4F4"><div align="right"><a href="../negocio/funcionario.php?action=cadastro"> Incluir funcion&aacute;rio </a> | <a href="../negocio/cargo.php?action=listar"> Incluir cargo</a> | <a href="../negocio/departamento.php?action=listar"> Incluir departamento </a></div></td>
            </tr>
        </table>
      </form>
    </div></td>
