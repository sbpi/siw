...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td height="300" colspan="5"><div align="center">
      <form id="form2" name="form2" method="post" action="../negocio/usuario.php?action=cadastrar">
        <table border="0" align="center">
          <tr>
            <td colspan="2"><div align="center"><strong>NOVO USU&Aacute;RIO</strong></div></td>
            </tr>
          <tr>
            <td width="107"><div align="right">Funcionário: </div></td>
            <td width="183"><input type="text" name="id_funcionario" value="<?php echo $id_funcionario;?>" disabled/></td>
            <input type="hidden" name="id_funcionario" value="<?php echo $id_funcionario;?>"/>
          </tr>
          <tr>
            <td width="107"><div align="right">Login: </div></td>
            <td width="183"><input type="text" name="login" />            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><select name="id_permissao">
            		...
            		<?php do{?>
            		<option value="<?php echo $data->Lista['id_permissao'];?>"><?php echo $data->Lista['permissao'];?></option>
