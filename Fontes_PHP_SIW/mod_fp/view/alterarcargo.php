...
<table width="770" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td height="300" colspan="5"><div align="center">
      <form id="form" name="form" method="post" action="../negocio/cargo.php?action=alterar">
        <p>&nbsp;</p>
        <table border="0" align="center">
          <tr>
            <td colspan="2"><div align="center"><strong>ALTERAR CARGO </strong></div></td>
            </tr>
          <tr>
            <td width="107"><div align="right">Nome: </div></td>
            <td width="183"><input name="nome" type="text" id="nome" value="<?php echo $data->Lista['nome'];?>" /></td>
			<input type="hidden" name="id_cargo" value="<?php echo $data->Lista['id_cargo']; ?>" />
          </tr>
          <tr>
