  ...
  <tr>
    <td height="300" colspan="5"><div align="center">
        <table width="400" border="0" align="center">
          <tr>
            <td width="303" bgcolor="#CCCCCC"><div align="center">DEPENDENTE(S)</div></td>
            <td bgcolor="#CCCCCC"><div align="center">A&Ccedil;&Atilde;O</div></td>
          </tr>
          <?php do{?>
          <tr>
            <td bgcolor="#F4F4F4"><div align="center"><a href="../negocio/dependente.php?action=alteracao&id_dependente=<?php echo $data->Lista['id_dependente'];?>" ><?php echo $data->Lista['nome'];?></a></div>              <div align="center"></div></td>
            <td width="87" bgcolor="#F4F4F4"><div align="center"><a href="../negocio/dependente.php?action=excluir&id_dependente=<?php echo $data->Lista['id_dependente'];?>&id_funcionario=<?php echo $_GET['id_funcionario'];?>" >DELETAR</a></div></td>
          </tr>
          <?php }while( $data->ViewDatabase() );?>
          <tr>
            <td colspan="2" bgcolor="#F4F4F4"><div align="right"><a href="../negocio/dependente.php?action=cadastro&id_funcionario=<?php echo $_GET['id_funcionario'];?>">+ Incluir dependente </a></div></td>
            </tr>
        </table>
    </div></td>
  </tr>
