    ...
    <td height="300" colspan="5"><div align="center">
      <form id="form2" name="form2" method="post" action="../negocio/login.php?action=login">
        <table width="291" border="0" align="center">
          ...
          <?php do{?>
          <tr>
            <td bgcolor="#F4F4F4"><div align="center"><a href="../negocio/cargo.php?action=alteracao&id_cargo=<?php echo $data->Lista['id_cargo'];?>"><?php echo $data->Lista['nome'];?></a></div></td>
            <td width="99" bgcolor="#F4F4F4"><div align="center"><a href="../negocio/cargo.php?action=excluir&id_cargo=<?php echo $data->Lista['id_cargo'];?>">DELETAR</a></div></td>
          </tr>
          <?php }while( $data->ViewDatabase() );?>
          <tr>
            <td colspan="2" bgcolor="#F4F4F4"><div align="right"><a href="../negocio/cargo.php?action=cadastro">+ Incluir cargo </a></div></td>
            </tr>
        </table>
      </form>
    </div></td>
