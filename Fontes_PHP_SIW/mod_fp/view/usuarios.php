    ...
    <td height="300" colspan="5"><div align="center">
      <form id="form2" name="form2" method="post" action="../negocio/login.php?action=login">
        <table width="552" border="0" align="center">
          <tr>
            <td bgcolor="#CCCCCC"><div align="center">USU&Aacute;RIO</div></td>
            <td bgcolor="#CCCCCC"><div align="center">FUNCION&Aacute;RIO</div></td>
            <td bgcolor="#CCCCCC"><div align="center">A&Ccedil;&Atilde;O</div></td>
          </tr>
          <?php do{?>
          <tr>
            <td width="109" bgcolor="#F4F4F4"><div align="center"><a href="../negocio/usuario.php?action=alteracaousuario&id=<?php echo $data->Lista['id_usuario'];?>"><?php echo $data->Lista['login'];?></a></div></td>
            <td width="353" bgcolor="#F4F4F4"><div align="left" style="margin-left:20px;"><?php echo $data->Lista['nome'];?></div></td>
            <td width="76" bgcolor="#F4F4F4"><div align="center"><a href="../negocio/usuario.php?action=excluir&id_usuario=<?php echo $data->Lista['id_usuario'];?>">DELETAR</a></div></td>
            
          </tr>
          <?php }while( $data->ViewDatabase() );?>
          <tr>
            <td colspan="3" bgcolor="#F4F4F4"><div align="right"><a href="../view/buscarfuncionario.php">Incluir usu&aacute;rio</a> | <a href="../negocio/permissao.php?action=listar">Administrar permiss&otilde;es</a> </div></td>
            </tr>
        </table>
      </form>
    </div></td>
