...
if ((strpos($SG,'PARC')!==false) || !(strpos($SG,'ANEXO')===false) || !(strpos($SG,'OUTRA')===false) || !(strpos($SG,'DADOS')===false) || !(strpos($SG,'NOTA')===false)) {
...
function Geral() {
  ...
  if ($O=='I' || $O=='A') {
    ...
    if ($O=='I') Validate('w_pessoa_nm', 'Outra parte:', 'HIDDEN', 1, 5, 100, '1', '1');
  ...
  if (substr($SG,3,3)=='CAD') {
    ...
    if (verificaAssinaturaEletronica($_SESSION['USERNAME'],$w_assinatura) || $w_assinatura=='') {
      ...
      $SQL = new dml_putAcordoGeral; $SQL->getInstanceOf($dbms,$O, $w_cliente, 
          ...
          $_REQUEST['w_sq_tipo_acordo'], $_REQUEST['w_objeto'], $_REQUEST['w_tipo_pessoa'], 
          ...
          $w_chave_nova, $w_copia, $_REQUEST['w_herda'], $_REQUEST['w_pessoa'], $w_codigo);
      if ($O=='I') {
