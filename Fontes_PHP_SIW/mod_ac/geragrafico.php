<?php
 ...
 include ($w_dir_volta.'classes/jpgraph/jpgraph.php');
 include ($w_dir_volta.'classes/jpgraph/jpgraph_bar.php');
 include ($w_dir_volta.'classes/jpgraph/jpgraph_pie.php'); 
 include ($w_dir_volta.'classes/jpgraph/jpgraph_pie3d.php');
 ...
 * @Data de criaчуo: 12/11/2003, 10:30
 * @version 0.1
 ...
 **/
 ...
 function barra() {
     ...
     switch($p_genero) {
         case 'M' : $datax = array('Total','Encerrados','Em execuчуo','Cadastramento','Restos a pagar','Em aviso de atraso', 'Acima do valor previsto');  break;
         case 'F' : $datax = array('Total','Encerradas','Em execuчуo','Cadastramento','Restos a pagar','Em aviso de atraso', 'Acima do valor previsto');  break;
     }
 ...
 function barra2() {
    ...
    $datax = array('Normal','Aviso','Restos a pagar');  
    ...
    $graph->title->Set(upper('Anсlise de '.$p_objeto.' em andamento'));
 ...
 function pizza() {
    ...
    $titulo = 'Anсlise de '.$p_objeto.' em andamento';
    $graph->title->Set(upper($titulo));
    ...
    $p1->SetLabelPos(0.8);
     switch($p_genero) {
         case 'M' : $p1->SetLegends(array('Normal', 'Aviso', 'Restos a pagar')); break;
         case 'F' : $p1->SetLegends(array('Normal', 'Aviso', 'Restos apagar')); break;
     }
