...
function Geral() {
  ...
  if (!(strpos('IAEV',$O)===false)) {
    ...
    if($w_segmento=='Público') {
      ShowHTML('      <tr><td colspan="2"><table border=0 width="100%" cellspacing=0>');
      ShowHTML('          <td><b><U>N</U>úmero do empenho:<br><INPUT ACCESSKEY="N" '.$w_Disabled.' class="STI" type="text" name="w_numero_empenho" size="20" maxlength="30" value="'.$w_numero_empenho.'"></td>');
...
function Termo() {
  ...
  if ($O=='I' || $O=='A') {
    ...
    Validate('w_requisitos','Qualificação exigida','1',1,5,2000,'1','1');
  ...
  if (!(strpos('IAEV',$O)===false)) {
    ...
    ShowHTML('      <tr><td align="center" height="1" bgcolor="#000000"></td></tr>');
    ShowHTML('      <tr><td><b><u>C</u>ódigo para a outra parte:</b><br><INPUT ACCESSKEY="C" '.$w_Disabled.' class="sti" type="text" name="w_codigo_externo" size="60" maxlength="60" value="'.$w_codigo_externo.'" title="Informe, se desejar, o código pelo qual este acordo é reconhecido pela outra parte."></td>');
