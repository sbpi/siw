...
function centralTel() {
  ...
  if ($O=='L') {
    ...
    ShowHTML('      <tr><td align="LEFT" colspan=2><font size="1"><b>'.$_SESSION['LABEL_CAMPO'].':<BR> <INPUT ACCESSKEY="A" class="sti" type="PASSWORD" name="w_assinatura" size="30" maxlength="30" value=""></td></tr>');
