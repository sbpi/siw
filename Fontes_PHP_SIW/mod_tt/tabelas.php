...
include_once('../classes/sp/db_getCentralTel.php');
include_once('../classes/sp/db_getTTRamal.php');
include_once('../classes/sp/db_getPersonData.php');
include_once('../classes/sp/db_getPrefixo.php');
include_once('../classes/sp/db_getTTUsuario.php');
include_once('../classes/sp/db_getRamalUsuarioAtivo.php');
include_once('../classes/sp/db_getPessoaTel.php');
include_once('../classes/sp/db_verificaAssinatura.php');
include_once('../classes/sp/dml_putTTCentral.php');
include_once('../classes/sp/dml_putTTPrefixo.php');
include_once('../classes/sp/dml_putTTRamal.php');
include_once('../classes/sp/dml_putTTRamalUsuario.php');
include_once('../classes/sp/dml_putTTTronco.php');
include_once('../classes/sp/dml_putTTUsuarioCentral.php');
include_once('../funcoes/selecaoEndereco.php');
include_once('../funcoes/selecaoPessoaTT.php');
include_once('../funcoes/selecaoCidadeCentral.php');
