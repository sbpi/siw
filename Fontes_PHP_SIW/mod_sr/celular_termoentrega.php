...
// -------------------------------------------------------------------------
function celular_termoEntrega($l_chave,$l_sg) {
  extract($GLOBALS);
  $l_html='';
  ...
  $l_html.=chr(13).'<p align="justify">Eu, <b>'.f($RS1,'nm_sol').'</b>, declaro que recebi da <b>'.f($RS2,'nome_resumido').' - '.f($RS2,'nm_pessoa').'</b>, o aparelho celular da marca <b>'.f($RS1,'marca').'</b>, ';
