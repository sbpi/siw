...
function Abastecimento() {
  ...
  if ($O=='L') {
    ...
    ShowHTML('      <tr><td ><b><u>L</u>itros:</b><br><input '.$w_Disabled.' accesskey="L" type="text" name="w_litros" class="STI" SIZE="18" MAXLENGTH="18" VALUE="'.number_format($w_litros,2,',','.').'" style="text-align:right;" onKeyDown="FormataValor(this,18,2,event);" title="Informe a quantidade de litro do abastecimento do veículo."></td>');
    ShowHTML('      <td><b><u>V</u>alor:</b><br><input '.$w_Disabled.' accesskey="V" type="text" name="w_valor" class="STI" SIZE="18" MAXLENGTH="18" VALUE="'.number_format($w_valor,2,',','.').'" style="text-align:right;" onKeyDown="FormataValor(this,18,2,event);" title="Informe o valor do abastecimento do veículo."></td>');
