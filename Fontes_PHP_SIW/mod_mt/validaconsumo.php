<?php
// =========================================================================
// Rotina de validação dos dados do pedido de material de consumo
// -------------------------------------------------------------------------
function ValidaConsumo($l_cliente,$l_chave,$l_sg1,$l_sg2,$l_sg3,$l_sg4,$l_tramite) {
  extract($GLOBALS);
  ...
  $sql = new db_getSolicMT; $l_rs_solic = $sql->getInstanceOf($dbms,$w_menu,$w_usuario,$l_sg1,3,
  ...
  // Recupera os itens do pedido de material de consumo
  $sql = new db_getCLSolicItem; $l_rs_item = $sql->getInstanceOf($dbms,null,$l_chave,null,null,null,null,null,null,null,null,null,null,'PEDMAT');
  ...
  // Verifica se já foram inseridos os itens do pedido de material de consumo
  if (count($l_rs_item)==0) {
    $l_erro.='<li>Informe pelo menos um item no pedido de material de consumo.';
    $l_tipo=0; 
  } else {
