...
function VisualEntrada($v_chave,$l_O,$l_usuario,$l_P1,$l_tipo) {
  ...
  $sql = new db_getSolicMT; $RS = $sql->getInstanceOf($dbms,null,$l_usuario,$SG,5,
  ...
  if ($l_O=='L' || $l_O=='V') {
    ...
    $sql = new db_getMTSolicItem; $RS1 = $sql->getInstanceOf($dbms,null,$v_chave,null,null,null,null,null,null,null,null,null,null,null);
  ...
  if ($l_O=='L' || $l_O=='V') {
    ...
    $w_erro = ValidaEntrada($w_cliente,$v_chave,substr($w_sigla,0,4).'GERAL',null,null,null,Nvl($w_tramite,0));
    if ($w_erro>'') {
