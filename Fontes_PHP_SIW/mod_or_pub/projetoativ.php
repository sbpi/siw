...
function Geral() {
  ...
  if (!(strpos('IAEV',$O)===false)) {
    ...
    //ShowHTML '              <td valign=''top''><b>Quantos <U>d</U>ias antes da data limite?<br><INPUT ACCESSKEY=''D'' ' & w_Disabled & ' class=''STI'' type=''text'' name=''w_dias'' size=''3'' maxlength=''3'' value=''' & w_dias & ''' title=''Número de dias para emissão do alerta de proximidade da data limite para conclusão da tarefa.''></td>'
    //ShowHTML '          </table>'
...
function Excluir() {
  ...
  ShowHTML('<HR>');
  AbreForm('Form',$w_dir.$w_pagina.'Grava','POST','return(Validacao(this));',null,$P1,$P2,$P3,$P4,$TP,'ORPGERAL',$w_pagina.$par,$O);
  ShowHTML('<INPUT type="hidden" name="w_chave" value="'.$w_chave.'">');
  ShowHTML('<INPUT type="hidden" name="w_troca" value="">');
...
function Encaminhamento() {
  ...
  ShowHTML(VisualDemanda($w_chave,'V',$w_usuario));
  ShowHTML('<HR>');
  AbreForm('Form',$w_dir.$w_pagina.'Grava','POST','return(Validacao(this));',null,$P1,$P2,$P3,$P4,$TP,'ORPENVIO',$w_pagina.$par,$O);
  ShowHTML(MontaFiltro('POST'));
  ShowHTML('<INPUT type="hidden" name="w_chave" value="'.$w_chave.'">');
  ShowHTML('<INPUT type="hidden" name="w_troca" value="">');
  ShowHTML('<INPUT type="hidden" name="w_menu" value="'.$w_menu.'">');
