...
//If p_agrega = "GRDMAREA"        Then                             ShowHTML " <option value=""GRDMAREA"" selected>Área envolvida"                   Else ShowHTML " <option value=""GRDMAREA"">Área envolvida"                    End If
    ...
    if ($RS_menu["solicita_cc"]=="S")
    {
      if ($p_agrega=="GRDMCC")
      {
        ShowHTML(" <option value=\"GRDMCC\" selected>Classificação");      } 
    } 
  }
    else
  {
...
(" <option value=\"GRDMCC\">Classificação");
...
(" <option value=\"GRDMPROP\">Parceria externa");
    ...
    {
      ShowHTML(" <option value=\"GRDMRESP\" selected>Responsável monitoramento");    } 
  }
    else
  {
    ShowHTML;
  }
(" <option value=\"GRDMRESP\">Responsável pelo monitoramento");
    if ($p_agrega=="GRDMSETOR")
    {
      ShowHTML(" <option value=\"GRDMSETOR\" selected>Setor responsável monitoramento");    } 
  }
    else
  {
    ShowHTML;
  }
(" <option value=\"GRDMSETOR\">Setor responsável monitoramento");
    ShowHTML("          </select></td>");
