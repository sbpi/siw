...
//      $l_html .=chr(13).'          </table>';
    ...
    if ($O=='L' && $w_tipo_visao!=2) {
      ...
      if (count($RS)>0) {
        ...
        $l_html .=chr(13).'      <tr><td align="center" colspan="2">';
     //   $l_html .=chr(13).'        <TABLE class="tudo" WIDTH="100%" bgcolor="'.$conTableBgColor.'" BORDER="'.$conTableBorder.'" CELLSPACING="'.$conTableCellSpacing.'" CELLPADDING="'.$conTableCellPadding.'" BorderColorDark="'.$conTableBorderColorDark.'" BorderColorLight="'.$conTableBorderColorLight.'">';
       $l_html.=chr(13).'        <table width=100%  border="1" bordercolor="#00000">'; 
        $l_html .=chr(13).'          <tr align="center">';
