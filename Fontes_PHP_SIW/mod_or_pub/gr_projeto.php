...
$p_mpog             = strtoupper($_REQUEST['p_mpog']);
$p_relevante        = strtoupper($_REQUEST['p_relevante']);
...
function Gerencial() {
  ...
  if ($O=='L' || $O=='V' || $O=='W') {
    ...
    if ($p_mpog>'')       $w_filtro = $w_filtro.'<tr valign="top"><td align="right">Selecionada SE/MS <td>[<b>'.$p_relevante.'</b>]';
    if ($p_relevante>'')  $w_filtro = $w_filtro.'<tr valign="top"><td align="right">Selecionada MP <td>[<b>'.$p_mpog.'</b>]';
    ...
    switch ($p_agrega) {
      case 'GRPRPROJ':
        ...
        break;
      case 'GRPRPROP':
        $RS1 = db_getSolicList::getInstanceOf($dbms,$P2,$w_usuario,'GRPRPROP',5,
                 $p_ini_i,$p_ini_f,$p_fim_i,$p_fim_f,$p_atraso,$p_solicitante,
                 $p_unidade,null,$p_ativo,$p_proponente,
                 $p_chave,$p_assunto, null, null, null, null,$p_usu_resp,
                 $p_uorg_resp,$p_palavra,$p_prazo,$p_fase,$p_sqcc,$p_projeto,$p_atividade,$p_sq_acao_ppa,$p_sq_orprioridade);
      ...
      case 'GRPRRESP':
        ...
        break;
      case 'GRPRRESPATU':
        $RS1 = db_getSolicList::getInstanceOf($dbms,$P2,$w_usuario,'GRPRRESPATU',5,
                 $p_ini_i,$p_ini_f,$p_fim_i,$p_fim_f,$p_atraso,$p_solicitante,
                 $p_unidade,null,$p_ativo,$p_proponente,
                 $p_chave,$p_assunto,null,null,null,null,$p_usu_resp,
                 $p_uorg_resp,$p_palavra,$p_prazo,$p_fase,$p_sqcc,null,null,$p_sq_acao_ppa,$p_sq_orprioridade);
      ...
      case 'GRPRINTER':
        ...
        $RS1 = db_getSolicGRI::getInstanceOf($dbms,$P2,$w_usuario,$p_agrega,5,
                 $p_ini_i,$p_ini_f,$p_fim_i,$p_fim_f,$p_atraso,$p_solicitante,
                 $p_unidade,null,$p_ativo,$p_proponente,
                 $p_chave,$p_assunto,null,null,null,null,$p_usu_resp,
                 $p_uorg_resp,$p_palavra,$p_prazo,$p_fase,$p_sqcc,null,null);
