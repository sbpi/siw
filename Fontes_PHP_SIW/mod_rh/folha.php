...
function Inicial() {
  ...
  if (count($RSUorg))
    ShowHTML('  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="SS" href="' . $conRootSIW . 'mod_rh/folha.php?par=lista&w_mes=' . $w_mes . '&P1=' . $P1 . '&P2=' . $P2 . '&P3=' . $P3 . '&P4=' . $P4 . '&TP=' . $TP . '&SG=GPFPLISTA">ALTERNAR PARA MODO APROVAÇÃO</a>');
  ShowHTML('</tr>');
  ShowHTML('</FORM>');
  ...
  if (nvl(f($RSMensal, 'horas_autorizadas'), '')!='')
    ShowHTML('      <tr valign="top"><td>Horas já aprovadas<td align="center"><input readonly type="text" name="w_autorizadas" class="stih" style="background-color:' . $conTableBgColor . '; border: 0; text-align:center;" SIZE="12" MAXLENGTH="12" VALUE="' . f($RSMensal, 'horas_autorizadas') . '">');

  ShowHTML('      <tr align="center" bgcolor="' . $conTrAlternateBgColor . '" valign="top"><td colspan="2"><b>JORNADA DIÁRIA');
  If (nvl($w_entrada_manha, '')!='')
    ShowHTML('      <tr valign="top"><td>Manhã<td align="center">&nbsp;' . $w_entrada_manha . '-' . $w_saida_manha . '&nbsp;');
...
function Visual() {
  ...
  if (nvl(f($RSMensal, 'horas_autorizadas'), '')!='')
    ShowHTML('      <tr valign="top"><td>Horas já aprovadas<td align="center">' . f($RSMensal, 'horas_autorizadas'));

  ShowHTML('      <tr align="center" bgcolor="' . $conTrAlternateBgColor . '"><td colspan="2"><b>JORNADA DIÁRIA');
  If (nvl($w_entrada_manha, '')!='')
    ShowHTML('      <tr><td>Manhã<td nowrap align="center">&nbsp;' . $w_entrada_manha . '-' . $w_saida_manha . '&nbsp;');
  If (nvl($w_entrada_tarde, '')!='')
