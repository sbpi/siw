...
function ValidaAfastamento($l_cliente,$l_chave,$l_sq_contrato_colaborador,$l_dt_ini,$l_dt_fim,$l_periodo_ini,$l_periodo_fim,$l_dias) {
  ...
  $sql = new db_getAfastamento; $l_rs_afast = $sql->getInstanceOf($dbms,$l_cliente,null,null,null,$l_sq_contrato_colaborador,$l_dt_ini,$l_dt_fim,null,null,$l_chave,null);
