...
/*      ShowHTML(' $(document).ready(function(){');
      ...
      ShowHTML('       if($(this).val() != "" && ($(this).attr("name")!="p_ini_i" && $(this).attr("name")!="p_ini_f" && $(this).attr("name")!="p_fim_i" && $(this).attr("name")!="p_fim_f")){');
      ShowHTML('         count = count + 1;');
      ShowHTML('       }');
      ShowHTML('     });');
      ShowHTML('     if(count <= 2 ){');
      ShowHTML('       count = 0;');
      ShowHTML('       alert("Pelo menos 2 (dois) critérios devem ser preenchidos."); ');
