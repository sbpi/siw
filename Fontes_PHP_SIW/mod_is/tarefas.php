...
function Limite() {
  ...
  if (!(strpos('A',$O)===false)) {
    ...
    $w_limite_tarefa=0;
    //$sql = new db_getLinkData; $RS1 = $sql->getInstanceOf($dbms,$w_cliente,'ISTCAD');
    ...
    ShowHTML('              </table>');
    ShowHTML('      <tr><td><font size="1"><b>'.$_SESSION['LABEL_CAMPO'].':<BR> <INPUT ACCESSKEY="A" class="sti" type="PASSWORD" name="w_assinatura" size="30" maxlength="30" value=""></td></tr>');
...
function Excluir() {
  ...
  ShowHTML('<tr bgcolor="'.$conTrBgColor.'"><td align="center">');
  ShowHTML('  <table width="97%" border="0">');
  ShowHTML('      <tr><td align="LEFT" colspan=4><font size="1"><b>'.$_SESSION['LABEL_CAMPO'].':<BR> <INPUT ACCESSKEY="A" class="STI" type="PASSWORD" name="w_assinatura" size="30" maxlength="30" value=""></td></tr>');
  ShowHTML('    <tr><td align="center" colspan=4><hr>');
