 ...
 * @Data de criação: 12/11/2003, 10:30
 * @version 0.1
 ...
 **/
 ...
 function barra() {
     ...
     switch($p_genero) {
         case 'M' : $datax = array('Total','Concluídos','Monitoramento','Programação','Atrasados','Em aviso de atraso', 'Acima do valor previsto');  break;
         case 'F' : $datax = array('Total','Concluídas','Monitoramento','Programação','Atrasadas','Em aviso de atraso', 'Acima do valor previsto');  break;
     }
 ...
 function pizza() {
    ...
    $p1->title->SetFont(FF_FONT1, FS_BOLD, 12);
